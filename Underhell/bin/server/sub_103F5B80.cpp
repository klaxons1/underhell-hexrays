unsigned int __usercall sub_103F5B80@<eax>(int a1@<ecx>, int a2@<ebx>)
{
  double v3; // st7
  int v4; // eax
  _DWORD *v5; // edi
  ...
  if ( v4 )
  {
    if ( (*(unsigned __int8 (__thiscall **)(int))(*(_DWORD *)v4 + 320))(v4) )
    {
      ...
      {
        if ( *(_DWORD *)(a1 + 1408) == -1 )
          *(_DWORD *)(a1 + 1408) = sub_10019BA0(v6, "VentPoses");
        v9 = (float)*(int *)(a1 + 1392);
        v10 = sub_10134630(v9, 0.0, 5.0, 0.0, 1.0);
        sub_10019C10(v7, *(_DWORD *)(a1 + 1408), v10);
      }
    }
  }
