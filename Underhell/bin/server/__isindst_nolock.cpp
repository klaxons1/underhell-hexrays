int __usercall _isindst_nolock@<eax>(_DWORD *a1@<edi>)
{
  ...
  v10 = 0;
  result = sub_1044047D(&v10);
  if ( result )
    _invoke_watson(0, 0, 0, 0, 0);
  if ( v10 )
  {
    v2 = a1[5];
    if ( v2 != dword_1068F388 || v2 != dword_1068F394 )
    {
      if ( dword_10701284 )
      {
    ...
    v5 = a1[7];
    if ( dword_1068F38C >= dword_1068F398 )
    {
      if ( v5 < dword_1068F398 || v5 > dword_1068F38C )
        return 1;
      if ( v5 <= dword_1068F398 || v5 >= dword_1068F38C )
        goto LABEL_28;
    }
    else if ( v5 >= dword_1068F38C && v5 <= dword_1068F398 )
    {
      if ( v5 > dword_1068F38C && v5 < dword_1068F398 )
        return 1;
LABEL_28:
      v6 = 1000 * (*a1 + 60 * (a1[1] + 60 * a1[2]));
      if ( v5 == dword_1068F38C )
        return v6 >= dword_1068F390;
      else
        return v6 < dword_1068F39C;
    }
    return 0;
  }
  return result;
