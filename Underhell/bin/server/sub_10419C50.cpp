double __thiscall sub_10419C50(int this, int a2, float a3)
{
  ...
  {
    v11 = v33;
    v7 = sub_104198C0(v33, (double (__thiscall ***)(_DWORD))a2, v10, &v32);
    v8 = sub_104198C0(v11, (double (__thiscall ***)(_DWORD))a2, v10 + 1, &v32);
    v9 /= 2;
    if ( v9 <= 1 )
      v9 = 1;
    if ( a3 >= (double)v7[1] )
...
LABEL_18:
  ...
  v15 = sub_104198C0(v33, (double (__thiscall ***)(_DWORD))a2, v12, &a2);
  v16 = sub_104198C0(v33, v14, v34, (_BYTE *)&a2 + 1);
  v17 = v8[1] - v7[1];
  v18 = *v15;
  v45[0] = *((int *)v15 + 1);
  *(float *)&v45[1] = v18;
  ...
  *(float *)&a2 = v27;
  ...
  sub_101711B0(v29, &v36, &v37);
  sub_101711B0(v30, &v35, &v36);
  if ( v37 == 15 )
  {
    result = v43;
  }
  ...
  else
  {
    if ( v37 == v35 )
    {
      sub_10171250(v35, (int)v45, (float *)&v42, (float *)&v39, (int)v38, *(float *)&a2, (float *)v46);
    }
    else
    {
      sub_10171250(v37, (int)v45, (float *)&v42, (float *)&v39, (int)v38, *(float *)&a2, (float *)v48);
      sub_10171250(v35, (int)v45, (float *)&v42, (float *)&v39, (int)v38, *(float *)&a2, (float *)v47);
      sub_100E8670((float *)v48, (float *)v47, *(float *)&a2, (float *)v46);
    }
    result = *(float *)&v46[1];
  }
  v31 = 1.0;
