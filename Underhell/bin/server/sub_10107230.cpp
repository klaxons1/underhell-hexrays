int __thiscall sub_10107230(int *this, int a2, int a3, _DWORD *a4)
{
  int *v5; // ebx
  int v7; // eax
  int v8; // ecx
    ...
    while ( 1 )
    {
      ...
      *(_DWORD *)(v17 + 12) = 0;
      if ( v18 )
      {
        v19 = *(_DWORD *)(v17 + 4);
        if ( v18 > v19 )
          sub_1026A8C0(v18 - v19);
        *(_DWORD *)(v17 + 12) += v18;
        v20 = *(char **)v17;
        v21 = *(_DWORD *)(v17 + 12) - v18;
        *(_DWORD *)(v17 + 16) = *(_DWORD *)v17;
        if ( v21 <= 0 )
          goto LABEL_22;
        if ( v18 > 0 )
          break;
...
LABEL_22:
    if ( v18 > 0 )
    {
      ...
      do
      {
        sub_100FFDE0((_DWORD *)(v22 + *(_DWORD *)v17), v22 + *v26);
        v22 += 132;
        --v18;
      }
      while ( v18 );
