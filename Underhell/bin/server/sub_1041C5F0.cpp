int __thiscall sub_1041C5F0(int *this)
{
  int v2; // ebp
  _DWORD *v3; // edi
  int i; // ebp
  ...
  *this = (int)&CChoreoEvent::`vftable';
  sub_10419FC0((int)this);
  this[89] = 0;
  v2 = this[72];
  if ( v2 )
  {
    sub_1041E7C0(this[72]);
    sub_10184660(v2);
  }
  sub_102375F0(this + 86);
  if ( this[81] >= 0 )
  {
    if ( this[79] )
    {
  ...
  sub_1041C450(this + 52);
  sub_1041C3F0(this + 47);
  if ( this[43] >= 0 )
  {
    if ( this[41] )
    {
  ...
  sub_102375F0(this + 32);
  result = sub_102375F0(this + 23);
  if ( this[16] >= 0 )
  {
    result = this[14];
    if ( result )
