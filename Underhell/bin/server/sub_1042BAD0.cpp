void __thiscall sub_1042BAD0(_BYTE *this, char *a2, char *Source, int a4, int a5, int *a6)
{
  _DWORD *v6; // ebx
  int i; // eax
  char v8; // cl
  ...
  if ( a4 )
  {
    sub_104299C0(Destination, a2, 512);
    ...
    sub_10429750(Destination, Source, 0x200u, -1);
    v9 = KeyValuesSystem();
    ...
    *((_BYTE *)v6 + 17) = v21[17] != 0;
    if ( sub_1042A380(v6, a4, Destination, a5) )
    {
      v13 = a6[3];
      v14 = a6[1];
      if ( v13 + 1 > v14 )
        sub_102ABFC0(a6, v13 - v14 + 1);
      ++a6[3];
      v15 = *a6;
      v16 = a6[3] - v13 - 1;
      a6[4] = *a6;
