int __usercall sub_100FE320@<eax>(
        int a1@<ebp>,
        int a2,
        float a3,
        _DWORD *a4,
        ...
        int a10)
{
  ...
  if ( (v10 & 2) != 0 )
  {
    sub_100FE000((unsigned __int16 *)(a9 + 4), &v30);
LABEL_3:
    result = a10;
    v12 = v31;
    *(float *)a10 = v30;
  ...
  if ( (v10 & 8) != 0 )
  {
    ...
    if ( a3 <= 0.001 )
    {
      if ( v16 <= 0 )
        ...
        v23 = v15 + v16;
      sub_100FE2B0(a2, v23, *a6, &v31);
      v24 = *(_WORD *)(a9 + 6);
      if ( v24 <= 0 )
        v25 = 0;
      else
        v25 = v15 + v24;
      sub_100FE2B0(a2, v25, a6[1], &v32);
      v26 = *(_WORD *)(a9 + 8);
      if ( v26 <= 0 )
        v27 = 0;
      else
        v27 = v15 + v26;
      sub_100FE2B0(a2, v27, a6[2], &v33);
      if ( (v37 & 0x10) == 0 )
      {
        v31 = *a5 + v31;
        v32 = a5[1] + v32;
    ...
    else
    {
      if ( v16 <= 0 )
        ...
        v17 = v15 + v16;
      sub_100FE1A0(a2, v17, *a6, &v34, &v31);
      v18 = *(_WORD *)(a9 + 6);
      if ( v18 <= 0 )
        v19 = 0;
      else
        v19 = v15 + v18;
      sub_100FE1A0(a2, v19, a6[1], &v35, &v32);
      v20 = *(_WORD *)(a9 + 8);
      if ( v20 <= 0 )
        v21 = 0;
      else
        v21 = v15 + v20;
      sub_100FE1A0(a2, v21, a6[2], &v36, &v33);
      if ( (v37 & 0x10) == 0 )
      {
        v34 = *a5 + v34;
        v35 = a5[1] + v35;
      ...
      {
        v22 = a10;
        result = sub_10423160(&v34, a10);
      }
      else
      {
        sub_10423160(&v34, v28);
        sub_10423160(&v31, v29);
        v22 = a10;
        result = sub_10425710((int)v28, (int)v29, a3, a10);
      }
    }
    if ( (*(_BYTE *)(a9 + 1) & 0x10) == 0 && (a7 & 0x100000) != 0 )
      return sub_10422BE0(a8, v22, v22);
  }
  else if ( (v10 & 0x10) != 0 )
  {
    result = a10;
