int __thiscall sub_101D5960(int this, unsigned __int16 a2)
{
  ...
  v5 = v4;
  *(_WORD *)(*(_DWORD *)(this + 4) + 16 * a2 + 2) = sub_101D3630((_DWORD *)this, v4);
  v8 = 16 * a2;
  if ( sub_101D3630((_DWORD *)this, v5) != -1 )
    *(_WORD *)(*(_DWORD *)(this + 4) + 16 * (unsigned __int16)sub_101D3630((_DWORD *)this, v5) + 4) = a2;
  if ( (_WORD)v5 != 0xFFFF )
  ...
  else
  {
    ...
    if ( sub_101D3630((_DWORD *)this, v6) == a2 )
