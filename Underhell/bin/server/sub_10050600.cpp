void sub_10050600()
{
  ...
  v20 = 0;
  v21 = 0;
  v35 = "TASK_FEAR_GET_PATH_TO_SAFETY_HINT";
  v36 = 100000;
  sub_10229160(0, &v35);
  v35 = "TASK_FEAR_WAIT_FOR_SAFETY";
  v36 = 100001;
  sub_10229160(0, &v35);
  v35 = "TASK_FEAR_IN_SAFE_PLACE";
  v36 = 100002;
  sub_10229160(0, &v35);
  v35 = "COND_FEAR_ENEMY_CLOSE";
  v36 = 100000;
  sub_10229160(0, &v35);
  v35 = "COND_FEAR_ENEMY_TOO_CLOSE";
  v36 = 100001;
  sub_10229160(0, &v35);
  v35 = "COND_FEAR_SEPARATED_FROM_PLAYER";
  v36 = 100002;
  sub_10229160(0, &v35);
  v35 = "SCHED_FEAR_MOVE_TO_SAFE_PLACE";
  v36 = 100000;
  sub_10229160(0, &v35);
  sub_102ABFC0(1);
  v33 = 1;
  v34 = 0;
  v35 = "SCHED_FEAR_MOVE_TO_SAFE_PLACE_RETRY";
  v36 = 100001;
  sub_10229160(0, &v35);
  v36 = 1;
  ...
  if ( v4 )
    *v4 = "\n"
          "\tSchedule\n"
          "\t\tSCHED_FEAR_MOVE_TO_SAFE_PLACE_RETRY\tTasks\t\tTASK_SET_FAIL_SCHEDULE\t\t\t\tSCHEDULE:SCHED_RUN_FROM_ENEMY\t"
          "\tTASK_FEAR_GET_PATH_TO_SAFETY_HINT\t0\t\tTASK_RUN_PATH\t\t\t\t\t\t0\t\tTASK_WAIT_FOR_MOVEMENT\t\t\t\t0\t\tTAS"
          "K_SET_ACTIVITY\t\t\t\t\tACTIVITY:ACT_IDLE\t\tTASK_FEAR_IN_SAFE_PLACE\t\t\t\t0\t\tTASK_SET_SCHEDULE\t\t\t\t\tSC"
          "HEDULE:SCHED_FEAR_STAY_IN_SAFE_PLACE\tInterrupts\t\tCOND_HEAR_DANGER\t\tCOND_NEW_ENEMY\n";
  v35 = "SCHED_FEAR_STAY_IN_SAFE_PLACE";
  v36 = 100002;
  sub_10229160(v24, &v35);
  v5 = v2;
  v36 = v2;
  if ( v2 + 1 > v31 )
  {
  ...
  if ( v8 )
    *(_DWORD *)v8 = "\n"
                    "\tSchedule\n"
                    "\t\tSCHED_FEAR_STAY_IN_SAFE_PLACE\tTasks\t\tTASK_FEAR_WAIT_FOR_SAFETY\t\t\t0\tInterrupts\t\tCOND_NEW"
                    "_ENEMY\t\tCOND_HEAR_DANGER\t\tCOND_FEAR_ENEMY_CLOSE\t\tCOND_FEAR_ENEMY_TOO_CLOSE\t\tCOND_CAN_RANGE_A"
                    "TTACK1\t\tCOND_FEAR_SEPARATED_FROM_PLAYER\n";
  sub_1004BBC0(&dword_10692020, (int)"CAI_FearBehavior", (int)&unk_10690E5C, (int)&dword_10690E10);
...
LABEL_19:
  ...
  if ( v6 > 0 )
  {
    ...
    do
    {
      if ( !v17 )
        break;
      v17 = sub_100A7A40("CAI_FearBehavior", *((_DWORD *)Src + v16++), &dword_10692020);
      byte_1060299C = v17;
    }
    while ( v16 < v6 );
  }
