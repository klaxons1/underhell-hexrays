float *__thiscall sub_103EA8F0(_BYTE *this, float *a2, int a3, char a4)
{
  int v5; // eax
  _BYTE v7[48]; // [esp+24h] [ebp-30h] BYREF

  if ( this[1690] )
    v5 = sub_100BEF30((int)this, "vehicle_gunner_eyes");
  else
    v5 = sub_100BEF30((int)this, "vehicle_driver_eyes");
  (*(void (__thiscall **)(_BYTE *, int, _BYTE *))(*(_DWORD *)this + 796))(this, v5, v7);
