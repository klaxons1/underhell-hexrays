int __thiscall sub_1042A5B0(_BYTE *this, void *Src, size_t Size, int a4, int a5)
{
  int v8; // eax
  const char *v9; // eax
  int v10; // ecx
    ...
    else
    {
      switch ( *(_BYTE *)(v10 + 16) )
      {
        case 1:
          ...
          if ( v11 && *v11 )
          {
            sub_1042A4B0((int)Src, Size, a4, a5 + 1);
            if ( Src )
              (*(void (__thiscall **)(void *, const char *, int, size_t))(*(_DWORD *)Src + 4))(Src, "\"", 1, Size);
            if ( a4 )
              sub_1042DD00((void *)"\"", 1u);
            ...
            sub_1042A510(v31, (int)Src, Size, a4, v13);
            if ( Src )
              (*(void (__thiscall **)(void *, const char *, int, size_t))(*(_DWORD *)Src + 4))(Src, "\"\t\t\"", 4, Size);
            if ( a4 )
              sub_1042DD00("\"\t\t\"", 4u);
            sub_1042A510(v31, (int)Src, Size, a4, *((const char **)i + 1));
            goto LABEL_28;
          }
          break;
        case 2:
          ...
          if ( a4 )
            sub_1042DD00(Srca, Sizea);
          if ( Src )
            (*(void (__thiscall **)(void *, const char *, int, size_t))(*(_DWORD *)Src + 4))(Src, "\"\t\t\"", 4, Size);
          if ( a4 )
            sub_1042DD00("\"\t\t\"", 4u);
          sub_10429A00(Buffer, 0x20u, "%d", *((_DWORD *)i + 3));
          v20 = strlen(Buffer);
          if ( Src )
            (*(void (__thiscall **)(void *, char *, size_t, size_t))(*(_DWORD *)Src + 4))(Src, Buffer, v20, Size);
          if ( a4 )
            sub_1042DD00(Buffer, v20);
          if ( !Src )
            goto LABEL_30;
          goto LABEL_29;
        case 3:
          ...
          if ( a4 )
            sub_1042DD00(Srcc, Sizec);
          if ( Src )
            (*(void (__thiscall **)(void *, const char *, int, size_t))(*(_DWORD *)Src + 4))(Src, "\"\t\t\"", 4, Size);
          if ( a4 )
            sub_1042DD00("\"\t\t\"", 4u);
          sub_10429A00(v29, 0x30u, "%f", i[3]);
          v26 = strlen(v29);
          if ( Src )
            (*(void (__thiscall **)(void *, char *, size_t, size_t))(*(_DWORD *)Src + 4))(Src, v29, v26, Size);
          if ( a4 )
            sub_1042DD00(v29, v26);
          goto LABEL_28;
        case 5:
          ...
          sub_1042A220((int)Src, Size, a4, v17, ArgList_4);
          if ( Src )
            (*(void (__thiscall **)(void *, const char *, int, size_t))(*(_DWORD *)Src + 4))(Src, "\"\t\t\"", 4, Size);
          if ( a4 )
            sub_1042DD00("\"\t\t\"", 4u);
          sub_1042A510(v31, (int)Src, Size, a4, MultiByteStr);
          if ( Src )
            goto LABEL_29;
          goto LABEL_30;
        case 6:
        ...
        case 7:
          ...
          if ( a4 )
            sub_1042DD00(Srcb, Sizeb);
          if ( Src )
            (*(void (__thiscall **)(void *, const char *, int, size_t))(*(_DWORD *)Src + 4))(Src, "\"\t\t\"", 4, Size);
          if ( a4 )
            sub_1042DD00("\"\t\t\"", 4u);
          sub_10429A00(Buffer, 0x20u, "0x%016I64X", *(_QWORD *)*((_DWORD *)i + 1));
          v23 = strlen(Buffer);
          if ( Src )
            (*(void (__thiscall **)(void *, char *, size_t, size_t))(*(_DWORD *)Src + 4))(Src, Buffer, v23, Size);
          if ( a4 )
            sub_1042DD00(Buffer, v23);
LABEL_28:
          if ( Src )
LABEL_29:
            (*(void (__thiscall **)(void *, const char *, int, size_t))(*(_DWORD *)Src + 4))(Src, "\"\n", 2, Size);
