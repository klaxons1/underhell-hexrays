int __thiscall sub_1021D8D0(_DWORD *this, int a2, int a3, int a4)
{
  int result; // eax
  int *v5; // esi
  _DWORD *v6; // edi
  ...
  if ( a4 > 0 )
  {
    ...
    do
    {
      ...
      if ( (result & 2) != 0 && (!v10[8] || (result & 1) == 0) )
      {
        ...
        {
          if ( v5[3] != dword_10646660[*(v5 - 6)] * *((unsigned __int16 *)v5 - 4) )
            Warning(
          ...
          result = (int)memset(
                          ...
                          dword_10646660[*(v5 - 6)] * *((unsigned __int16 *)v5 - 4));
        }
      }
      v5 += 13;
      --a4;
