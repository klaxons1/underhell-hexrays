int __thiscall sub_100BAF90(_DWORD *this, int a2, int a3, int a4)
{
  int v4; // ebx
  int v7; // edi
  int v8; // esi
  ...
  v4 = a2;
  v21 = this;
  if ( !(unsigned __int8)sub_10245220(a2) )
  {
    if ( dword_10695530 < 1 )
    {
  ...
  memset(&v20[1], 0, 12);
  v20[0] = v8;
  if ( sub_100BAE70(v21 + 3, v20, &a2, &a4) )
    v11 = a4 | (a2 << 16);
  else
    v11 = -1;
  v12 = HIWORD(v11);
  ...
  v15 = v14[3] - 1;
  if ( dword_10697280 )
    v16 = sub_10265130("SelectWeightedSequence", 0, v15, 0);
  else
    v16 = RandomInt(0, v15);
