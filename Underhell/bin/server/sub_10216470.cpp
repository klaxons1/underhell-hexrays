int __usercall sub_10216470@<eax>(int a1@<ebx>, int *a2, int a3, float a4, int a5)
{
  int result; // eax
  int v6; // ebx
  int v7; // edx
  ...
  result = (*(int (__thiscall **)(int, int))(*(_DWORD *)dword_106B31F0 + 16))(dword_106B31F0, a3);
  if ( result )
  {
    v6 = (*(int (__thiscall **)(int, _DWORD, int))(*(_DWORD *)dword_106BAFF0 + 152))(
           dword_106BAFF0,
           *(_DWORD *)(result + 8),
           a1);
    ...
    return (*(int (__thiscall **)(int))(*(_DWORD *)dword_106BAFF0 + 156))(dword_106BAFF0);
  }
  return result;
}
