void __thiscall sub_1010A310(_DWORD *this)
{
  int v2; // edi
  ...
  _DWORD v20[5]; // [esp+40h] [ebp-44h] BYREF
  ...
  if ( this[319] )
  {
    ...
    v4 = v3(this, v23, 0.80000001);
    sub_1021A0E0(v4, COERCE_FLOAT(v23));
    v15 = 0.0;
    v21 = -1;
    v5 = (const char *)this[319];
    v12 = 0;
    v13 = 100;
    v14 = 0;
    v16 = 0;
