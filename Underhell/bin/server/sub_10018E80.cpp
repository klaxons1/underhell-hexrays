bool __thiscall sub_10018E80(void *this, float *a2)
{
  float *v3; // eax
  ...
  (*(void (__thiscall **)(void *, float *))(*(_DWORD *)this + 916))(this, v6);
  v3 = (float *)(*(int (__thiscall **)(void *, _BYTE *))(*(_DWORD *)this + 504))(this, v5);
  v7 = *a2 - *v3;
  v8 = a2[1] - v3[1];
  v9 = a2[2] - v3[2];
  return off_10689714() >= 1.0 && v7 * v6[0] + v6[1] * v8 + v6[2] * v9 > 0.259;
}
