_DWORD *__usercall sub_10106010@<eax>(_DWORD *result@<eax>, int a2@<ecx>)
{
  int v2; // edx
  double v4; // st7
  double v5; // st6
        ...
        else
        {
          ...
          if ( v38 )
          {
            ...
            else if ( v37 + 216 * v39 + *(_DWORD *)(v37 + 160) )
            {
              ...
              v40 = 20 * v44;
              v41 = sub_10105BA0((int *)(20 * v44 + *(_DWORD *)(a2 + 4092)));
              result = sub_100FFDE0((_DWORD *)(*(_DWORD *)(v40 + *(_DWORD *)(a2 + 4092)) + 132 * v41), (int)v42);
            }
            else
            {
              result = (_DWORD *)DevWarning(
