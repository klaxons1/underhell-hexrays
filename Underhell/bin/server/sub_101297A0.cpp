int __thiscall sub_101297A0(_DWORD *this, int a2, int a3, float a4, int a5)
{
  int v6; // esi
...
LABEL_9:
    ((void (__stdcall *)(_DWORD *, _DWORD, int, int, _DWORD, int))(*off_1065C5EC)[35])(v8, 0.0, a2, a3, LODWORD(a4), a5);
