void __thiscall sub_10172CB0(_DWORD *this, __int64 a2, int a3, int a4)
{
  int v5; // eax
  ...
  if ( (_DWORD)a2 )
  {
    if ( sub_10171D30((_DWORD *)a2) != 28 )
    {
      ...
      sub_1023C580((int)v7, v5, v6, (int)"HL2Player.PickupItems", 0.0, COERCE_INT(0.0));
      sub_1010DD80(this + 282, a2, 0.0);
      (*(void (__thiscall **)(_DWORD, int, _DWORD))(*(_DWORD *)a2 + 1640))(a2, 13, 0);
      (*(void (__thiscall **)(_DWORD, int))(*(_DWORD *)a2 + 1640))(a2, 13);
      (*(void (__thiscall **)(_DWORD, int))(*(_DWORD *)a2 + 1640))(a2, 13);
      sub_100D6A00(this);
