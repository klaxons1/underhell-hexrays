int __thiscall sub_103D9CD0(int this, int a2, char *a3)
{
  _DWORD *v5; // eax
  float *v6; // eax
  double v7; // st6
  ...
  *(_DWORD *)(a2 + 4) = v5[1];
  *(_DWORD *)(a2 + 8) = v5[2];
  v18 = *(float *)(dword_106B31C8 + 12) - *(float *)(this + 3820);
  if ( a3[256] >= 0 )
  {
    ...
    else if ( *(_BYTE *)(this + 3825) || (*(int (__thiscall **)(char *))(*(_DWORD *)a3 + 220))(a3) != 19 )
    {
      if ( (*(int (__thiscall **)(char *))(*(_DWORD *)a3 + 220))(a3) == 4 )
      {
        if ( (*((_DWORD *)a3 + 63) & 0x800) != 0 )
          sub_100DAE60((int)a3);
        result = a2;
    ...
    else
    {
      ...
      {
        v19 = *(_DWORD *)a3;
        v10 = sub_103D9500((float *)this, v16);
        v11 = (float *)(*(int (__thiscall **)(char *, float *, float *, _DWORD))(v19 + 520))(a3, v15, v10, 0);
      }
      else
      {
        v20 = *(_DWORD *)a3;
        v13 = sub_103D9500((float *)this, v15);
        v11 = (float *)(*(int (__thiscall **)(char *, float *, float *))(v20 + 524))(a3, v16, v13);
      }
      *(float *)a2 = *v11;
      *(float *)(a2 + 4) = v11[1];
      v12 = v11[2];
  ...
  else
  {
    ...
    {
      v6 = (float *)(*(int (__thiscall **)(char *, float *))(*(_DWORD *)a3 + 504))(a3, v16);
      v7 = v6[1];
      v8 = v6[2] + 1.0;
      *(float *)a2 = *v6;
      *(float *)(a2 + 4) = v7;
