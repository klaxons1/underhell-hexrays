void __thiscall sub_10329900(int this, int a2, int a3)
{
  double v4; // st7
  const char *v5; // eax
  ...
  *(float *)(this + 164) = *(float *)(dword_106B31C8 + 12);
  if ( a3 == 1 )
  {
    ...
    Buffer[0] = 0;
    *(float *)(this + 116) = v4;
    v5 = (const char *)(*(int (__thiscall **)(int, const char *))(*(_DWORD *)(this - 3680) + 2228))(
                         this - 3680,
                         "DiveBomb");
  ...
  {
    sub_10023CB0((char *)(this - 3680), 75);
    sub_10023E00((char *)(this - 3680), 76);
  }
}
