  ...
  if ( v4 )
  {
    if ( *(_BYTE *)(v4 + 8) )
    {
      ...
      if ( v5 || *a3 < 0 )
      {
        ...
        if ( (*a3 & 8) != 0 )
        {
          if ( unknown_libname_7(*(_DWORD *)(a1 + 24)) && unknown_libname_7(v6) )
          {
            v7 = *(_DWORD *)(a1 + 24);
            *v6 = v7;
...
LABEL_11:
        ...
        else
        {
          ...
          if ( (*(_BYTE *)a4 & 1) != 0 )
          {
            if ( unknown_libname_7(v11) && unknown_libname_7(v6) )
            {
          ...
          {
            if ( unknown_libname_7(v11) && unknown_libname_7(v6) && unknown_libname_7(*(_DWORD *)(a4 + 24)) )
              return ((*(_BYTE *)a4 & 4) != 0) + 1;
          }
          else if ( unknown_libname_7(v11) && unknown_libname_7(v6) )
          {
            v12 = *(_DWORD *)(a4 + 20);
