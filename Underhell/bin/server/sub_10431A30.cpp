int __thiscall sub_10431A30(int this, int a2)
{
  int v3; // eax
  _WORD *v4; // edx
  ...
  if ( v6[4] == v5 && v6[5] != v5 )
    return (*(int (__thiscall **)(int))(*(_DWORD *)this + 8))(this);
  if ( *v6 )
    sub_10431690((unsigned __int16 *)this, a2);
  sub_101C63C0((_DWORD *)(this + 12), *(_WORD *)(this + 68), v5);
  v8 = sub_10431740((void *)this, v5);
