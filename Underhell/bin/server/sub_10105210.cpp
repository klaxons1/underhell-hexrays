int __thiscall sub_10105210(float *this, int a2, int a3, int a4, int a5)
{
  int *v6; // ecx
  int v7; // eax
  float *v8; // esi
  ...
  if ( *(int *)(v7 + 284) > 0 )
  {
    ...
    do
    {
      ...
      *(v8 - 1) = NAN;
      ...
      {
        sub_10102F30((int)v6, (int)(this + 1033), a2, a3, v11, a4, a5);
        sub_10424D60(a4 + 48 * v11, v8 + 3, v8);
      }
      v6 = (int *)*((_DWORD *)this + 1022);
      v12 = *v6;
      v71 += 16;
      ...
      if ( (int)v14[3] > 0 )
      {
        ...
        do
        {
          ...
          *v16 = NAN;
          if ( *(_DWORD *)(v15 + 4) == 1 )
          {
            sub_10425290(v15 + 44, v15 + 32, v58);
            v26 = *(_DWORD *)(v15 + 12);
            if ( v26 == -1 )
            {
              sub_10421E30(this + 1033, v58, v56);
            }
            else
            {
              sub_10102F30(*((_DWORD *)this + 1022), (int)(this + 1033), a2, a3, v26, a4, a5);
              sub_10421E30(a4 + 48 * *(_DWORD *)(v15 + 12), v58, v56);
            }
            v27 = *(float *)(v15 + 96) * *(float *)(v15 + 92);
            v69 = v27;
            v62 = 1.0 - v27;
            v16[8] = v27 + (1.0 - v27) * v16[8];
            sub_10424D60(v56, v59, &v65);
            v28 = v69;
            ...
            v16[3] = v30;
            v52 = v28;
            sub_104251E0((int)(v16 + 4), (int)v59, v52, (int)(v16 + 4));
          }
          else if ( *(_DWORD *)(v15 + 4) == 4 )
          {
            ...
            v21 = *(_DWORD *)(*(_DWORD *)(v19 + *(_DWORD *)(v19 + 288) + v20 + 12)
                            ...
                            + v20
                            + 56);
            sub_10102F30((int)v17, (int)(this + 1033), a2, a3, v21, a4, a5);
            sub_10424D60(a4 + 48 * v21, v60, v63);
            v22 = v69;
            v23 = 1.0 - v69;
            ...
            v16[3] = v25;
            v51 = v22;
            sub_104251E0((int)(v16 + 4), (int)v60, v51, (int)(v16 + 4));
          }
  ...
  if ( *((int *)this + 1020) > 0 )
  {
    ...
    do
    {
      if ( *(v32 - 38) > 0.0 )
      {
        ...
        sub_104252F0(v32 - 55, v63);
        sub_104256B0(v63, v32 - 58, v58);
        sub_104252F0(v32 - 34, v61);
        sub_104256B0(v61, v32 - 37, v57);
        sub_10421E30(v57, v58, v56);
        sub_10424D60(v56, v59, &v65);
        v34 = *(v32 - 38);
        v33[8] = *(v32 - 38);
        v35 = v65 * v34;
        ...
        v33[2] = v39;
        v33[3] = v37 + v40;
        sub_104251E0((int)(v33 + 4), (int)v59, v33[8], (int)(v33 + 4));
      }
      if ( *((_BYTE *)v32 - 44) )
      {
        v41 = *((_DWORD *)v32 - 33);
  ...
  if ( *(int *)(result + 284) > 0 )
  {
    ...
    do
    {
      ...
      if ( v72[7] > 0.0 )
      {
        sub_10421CE0(a4 + 48 * *(_DWORD *)(*(_DWORD *)(v45 + 12) + v45 + 56), 3, &v65);
        if ( sub_10105130(v45, v72, a4) )
        {
          sub_10421CE0(a4 + 48 * *(_DWORD *)(*(_DWORD *)(v45 + 12) + v45 + 56), 3, v61);
          sub_10425290(v72 + 3, v61, a4 + 48 * *(_DWORD *)(*(_DWORD *)(v45 + 12) + v45 + 56));
          v46 = *(_DWORD *)(*(_DWORD *)(v45 + 12) + v45 + 56);
          sub_10424F80(a4 + 48 * *(_DWORD *)(*(_DWORD *)(*((_DWORD *)this + 1022) + 64) + 4 * v46), v57);
          sub_10421E30(v57, a4 + 48 * v46, v58);
          sub_10424D60(v58, a3 + 16 * v46, a2 + 12 * v46);
          v47 = *(_DWORD *)(*(_DWORD *)(v45 + 12) + v45 + 28);
          sub_10424F80(a4 + 48 * *(_DWORD *)(*(_DWORD *)(*((_DWORD *)this + 1022) + 64) + 4 * v47), v57);
          sub_10421E30(v57, a4 + 48 * v47, v58);
          sub_10424D60(v58, a3 + 16 * v47, a2 + 12 * v47);
          v48 = *(_DWORD *)(v45 + *(_DWORD *)(v45 + 12));
          sub_10424F80(a4 + 48 * *(_DWORD *)(*(_DWORD *)(*((_DWORD *)this + 1022) + 64) + 4 * v48), v57);
          sub_10421E30(v57, a4 + 48 * v48, v58);
          sub_10424D60(v58, a3 + 16 * v48, a2 + 12 * v48);
        }
        else
        {
          v49 = *((_DWORD *)v72 - 1);
          if ( v49 != -1 )
          {
            ...
            *(float *)(v53 - 4) = this[v50 + 69] * 0.80000001;
            sub_10422E20(v53, 0.80000001, v53);
          }
        }
      }
      result = **((_DWORD **)this + 1022);
