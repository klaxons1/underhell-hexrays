int __thiscall sub_1042AFF0(_DWORD *this)
{
  int v2; // eax
  int v3; // esi
  int v4; // eax
    ...
    case 5:
      ...
      if ( v9 )
      {
        ...
        while ( *v9++ )
          ;
        v12 = v9 - v10;
        v13 = (void *)sub_10184390((unsigned __int64)(unsigned int)(v12 + 1) >> 31 != 0 ? -1 : 2 * (v12 + 1));
        *(_DWORD *)(v3 + 8) = v13;
