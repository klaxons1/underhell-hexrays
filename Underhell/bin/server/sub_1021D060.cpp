bool __thiscall sub_1021D060(void *this, _DWORD *a2, int *a3)
{
  __int16 v5; // cx
  int v6; // edx
  _DWORD *v8; // ecx
  ...
  if ( v6 != 10 )
  {
    ...
    if ( v6 != 13 )
    {
      if ( a3[9] != dword_10646660[v6] * *((unsigned __int16 *)a3 + 8) )
        Warning(
          "WARNING! Field %s is using the wrong FIELD_ type!\nFix this or you'll see a crash.\n",
          (const char *)a3[1]);
      return !sub_1021CF60(a2, dword_10646660[*a3] * *((unsigned __int16 *)a3 + 8));
    }
    if ( a3[9] != dword_10646694 * *((unsigned __int16 *)a3 + 8) )
      Warning(
        "WARNING! Field %s is using the wrong FIELD_ type!\nFix this or you'll see a crash.\n",
        (const char *)a3[1]);
    v8 = a2;
...
LABEL_30:
  ...
  while ( !(unsigned __int8)sub_1021D060((char *)a2 + *(_DWORD *)(v16 + 8), v16) )
  {
    v16 += 52;
    if ( v16 >= v17 )
      goto LABEL_30;
