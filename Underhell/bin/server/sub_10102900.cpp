int __cdecl sub_10102900(int *a1, int a2, int a3, int a4, int a5)
{
  int result; // eax
  int v6; // ebx
  double v7; // st7
      ...
      if ( (a5 & *(_DWORD *)(a1[11] + 4 * v9)) != 0 )
      {
        ...
        switch ( *(_DWORD *)(v10 + 4) & 0x3FFFF )
        {
          ...
          case 8:
            ...
            v15 = v7;
            v16 = v7;
            sub_10423160(&v14, v13);
            sub_100FE9D0(1.0, (int)v13, 16 * v9 + a3, (float *)(16 * v9 + a3));
            goto LABEL_10;
          case 0x10:
            v14 = v7;
            ...
            v16 = v7;
            sub_10423160(&v14, v13);
            sub_100FE9D0(1.0, (int)v13, a3 + 16 * v9, (float *)(a3 + 16 * v9));
            goto LABEL_10;
          case 0x20:
            v14 = v7;
            v15 = v14;
