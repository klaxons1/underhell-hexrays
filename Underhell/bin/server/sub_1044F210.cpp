bool __cdecl sub_1044F210(int a1, _DWORD *a2)
{
  int v2; // esi
  int v3; // eax
  void **v4; // ebx
  ...
  if ( (*(_BYTE *)(a1 + 21) & 1) != 0 )
  {
    v8 = sub_1044F0C0(a1, &v16);
    if ( v8 < 0 )
      return 0;
    sub_1042D6E0((_DWORD *)v2);
    v15 = v8;
    v9 = a2;
    v10 = 0;
    sub_10430F70(a2, v15);
    if ( *(_DWORD *)(v2 + 12) < v16 )
    {
      while ( 1 )
      {
        ...
        {
          HIBYTE(a1) = 0;
          sub_1042E720(v2, "%c", (char *)&a1 + 3);
        }
        else if ( sub_1042D170(v2, 1) )
        {
          v11 = *(_DWORD *)(v2 + 12) + 1;
  ...
  {
    v3 = sub_1008A260((_DWORD *)a1);
    v4 = (void **)a2;
    v5 = v3;
    sub_10430F70(a2, v3);
    if ( v4[3] )
      sub_1042D670((_BYTE *)v2, *v4, (size_t)v4[3]);
    v6 = v4[3];
    if ( (void *)v5 != v6 )
    {
      sub_1042D280(v2, 1, v5 - (_DWORD)v6);
      return 0;
    }
