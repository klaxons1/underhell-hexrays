int __stdcall sub_100020D0(_DWORD **a1, int a2)
{
  int v2; // edx
  int v3; // ecx
  int v4; // eax
  ...
  if ( dword_10690154 > 0 )
  {
    while ( *(_DWORD *)(dword_10690148 + 8 * v4) != **a1 )
    {
      if ( ++v4 >= dword_10690154 )
        goto LABEL_8;
    }
    v5 = dword_10690148 + 8 * v4;
    if ( v5 )
    {
      v6 = (const char *)sub_10244C30(*(unsigned __int16 *)(v5 + 4));
      if ( v6 )
        goto LABEL_12;
      v2 = dword_10690154;
      v3 = dword_10690148;
...
LABEL_8:
  ...
  v11 = v3 + 8 * v7;
  if ( v11 )
    v6 = (const char *)sub_10244C30(*(unsigned __int16 *)(v11 + 4));
  else
LABEL_11:
    v6 = 0;
LABEL_12:
