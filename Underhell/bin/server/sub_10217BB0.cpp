int __usercall sub_10217BB0@<eax>(int a1@<eax>, _DWORD *a2@<esi>, int a3, _DWORD *a4)
{
  int result; // eax
  int v6; // ecx
  int v7; // ecx
  ...
  {
    v8 = sub_10100DC0(a4[2], (char *)(a1 + 4));
    a2[*a2 + 147] = v8;
    if ( v8 < 0 )
    {
    ...
    else
    {
      *(float *)(a1 + 1572) = 0.1;
      *(_DWORD *)(a1 + 1580) = *a4;
      v9 = (*(int (__thiscall **)(int, int))(*(_DWORD *)dword_106BAFF8 + 12))(dword_106BAFF8, a1 + 1028);
      if ( v9 < 0 )
        v9 = (*(int (__thiscall **)(int, const char *))(*(_DWORD *)dword_106BAFF8 + 12))(dword_106BAFF8, "default");
