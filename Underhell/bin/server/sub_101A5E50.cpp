bool __thiscall sub_101A5E50(int this)
{
  bool result; // al
  int v3; // edi
  int v4; // eax
  ...
  v5 = __RTDynamicCast(
         ...
         0);
  if ( v5 && !(*(unsigned __int8 (__thiscall **)(int, int))(*(_DWORD *)v5 + 876))(v5, this) )
    v3 = 20;
  v13 = (float)*(int *)(this + 220);
  result = 0;
  if ( (double)(*(int (__thiscall **)(int))(*(_DWORD *)this + 448))(this) * 0.5 >= v13
    || !sub_1004AE70((_DWORD *)this, 8, 9)
    && (*(int (__thiscall **)(int, _DWORD, int))(*(_DWORD *)dword_106B31E4 + 8))(dword_106B31E4, 0, 100) <= v3
    && *(float *)(dword_106B31C8 + 12) >= (double)*(float *)(this + 3872) )
  {
