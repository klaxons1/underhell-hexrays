int __cdecl sub_10426140(float a1, float a2, float a3, int a4)
{
  double v4; // st7
  double v5; // st6
  double v6; // st6
  ...
  do
  {
    ...
    v34 = v16;
    flt_106F1CE8[v15] = pow(v16, a2);
    flt_106F30E8[v15] = pow(v34, 0.4545454382896423);
    flt_106F54E8[v15++] = pow(v34, 2.200000047683716);
    v25 = v15;
  }
  while ( v15 < 256 );
  v17 = 0;
  ...
  do
  {
    dword_106F34E8[v17++] = (int)(pow((double)v26 * 0.0009775171065493646, v32) * 255.0);
    v26 = v17;
  }
  while ( v17 < 1024 );
  v33 = 1.0;
...
LABEL_34:
  ...
  do
  {
    ...
    flt_106F58E8[v19] = v20;
    if ( v20 > 1.0 )
      flt_106F58E8[v19] = 1.0;
    v35 = v20 * 255.0;
    v21 = (int)v35;
    if ( v21 <= 255 )
      result = v21 < 0 ? 0 : v21;
