void __thiscall sub_103E8690(int this)
{
  int v2; // ebx
  ...
  if ( *(float *)(dword_106B31C8 + 12) >= (double)*(float *)(this + 1952) && (double)*(int *)(this + 1164) <= 5.0 )
  {
    ...
    sub_101117D0(this + 320, &v4, (float *)v3);
    sub_1023D4B0(4096, (float *)v3, v2, 0.5, this, 0, 0);
    *(float *)(this + 1952) = *(float *)(dword_106B31C8 + 12) + 0.5;
  }
}
