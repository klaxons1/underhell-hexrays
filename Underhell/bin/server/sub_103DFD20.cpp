void __thiscall sub_103DFD20(float *this, float *a2, int a3, float a4)
{
  double v5; // st4
  double v6; // rt1
  double v7; // st4
  ...
  sub_10422220(a3, &v45);
  v5 = a4 * this[437] + this[431];
  v39 = v5;
  v6 = v5;
  v7 = this[438] * a4 + this[432];
  v8 = v6;
  v40 = v7;
  v9 = v7;
  v10 = this[439] * a4 + this[433];
  v41 = v10;
  v11 = a2[1] - this[435];
  v12 = 1.0 / a4;
  v13 = (*a2 - this[434]) * v12;
  ...
  {
    v28 = 9.0 * *(float *)(dword_106B765C + 44) * *(float *)(dword_106B765C + 44);
    v29 = *(float *)(dword_106B765C + 44) * 4.5 * *(float *)(dword_106B76A4 + 44);
    v30 = 1.0 / (v29 * a4 + 1.0 + v28 * a4 * a4);
    v31 = (v29 + v28 * a4) * v30;
    v32 = v28 * v30;
    v33 = (v43 * v31 + v52 * v32) * a4;
    v34 = a4 * (v31 * v44 + v32 * v53);
    this[437] = (v42 * v31 + v32 * v51) * a4 + this[437];
    this[438] = v33 + this[438];
    this[439] = v34 + this[439];
    this[431] = v39;
    this[432] = v40;
    this[433] = v41;
