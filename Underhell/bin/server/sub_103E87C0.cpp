float *__thiscall sub_103E87C0(_DWORD *this, int a2)
{
  double v3; // st4
  double v4; // rt1
  double v5; // st4
  ...
  if ( v14 )
  {
    v15 = this[518];
    if ( v15 == -1
      || off_1061BE18[4 * (this[518] & 0xFFF) + 2] != v15 >> 12
      || !off_1061BE18[4 * (this[518] & 0xFFF) + 1] )
    {
      ...
      this[518] = *(_DWORD *)(*(int (__thiscall **)(float *))(*(_DWORD *)v14 + 8))(v14);
    }
  }
  ...
  if ( result )
  {
    v19 = this[519];
    if ( v19 == -1
      || (result = (float *)(v19 >> 12), (float *)off_1061BE18[4 * (this[519] & 0xFFF) + 2] != result)
      || !off_1061BE18[4 * (this[519] & 0xFFF) + 1] )
    {
