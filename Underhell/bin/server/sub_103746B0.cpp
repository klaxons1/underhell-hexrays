int __thiscall sub_103746B0(_DWORD *this, int a2, int a3)
{
  int v4; // ebx
  ...
  sub_100BF1B0(this, "right foot", a2, 0, 0, 0);
  ...
  sub_1023C580(a2, v9, v11, v7, v9, (int)"NPC_Hunter.Footstep", *(float *)&a2, a3);
