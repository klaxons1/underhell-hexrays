int __stdcall sub_1023EA50(int a1, int a2, int a3)
{
  int v3; // eax
  int v4; // ecx
  int v5; // edi
  ...
  else if ( off_1061BE18[4 * a2 + 1] )
  {
    v11 = a2 | (off_1061BE18[4 * a2 + 2] << 12);
  }
  else
  {
    v11 = -1;
  ...
  sub_1023E540((float *)v5, a1, v4, *(_DWORD *)a3, *(char **)(a3 + 4), *(_DWORD *)(a3 + 12));
  v6 = *(float *)(a3 + 8);
  *(_DWORD *)(v5 + 60) |= 1u;
  if ( v6 > 1.0 )
    v6 = 1.0;
  v9 = v6;
  sub_1023DBC0((float *)(v5 + 16), v9, 0.0);
  v7 = (double)*(int *)(a3 + 20);
  *(_DWORD *)(v5 + 60) |= 2u;
  v10 = v7;
  sub_1023DBC0((float *)v5, v10, 0.0);
  result = v5;
  if ( *(char *)(a3 + 16) < 0 )
    *(_DWORD *)(v5 + 64) = 128;
  return result;
