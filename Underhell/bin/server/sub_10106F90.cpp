int __thiscall sub_10106F90(float *this, int a2, int a3, int a4, int a5, float a6)
{
  int v7; // edx
  int result; // eax
  int v9; // edi
  ...
  if ( (v12 & 0x100) != 0 )
  {
    v14 = sub_10100630(v7, a2, a3, a5) * this[1046];
...
LABEL_20:
  sub_10100370(*((_DWORD *)this + 1022), a2, a3, a5, v34, (float *)v35);
  result = 0;
  v36 = 0;
  if ( *(int *)(a2 + 144) > 0 )
  {
    while ( 1 )
    {
      if ( !sub_100FF990(*((_DWORD *)this + 1022), v9, a3, *(float *)&a4, result, v13, (int)v34, (float *)v35, v28) )
        goto LABEL_35;
...
LABEL_35:
    ...
    v20 = v30;
LABEL_33:
    v27 = sub_10105BA0((int *)(*((_DWORD *)this + 1023) + 20 * v20));
    sub_100FFDE0((_DWORD *)(*(_DWORD *)(*((_DWORD *)this + 1023) + 20 * v30) + 132 * v27), (int)v28);
    goto LABEL_34;
  }
  return result;
}
