int sub_100CADD0()
{
  ...
  if ( (dword_10696B44 & 1) == 0 )
  {
    dword_10696B44 |= 1u;
    sub_10122040(&unk_106969C8, "should_never_see_this", 0, 4, -1, 0, 0);
    sub_101221E0(
      &unk_10696A14,
      "baseclass",
      0,
    ...
    sub_101221E0(&unk_10696A60, "bcc_localdata", 0, &unk_106967EC, sub_100CAD00);
    sub_10234730(&unk_10696AAC, "m_hActiveWeapon", 2100, 4, -1, sub_10234830);
    v20 = std::_Unchecked<std::_Vector_val<std::_Simple_types<void *>>>;
    sub_10234730(&v1, "m_hMyWeapons", 1908, 4, -1, sub_10234830);
    sub_101223F0(
      (int)&unk_10696AF8,
      (char)"m_hMyWeapons",
      1908,
  ...
  sub_10121D00(&unk_10696A14, 4, off_1060E1E4);
  return 1;
}
