void __usercall sub_10217DF0(int a1@<ebx>, _DWORD *a2, int a3, int a4)
{
  int v5; // esi
  const char *v6; // eax
  int v7; // eax
  ...
  if ( a3 )
  {
    if ( !(*(int (__thiscall **)(int, int))(*(_DWORD *)dword_106BAFE8 + 44))(dword_106BAFE8, a4) )
    {
      v16 = (*(int (__thiscall **)(int, int, _DWORD))(*(_DWORD *)dword_106BAFE8 + 40))(dword_106BAFE8, a4, *a2);
      if ( v16 )
      {
        v17 = 0;
        v5 = (*(int (__thiscall **)(int, _DWORD, int))(*(_DWORD *)dword_106BAFF0 + 152))(
               dword_106BAFF0,
               *(_DWORD *)(a3 + 8),
               a1);
        while ( !(*(unsigned __int8 (__thiscall **)(int))(*(_DWORD *)v5 + 8))(v5) )
        {
          ...
          {
            v7 = (*(int (__thiscall **)(int, int, _DWORD))(*(_DWORD *)dword_106BAFE8 + 40))(dword_106BAFE8, a4, *a2);
        ...
        (*(void (__thiscall **)(int, int))(*(_DWORD *)dword_106BAFF0 + 156))(dword_106BAFF0, v5);
        if ( !v17 )
        {
          v9 = *a2;
          v10 = 0;
