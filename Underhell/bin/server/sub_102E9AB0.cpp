char __thiscall sub_102E9AB0(int this, _DWORD *a2, float *a3)
{
  double v5; // st7
  float *v6; // eax
  double v7; // st1
  ...
  if ( !a2 )
    return 0;
  sub_1014EC90((int)a2, &v19);
  sub_1014ECE0((int)a2, &v22);
  v5 = v19;
  v6 = *(float **)(this + 8);
  v7 = v20 - v6[39];
  v8 = v7 * v7;
  ...
  v30 = v16;
  off_10689714();
  if ( *(float *)(this + 28) * v29 + *(float *)(this + 24) * v28 + *(float *)(this + 32) * v30 <= *(float *)(dword_106E17BC + 44) )
    return 0;
