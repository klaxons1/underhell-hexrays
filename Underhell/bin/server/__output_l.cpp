  ...
  if ( Stream
    && ((Stream->_flag & 0x40) != 0
     || ((v7 = _fileno(Stream), v7 == -1) || v7 == -2
       ? (v8 = &unk_1068F4B0)
       : (v8 = (_BYTE *)(dword_10709BA0[v7 >> 5] + ((v7 & 0x1F) << 6))),
         (v8[36] & 0x7F) == 0
      && (v7 == -1 || v7 == -2
        ? (v9 = (char *)&unk_1068F4B0)
        : (v9 = (char *)(dword_10709BA0[v7 >> 5] + ((v7 & 0x1F) << 6))),
          v9[36] >= 0)))
    && (v10 = 0, a2) )
  {
    v11 = *a2;
    ...
    if ( v11 )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned __int8)(v11 - 32) > 0x58u )
          ...
          v13 = aBadException[(char)v11 + 4] & 0xF;
        v62 = byte_105CD320[8 * v13 + v10] >> 4;
        switch ( v62 )
        {
          case 0:
...
LABEL_123:
              ...
              v56 = (char)v11;
              v55 = v66;
              v32 = (void (__cdecl *)(_DWORD *, char *, int, int, int, int, __crt_locale_pointers *))DecodePointer(off_1068EA38);
              v32(v60, v27, v55, v56, v58, v59, &Locale);
              v33 = v85 & 0x80;
              if ( (v85 & 0x80) != 0 && !v83 )
              {
                v34 = (void (__cdecl *)(char *, __crt_locale_pointers *))DecodePointer(off_1068EA44);
                v34(v27, &Locale);
              }
              if ( v84 == 103 && !v33 )
              {
                v35 = (void (__cdecl *)(char *, __crt_locale_pointers *))DecodePointer(off_1068EA40);
                v35(v27, &Locale);
              }
              if ( *v27 == 45 )
              {
