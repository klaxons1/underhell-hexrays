int _ioinit()
{
  ...
  v0 = (char *)sub_101845E0(32, 64);
  if ( !v0 )
    return -1;
  dword_10709BA0[0] = (int)v0;
  uNumber = 32;
  if ( v0 < v0 + 2048 )
  {
    v2 = v0 + 5;
    ...
    while ( (unsigned int)(v2 - 5) < dword_10709BA0[0] + 2048 );
  }
  if ( StartupInfo.cbReserved2 && StartupInfo.lpReserved2 )
  {
    ...
    if ( (int)uNumber < v3 )
    {
      v4 = (char **)&unk_10709BA4;
      while ( 1 )
      {
        v5 = (char *)sub_101845E0(32, 64);
        if ( !v5 )
          break;
        uNumber += 32;
        *v4 = v5;
...
LABEL_19:
    for ( i = 0; i < v3; ++v17 )
    {
      ...
      {
        v8 = dword_10709BA0[i >> 5] + ((i & 0x1F) << 6);
        *(_DWORD *)v8 = *v16;
        *(_BYTE *)(v8 + 4) = *v17;
