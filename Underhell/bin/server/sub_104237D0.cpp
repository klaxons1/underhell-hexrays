float *__cdecl sub_104237D0(float *a1, float *a2, float *a3, float *a4, float a5, float *a6)
{
  double v7; // st7
  double v8; // st4
  double v9; // st5
  ...
  *(float *)&v12 = *a4 - *a3;
  v13 = a4[1] - a3[1];
  v14 = a4[2] - a3[2];
  off_10689714((float *)&v15);
  off_10689714((float *)&v12);
  ...
  *(float *)&v12 = *(float *)&v12 * v18 + *a3;
  v13 = v13 * v18 + a3[1];
  v14 = v18 * v14 + a3[2];
  return sub_10423440((float *)&v15, a2, a3, (float *)&v12, a5, a6);
}
