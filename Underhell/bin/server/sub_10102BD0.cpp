char __cdecl sub_10102BD0(int a1, int a2, int a3, float *a4, float *a5, float *a6, int a7)
{
  float *v7; // edi
  float *v8; // ebx
  double v9; // st5
  ...
  v41 = a7 + 48 * a1;
  sub_10421CE0(v41, 3, &v55);
  v7 = (float *)(a7 + 48 * a2);
  sub_10421CE0(v7, 3, &v45);
  v8 = (float *)(48 * a3 + a7);
  sub_10421CE0(v8, 3, &v42);
  v9 = a4[1] - v56;
  v10 = a4[2] - v57;
  *(float *)&v58 = *a4 - v55;
  v59 = v9;
  ...
  *(float *)&v48 = *a6 * (v17 * 100.0) + *(float *)&v51;
  ...
  if ( !sub_10102AD0(v40, v61, v64, (float *)&v58, (float *)&v48, (float *)&v53) )
    return 0;
  sub_100FF4B0(v41, (float *)&v53);
  *(float *)&v48 = *(float *)&v58 - *(float *)&v53;
  v49 = v59 - *(float *)&v54;
  v50 = v60 - *((float *)&v54 + 1);
  sub_100FF4B0((int)v7, (float *)&v48);
  v31 = v55;
  result = 1;
  v7[3] = *(float *)&v53 + v55;
  v33 = v56;
