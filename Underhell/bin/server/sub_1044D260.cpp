int sub_1044D260(int a1, char *Format, ...)
{
  int i; // ebx
  ...
  va_start(va, Format);
  sub_10429A50(v7, 0x800u, Format, va);
  sub_10429A00(Buffer, 0x800u, "%s(%d) : %s\n", *(const char **)(a1 + 128), *(_DWORD *)(a1 + 132), v7);
  Warning(Buffer);
  for ( i = 0; i < *(_DWORD *)(a1 + 140); ++i )
  {
    ...
    if ( v3 != 0xFFFF )
    {
      if ( i >= *(_DWORD *)(a1 + 136) )
      {
        v6 = sub_1042EE50(dword_107019F8, v3);
        Warning("(*%s*), ", v6);
      }
      else
      {
        v5 = sub_1042EE50(dword_107019F8, v3);
        Warning("%s, ", v5);
      }
    }
  }
