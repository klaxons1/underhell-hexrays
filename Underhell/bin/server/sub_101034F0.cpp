char __cdecl sub_101034F0(int a1, int a2, int a3, float *a4, int a5)
{
  double v7; // st7
  double v8; // st6
  double v9; // st5
  ...
  sub_10421CE0(a5 + 48 * a1, 3, &v23);
  sub_10421CE0(a5 + 48 * a2, 3, &v20);
  sub_10421CE0(a5 + 48 * a3, 3, &v26);
  v7 = v20 - v23;
  v17 = v7;
  v8 = v21 - v24;
  v18 = v8;
  ...
  off_10689714();
  return sub_10102BD0(a1, a2, a3, a4, &v20, v16, a5);
}
