char *__cdecl asctime(const struct tm *Tm)
{
  ...
  v1 = (char *)&unk_10700AFC;
  v21 = (char *)&unk_10700AFC;
  v2 = _getptd_noexit();
  v3 = v2;
  if ( v2 )
  {
    if ( *(_DWORD *)(v2 + 60) || (v4 = sub_101845E0(26, 1), (*(_DWORD *)(v3 + 60) = v4) != 0) )
    {
      v1 = *(char **)(v3 + 60);
      v21 = v1;
    }
  ...
  *v1 = 0;
  ...
  if ( tm_mday < 1 )
    goto LABEL_6;
  if ( dword_1068F478[tm_mon] - dword_1068F474[tm_mon] < tm_mday )
  {
  ...
  if ( tm_wday <= 6 )
  {
    ...
    for ( i = 0; i < 3; ++i )
    {
      *v5 = byte_105CD380[v12 + i];
      v21[i + 4] = byte_105CD398[3 * tm_mon + i];
      ++v5;
    }
    *v5 = 32;
    v5[4] = 32;
