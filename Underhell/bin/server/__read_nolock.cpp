unsigned int __cdecl _read_nolock(int FileHandle, CHAR *lpBuffer, DWORD nNumberOfBytesToRead)
{
  ...
  v5 = &dword_10709BA0[FileHandle >> 5];
  v6 = *v5;
...
LABEL_18:
  ...
  v9 = (CHAR *)sub_10184390(nNumberOfBytesToRead);
  lpMultiByteStr = v9;
  if ( !v9 )
  {
    *_errno() = 12;
...
LABEL_52:
      ...
      if ( (char)*v24 < 0 )
      {
        ...
        while ( !byte_1068FD50[v25] && v26 <= 4 && v24 >= lpMultiByteStr )
        {
          v25 = (unsigned __int8)*--v24;
          ++v26;
        }
        v27 = *v24;
        if ( !byte_1068FD50[(unsigned __int8)*v24] )
        {
          *_errno() = 42;
LABEL_93:
          v39 = -1;
        ...
        if ( byte_1068FD50[(unsigned __int8)*v24] + 1 == v26 )
        {
          v24 += v26;
        }
...
$error_return$29001:
  if ( lpMultiByteStr != lpBuffer )
    sub_10184660((int)lpMultiByteStr);
  result = v39;
  if ( v39 == -2 )
    return v41;
  return result;
