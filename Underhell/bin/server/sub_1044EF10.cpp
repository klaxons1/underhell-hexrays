BOOL __cdecl sub_1044EF10(int a1, _BYTE *a2)
{
  int v2; // esi
  int v3; // eax
  _BYTE *v4; // ecx
  ...
  if ( (*(_BYTE *)(a1 + 21) & 1) != 0 )
  {
    ...
    v13 = 0;
    v12 = 255;
    v3 = sub_1042E720(v11, "%d %d %d %d", &a1, &v14, &v13, &v12);
    v4 = a2;
    *a2 = a1;
    v4[1] = v14;
    v4[2] = v13;
