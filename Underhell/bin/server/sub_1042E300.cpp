void __thiscall sub_1042E300(int this, int a2, char *a3, int a4)
{
  int v6; // eax
  int v7; // ecx
  int v8; // edi
  ...
  if ( (*(_BYTE *)(this + 21) & 1) != 0 && a2 )
  {
    ...
    else
    {
      ...
      if ( sub_1042DA30((_BYTE *)this, 0, *(_BYTE **)(a2 + 8), *(_DWORD *)(a2 + 12)) )
      {
