        ...
        int a9)
{
  ...
  v59 = sub_102455F0(a1, a2);
  v71 = sub_102454D0(v59);
  v11 = sub_10245470(a1);
  v12 = *(_DWORD *)(v11 + 400);
  ...
  v23 = 0.0;
  v24 = 1.0;
  v25 = (unsigned __int8 *)sub_10244E70(&v70, &v64);
  v26 = *a3;
  ...
  if ( v25 )
  {
    while ( *v25 != 0xFF )
    {
      ...
      if ( v42 >= 0 && (a9 & *(_DWORD *)(a3[11] + 4 * v42)) != 0 )
      {
        ...
        {
          sub_100FE600(v70, v63, v66 + 216 * v41, (_DWORD *)v68, v25, a6 + 16 * v42);
          sub_10101410(v70, v63, v66 + 216 * *v25, v68, v25, (float *)(a5 + 12 * v42));
          v23 = 0.0;
          ++a3[33];
        }
      }
    ...
    if ( v64 > v23 )
      sub_10101F30((int)a3, v17, v65, v66, v71, v60, a5, a6, a9, v64);
    if ( *(_DWORD *)(v71 + 72) )
    {
      v73 = (int)sub_100FE100(&dword_1069A680);
      if ( !v73 )
      {
        v73 = sub_10184390(6144);
        if ( (v73 & 7) != 0 )
          __debugbreak();
      }
      v45 = 0.0;
      ...
      if ( *(int *)(v71 + 72) > 0 )
      {
        do
        {
          v46 = (_DWORD *)sub_10245190(LODWORD(v45));
          if ( !v46 )
            break;
          v47 = *(_DWORD *)(v65 + 24);
          ...
          if ( v48 >= 0 )
          {
            ...
            if ( (a9 & *(_DWORD *)(v49 + 4 * v48)) != 0 )
            {
              ...
              if ( v50 >= 0 && (a9 & *(_DWORD *)(v49 + 4 * v50)) != 0 )
                sub_101031E0((int)a3, v73, (int)&v52, a5, a6, v56, v48, v50, a8, v59, v63);
            }
          }
      ...
      sub_100FE090(&dword_1069A680, (int *)v73);
    }
  }
  else
  {
    v51 = v24;
    sub_10101F30((int)a3, v17, v65, v66, v71, v60, a5, a6, a9, v51);
  }
}
