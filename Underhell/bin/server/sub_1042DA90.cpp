int __thiscall sub_1042DA90(int this, int a2, char a3)
{
  int v4; // ebx
  int v5; // edi
  int v7; // edi
  ...
  if ( (*(_BYTE *)(this + 21) & 1) == 0 )
    return sub_1042D7E0(this);
  v4 = a2;
  if ( !a2 )
    return sub_1042D7E0(this);
  v5 = sub_1042D740((_BYTE *)this, 0);
  if ( !sub_1042DA30((_BYTE *)this, v5, *(_BYTE **)(a2 + 8), *(_DWORD *)(a2 + 12)) )
    return 0;
  v20 = v5;
  v7 = *(_DWORD *)(a2 + 12) + v5;
  v22 = 1;
...
LABEL_17:
  ...
  *(_BYTE *)(this + 20) &= ~2u;
  if ( !v13 || sub_104291C0((_BYTE *)(*(_DWORD *)(this + 12) + v7 + *(_DWORD *)this - *(_DWORD *)(this + 32)), v21, v24) )
  {
    v4 = a2;
    goto LABEL_17;
  }
