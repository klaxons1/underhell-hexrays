int __thiscall sub_101125D0(char *this, int a2)
{
  float *v3; // edi
  float *v4; // edi
  float *v5; // esi
  ...
  *((float *)this + 8) = 0.0;
  ...
  v4 = (float *)(this + 44);
  *((float *)this + 17) = flt_106F1CA8;
  *((float *)this + 18) = flt_106F1CAC;
  *((float *)this + 19) = flt_106F1CB0;
  *((float *)this + 20) = flt_106F1CA8;
  *((float *)this + 21) = flt_106F1CAC;
  *((float *)this + 22) = flt_106F1CB0;
