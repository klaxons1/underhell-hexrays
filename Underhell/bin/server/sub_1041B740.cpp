char __thiscall sub_1041B740(int this, int a2, int a3, int a4)
{
  char v5; // al
  double v6; // st7
  double v7; // st7
  ...
  *(_BYTE *)(this + 4) = v5;
  ...
  {
    v62 = 0;
    sub_1042E720(a2, "%d", &v62);
  }
  else
  {
    sub_10087860((_DWORD *)a2, (char *)&v62);
  }
  (*(void (__thiscall **)(int, int, char *, int))(*(_DWORD *)a4 + 4))(a4, v62, Src, 256);
  sub_10431100(Src);
  sub_10087780((_DWORD *)a2, &v63, (int)"%f");
  v6 = *(float *)&v63;
  ...
  *(float *)(this + 76) = *(float *)&v63;
  ...
  (*(void (__thiscall **)(int, int, char *, int))(*(_DWORD *)a4 + 4))(a4, v62, Source, 2048);
  sub_10418460(Source);
  if ( !sub_1041A850((int *)(this + 92), 0, (_DWORD *)a2, a4) )
    return 0;
  v10 = sub_1041A0B0((_DWORD *)a2);
  ...
  if ( v11 )
  {
    ...
    do
    {
      ...
      *(float *)&v68[4] = (double)v61 * 0.0039215689;
      sub_1041B080((int *)(this + 188), v15, (int)v68);
      if ( v68[2] >= 0 && v68[0] )
  ...
  if ( v16 )
  {
    ...
    do
    {
      ...
      else if ( (unsigned __int8)sub_1042D170(2) )
      {
        ...
        if ( (*(_BYTE *)(a2 + 44) & 1) != 0 )
        {
          sub_10086860((_BYTE *)(a2 + 44), (char *)&v62, (char *)(*(_DWORD *)(a2 + 12) + v18), 1);
          *(_DWORD *)(a2 + 12) += 2;
        }
        else
        {
      ...
      sub_1041B340((int *)this, v69, v58, 0);
      --v17;
    }
    while ( v17 );
  }
...
LABEL_103:
        ...
        sub_1041B4F0((_DWORD *)this, v63, v69, v60);
        --v67;
      }
      while ( v67 );
    }
...
LABEL_154:
  v47 = v66;
  if ( !sub_1041A980(v66, (int)v66, a2, v42) )
    return 0;
  if ( *((_BYTE *)v47 + 4) == 12 )
  {
    if ( (*(_BYTE *)(a2 + 21) & 1) != 0 )
