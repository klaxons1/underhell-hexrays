void __thiscall sub_10246010(int *this, char *a2)
{
  int *v2; // edi
  bool v3; // zf
  char *v4; // esi
  ...
  *((_BYTE *)v2 + 8) = 1;
  ...
  while ( 1 )
  {
    v10 = (_DWORD *)sub_10245550(v4, v9);
    v3 = (v10[3] & 0x1000) == 0;
    v50 = v10;
    if ( v3 )
      sub_100BAC80((int)a2, v9);
    v11 = v10[4];
    if ( v11 >= 0 )
    {
      v12 = v10[5];
      ...
      v48[1] = 0;
      v48[2] = 1;
      if ( sub_100BAE70(v2 + 3, v48, (int *)&v52, &v53) )
        v13 = v53 | (v52 << 16);
      else
        v13 = -1;
      v14 = HIWORD(v13);
      ...
      if ( !sub_100BAE70(v2 + 3, v48, &v49, (int *)&v50) )
        sub_102A4E30(*(_DWORD *)(v2[3] + 20 * v49 + 12), v48);
    }
LABEL_27:
    v54 = ++v9;
    if ( v9 >= v55 )
...
LABEL_34:
    ...
    v31 = sub_10184390(v19 >> 30 != 0 ? -1 : 4 * v19);
    v32 = 4 * v53 + 19;
    v52 = v31;
    *v2 = v31;
    v32 &= 0xFFFFFFF0;
    ...
    do
    {
      v35 = sub_10245550(a2, v34);
      v36 = *(_DWORD *)(v35 + 16);
      v49 = v36;
      if ( v36 >= 0 )
      {
        v37 = sub_10430E70(v36);
        if ( *((_BYTE *)v2 + 34) )
          v38 = v37 & v2[9];
        else
          v38 = v37 % v2[6];
