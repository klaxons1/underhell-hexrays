char __usercall sub_10101850@<al>(int a1@<ebp>, int a2, const void *a3, int *a4, int a5, int a6, int a7, int a8)
{
  int v8; // eax
  int v9; // edx
  int v10; // ecx
  ...
  *(_BYTE *)(a8 + 55) = 0;
  ...
  while ( 1 )
  {
    ...
    {
      if ( (unsigned __int8)sub_10114C90((int)v24, *(_DWORD *)(a6 + 4 * v32), v11 + 8, v11 + 20, 0.0, (int)v25) )
      {
        *(float *)a8 = v25[0];
        v12 = v26;
        v13 = v27;
