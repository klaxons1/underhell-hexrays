void __thiscall sub_102156A0(_BYTE *this, int a2, char *String1, char *String)
{
  if ( !_stricmp(String1, "model") )
  {
    sub_10215600(String, 0x200u, (char *)(a2 + 12));
  }
  ...
  {
    sub_104299C0((char *)(a2 + 524), String, 0x200u);
    *(_BYTE *)(a2 + 1061) = 1;
  }
  ...
  {
    if ( sub_10043F40(String, "server") )
    {
      *(_DWORD *)(a2 + 1064) = 1;
    }
    else if ( sub_10043F40(String, "client") )
    {
      *(_DWORD *)(a2 + 1064) = 2;
    }
  }
