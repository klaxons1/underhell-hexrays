  ...
  if ( (v7 & 0x7FFFFu) - 260864 >= 0x3BB )
  {
    ...
    if ( v18 >= 0x41 )
    {
      ...
      if ( v34 >= 0x3800 )
      {
        ...
        else
        {
          ...
          *(double *)a5.m128i_i64 = sqrt(*(double *)a5.m128i_i64);
          v43 = _mm_mul_pd((__m128d)xmmword_105CB520, v42);
          v44 = (__m128d)_mm_shuffle_epi32((__m128i)v42, 68);
          epi16 = _mm_extract_epi16((__m128i)v9, 3);
          v46 = _mm_mul_pd(v42, v42);
          v47 = _mm_add_pd(_mm_add_pd((__m128d)xmmword_105CB530, v43), _mm_mul_pd((__m128d)xmmword_105CB540, v46));
      ...
      else
      {
        ...
        v39 = _mm_add_pd(
                _mm_add_pd(_mm_mul_pd((__m128d)xmmword_105CB520, v37), (__m128d)xmmword_105CB530),
                _mm_mul_pd((__m128d)xmmword_105CB540, _mm_mul_pd(v37, v37)));
        v37.m128d_f64[0] = *(double *)_mm_shuffle_epi32((__m128i)xmmword_105CB4A0, 238).m128i_i64;
    ...
    else
    {
      ...
      *(_QWORD *)&v27 = COERCE_UNSIGNED_INT64(NAN) & a4.m128i_i64[0] | v23;
      ...
      v29 = *(double *)a4.m128i_i64 * *(double *)&qword_105CACA0[v28];
      v30 = v22 * v27 - v29 + v21 * v27;
      v31 = v25 - v27 * v27 - v24;
      v32 = (__m128i)_mm_add_pd(
                       _mm_and_pd((__m128d)_mm_shuffle_epi32(_mm_cvtsi32_si128(v26), 0), (__m128d)xmmword_105CB4B0),
                       (__m128d)xmmword_105C9DA0[v28]);
