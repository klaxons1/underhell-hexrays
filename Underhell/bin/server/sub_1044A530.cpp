void __thiscall sub_1044A530(_BYTE *this, int a2, _BYTE *a3)
{
  _BYTE *v3; // esi
  int v5; // eax
  int v6; // ebx
...
LABEL_19:
    ...
    sub_1042DEC0(v14, *((_DWORD *)v3 + 1), strlen(*((const char **)v3 + 1)), 9);
    sub_1044C720(*((_DWORD *)v3 + 2), v14);
    v9 = v12;
    if ( v14[2] >= 0 && v14[0] )
...
LABEL_10:
    ...
    if ( *((_DWORD *)v3 + 2) == *(_DWORD *)v9 )
    {
      if ( v10 == 5 )
      {
        v11 = (char *)sub_10430F10(*((_DWORD **)v9 + 2));
        sub_104299C0((char *)v6, v11, *((_DWORD *)v3 + 4));
      }
