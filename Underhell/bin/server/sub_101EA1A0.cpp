int __thiscall sub_101EA1A0(int *this, char a2)
{
  int v3; // ecx
  int v4; // eax
  __int16 v5; // cx
  ...
  {
    result = v3;
    *((_WORD *)this + 8) = *(_WORD *)(*this + 40 * v3 + 38);
  }
  v12 = *this;
  v13 = 40 * (unsigned __int16)result;
  if ( a2 )
  {
    *(_WORD *)(v13 + v12 + 38) = -1;
    *(_WORD *)(v13 + *this + 36) = -1;
  ...
  {
    *(_WORD *)(v13 + v12 + 38) = result;
    *(_WORD *)(v13 + *this + 36) = result;
  }
  this[6] = *this;
  return result;
}
