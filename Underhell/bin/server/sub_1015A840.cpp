int __thiscall sub_1015A840(_DWORD *this, float *a2, int a3)
{
  int v4; // eax
  int v5; // ebx
  double v6; // st7
...
LABEL_12:
    ...
    if ( v31 )
      break;
    (*(void (__thiscall **)(int, float *, int))(*(_DWORD *)dword_106B6E60 + 8))(dword_106B6E60, v68, this[2] + 64);
    v32 = v70;
    if ( v70 > 0.7 )
      v97 |= 1u;
    if ( 0.0 == v32 )
...
LABEL_68:
    ...
    *v33 = v69[3];
    ...
    if ( v5 == 1 )
    {
      ...
      if ( *(_BYTE *)(v35 + 306) == 2 )
      {
        if ( !sub_101C5260(v35) )
        {
          if ( v64 <= 0.7 )
          {
            v55 = (1.0 - *(float *)(this[1] + 4512)) * *(float *)(dword_106B738C + 44) + 1.0;
            sub_10157180((float *)&v94, (float *)&v62, (float *)&v84, v55);
          }
          else
          {
            sub_10157180((float *)&v94, (float *)&v62, (float *)&v84, 1.0);
          }
          v36 = *(float *)&v84;
          v37 = (float *)this[2];
          v37[16] = *(float *)&v84;
    ...
    if ( v5 > 0 )
    {
      ...
      do
      {
        sub_10157180((float *)&v94, (float *)v91, (float *)(this[2] + 64), 1.0);
        v10 = 0.0;
        v40 = 0;
        if ( v5 >= 4 )
        {
