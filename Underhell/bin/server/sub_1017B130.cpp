int __thiscall sub_1017B130(int this)
{
  int result; // eax
  int v3; // esi
  int v4; // esi
  ...
  if ( (*(_BYTE *)(this + 236) & 1) != 0 )
  {
    ...
    sub_10429A00(Buffer, 0x200u, "    Initial Value: %f", SLOBYTE(ArgList));
    sub_100D5DE0((_DWORD *)this, v3, (int)Buffer, 0.0, 255, 255, 255, 255);
    ArgLista = *(float *)(this + 804);
    v4 = v3 + 1;
    sub_10429A00(Buffer, 0x200u, "    Compare Value: %f", SLOBYTE(ArgLista));
