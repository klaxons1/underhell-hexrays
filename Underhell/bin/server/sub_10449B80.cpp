bool __thiscall sub_10449B80(void *this, int a2, int a3, _DWORD *a4, int a5, int a6, int a7)
{
  int v7; // edi
  int v8; // eax
  char *v9; // edi
  ...
  {
    v20 = 0;
    sub_1042E720(a2, "%d", &v20);
  }
  else
  {
    sub_100878C0((_DWORD *)a2, &v20);
  }
  v21 = 0;
  if ( v20 <= 0 )
  {
LABEL_29:
  ...
  while ( !a7 )
  {
    sub_1042E170(a2, v23, 1024);
    v9 = v23;
LABEL_16:
    if ( (*(_BYTE *)(a2 + 21) & 1) != 0 )
    {
      v18 = 0;
      sub_1042E720(a2, "%c", &v18);
    }
    else if ( sub_1042D170(a2, 1) )
    {
      v10 = *(_DWORD *)(a2 + 12) + 1;
