void __thiscall sub_10111D60(char *this, float *a2, float *a3)
{
  float *v4; // eax
  int v5; // eax
  int v6; // eax
  ...
  if ( (*(int (__thiscall **)(char *))(*(_DWORD *)this + 44))(this) != 5 || this[40] == 4 )
  {
    switch ( this[40] )
    {
      case 0:
        ...
        sub_10111D30(this, v11, a2, a3);
        break;
      case 1:
        v7 = (*(int (__thiscall **)(char *))(*(_DWORD *)this + 44))(this);
        sub_10111D30(this, v7 == 6, a2, a3);
        break;
      case 2:
        v8 = (*(int (__thiscall **)(_DWORD))(**((_DWORD **)this + 1) + 208))(*((_DWORD *)this + 1));
        if ( v8 )
          sub_100C0880(v8, a2, a3);
        break;
      case 3:
        ...
        *a3 = *v10 + *((float *)this + 14);
        ...
        break;
      case 4:
        (*(void (__thiscall **)(_DWORD, float *, float *))(**((_DWORD **)this + 1) + 56))(*((_DWORD *)this + 1), a2, a3);
        break;
      case 5:
        sub_10111C70((int)this, a2, a3);
        break;
      case 6:
