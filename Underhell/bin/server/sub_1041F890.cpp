int __thiscall sub_1041F890(int this, unsigned __int16 a2)
{
  ...
  v3 = sub_1041F220((_DWORD *)this, a2)[1];
  v4 = 12 * a2;
  *(_WORD *)(*(_DWORD *)(this + 4) + v4 + 2) = *sub_1041F220((_DWORD *)this, v3);
  if ( *sub_1041F220((_DWORD *)this, v3) != -1 )
    *(_WORD *)(*(_DWORD *)(this + 4) + 12 * (unsigned __int16)*sub_1041F220((_DWORD *)this, v3) + 4) = a2;
  if ( v3 != 0xFFFF )
  ...
  else
  {
    ...
    if ( *sub_1041F220((_DWORD *)this, v5[2]) == a2 )
