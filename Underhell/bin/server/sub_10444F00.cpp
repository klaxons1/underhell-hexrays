int __cdecl sub_10444F00(unsigned __int16 *a1, unsigned int *a2)
{
  ...
  if ( v3 != -16383 )
  {
    ...
    v8 = dword_1068FA58 - 1;
    v53 = v3;
    v59 = dword_1068FA58 / 32;
    v9 = &v74 + dword_1068FA58 / 32;
    v51 = 31 - dword_1068FA58 % 32;
    if ( ((1 << v51) & *v9) != 0 )
    {
      v10 = dword_1068FA58 / 32;
      for ( i = (~(-1 << (31 - dword_1068FA58 % 32)) & *(&v74 + v59)) == 0; i; i = *(&v74 + v10) == 0 )
      {
        if ( ++v10 >= 3 )
          goto LABEL_21;
      }
...
LABEL_21:
    *v9 &= -1 << v51;
    ...
    if ( v65 )
      ++v3;
    if ( v3 >= dword_1068FA54 - dword_1068FA58 )
    {
      if ( v3 > dword_1068FA54 )
      {
        if ( v3 < dword_1068FA50 )
        {
          v5 = dword_1068FA64 + v3;
          v74 &= ~0x80000000;
          v44 = dword_1068FA5C / 32;
          v45 = dword_1068FA5C % 32;
          v64 = 0;
          for ( j = 0; j < 3; ++j )
          {
            v58 = ~(-1 << v45) & *(&v74 + j);
        ...
        else
        {
          ...
          v76 = 0;
          v74 = 0x80000000;
          v39 = dword_1068FA5C / 32;
          v40 = dword_1068FA5C % 32;
          v63 = 0;
          for ( k = 0; k < 3; ++k )
          {
            v41 = (int *)(&v74 + k);
          ...
          while ( v42 >= 0 );
          v5 = dword_1068FA50 + dword_1068FA64;
          result = 1;
        }
        goto LABEL_78;
      }
      v74 = v71;
      v75 = v72;
      v17 = (dword_1068FA54 - v53) / 32;
      v76 = v73;
      v18 = (dword_1068FA54 - v53) % 32;
      v60 = 0;
      for ( m = 0; m < 3; ++m )
      {
        v19 = (int *)(&v74 + m);
      ...
      while ( v20 >= 0 );
      v22 = dword_1068FA58 - 1;
      v23 = dword_1068FA58 / 32;
      v52 = dword_1068FA58 / 32;
      v24 = &v74 + dword_1068FA58 / 32;
      v55 = 31 - dword_1068FA58 % 32;
      if ( ((1 << v55) & *v24) != 0 )
      {
        for ( n = (~(-1 << (31 - dword_1068FA58 % 32)) & *(&v74 + v23)) == 0; n; n = *(&v74 + v23) == 0 )
        {
          if ( ++v23 >= 3 )
            goto LABEL_51;
        }
...
LABEL_51:
      *v24 &= -1 << v55;
      ...
      v34 = (dword_1068FA5C + 1) / 32;
      v35 = (dword_1068FA5C + 1) % 32;
      v62 = 0;
      for ( jj = 0; jj < 3; ++jj )
      {
        v36 = (int *)(&v74 + jj);
  ...
  result = 2;
LABEL_78:
  v48 = v74 | (v50 != 0 ? 0x80000000 : 0) | (v5 << (31 - dword_1068FA5C));
  if ( dword_1068FA60 == 64 )
  {
    v49 = v75;
    a2[1] = v48;
    *a2 = v49;
  }
  else if ( dword_1068FA60 == 32 )
  {
    *a2 = v48;
  }
  return result;
