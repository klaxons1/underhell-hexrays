int __thiscall sub_10065E30(int this, __int16 a2)
{
  __int16 v4; // di
  __int16 v5; // ax
  int result; // eax
  ...
  v4 = sub_10065A20((_DWORD *)this, a2);
  *(_WORD *)(80 * a2 + *(_DWORD *)(this + 4)) = sub_10065A80((_DWORD *)this, v4);
  v7 = 80 * a2;
  if ( sub_10065A80((_DWORD *)this, v4) != -1 )
    *(_WORD *)(*(_DWORD *)(this + 4) + 80 * sub_10065A80((_DWORD *)this, v4) + 4) = a2;
  if ( v4 != -1 )
