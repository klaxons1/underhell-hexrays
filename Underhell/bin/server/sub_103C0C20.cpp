...
char __userpurge sub_103C0C20@<al>(
        int a1@<ecx>,
        int a2@<ebp>,
        int a3@<edi>,
        int a4@<esi>,
        ...
        int a9)
{
  ...
  if ( v10 )
  {
    (*(void (__thiscall **)(float *, int *))(*(_DWORD *)v10 + 76))(v10, v39);
    v34 = v10 + 280;
    ...
    v42 = v11;
    *((_BYTE *)v10 + 1212) = 0;
    sub_100BCCA0(v12, v12[950], SLODWORD(v40), SLODWORD(v41));
    v13 = *(_DWORD *)(a5 + 44) == 7;
    v36 = v31;
    v37 = v32;
    v38 = v33;
    ...
    v30[0] = v40 * 12.0 + v36;
    v30[1] = *(float *)&v39 * 12.0 + v37;
    v30[2] = 12.0 * v42 + v38;
    sub_10107970(v10, v30, &v40, (int)v39);
    v24[6] = 0.0;
    v24[7] = 0.0;
