char __thiscall sub_101C96F0(int (__cdecl **this)(_DWORD), int a2)
{
  _DWORD *v2; // ebx
  int *v3; // eax
  unsigned int v4; // esi
  ...
  v13[1] = 0;
  v14 = this + 1;
  LOBYTE(v3) = sub_101C90F0(this + 1, (int)v13, &a2, &v15);
  if ( (_BYTE)v3 )
  {
    v4 = v15 | (a2 << 16);
    if ( v4 != -1 )
    {
      ...
      if ( v8 )
      {
        v12 = *v8;
        a2 = *v8;
        sub_101C74F0((int)dword_1063873C, v12);
        sub_101C5740(&dword_10638748, a2);
        *(_WORD *)(dword_10638748 + 10 * (unsigned __int16)a2 + 8) = word_10638758;
        word_10638758 = a2;
        sub_10184660((int)v8);
      }
      v3 = (int *)(*v14 + 20 * v5);
