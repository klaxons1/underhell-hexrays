int __thiscall sub_101D61E0(int this, unsigned __int16 a2)
{
    ...
    do
    {
      ...
      if ( v2 == *(_WORD *)v8 )
      {
        ...
        if ( *((_WORD *)v16 + 3) == 1 )
        {
          ...
          v19 = (_WORD)v18 == 0xFFFF ? &dword_106BAE74 : (int *)(*(_DWORD *)(this + 4) + 16 * v18);
          if ( *((_WORD *)v19 + 3) == 1 )
            goto LABEL_64;
        }
        if ( (v4 & 1) == 0 )
      ...
      else
      {
        ...
        if ( *((_WORD *)v35 + 3) == 1 )
        {
          ...
          v38 = (_WORD)v37 == 0xFFFF ? &dword_106BAE74 : (int *)(*(_DWORD *)(this + 4) + 16 * v37);
          if ( *((_WORD *)v38 + 3) == 1 )
          {
LABEL_64:
            if ( (_WORD)v10 != 0xFFFF )
