int (__thiscall ***__thiscall sub_103E0120(_DWORD *this))(_DWORD, _DWORD)
{
  int v2; // eax
  ...
  sub_102075B0(this);
  this[441] = sub_100BEF30((int)this, "gun");
  this[442] = sub_100BEF30((int)this, "muzzle");
  this[453] = sub_100BEF30((int)this, "splash_pt");
  sub_103DF970(this);
  v2 = (*(int (__thiscall **)(_DWORD *))(*this + 340))(this);
