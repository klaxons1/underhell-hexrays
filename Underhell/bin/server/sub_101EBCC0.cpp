...
int __userpurge sub_101EBCC0@<eax>(int a1@<ebp>, int a2@<edi>, int a3@<esi>, int a4, int a5, int a6, int a7)
{
  float v7; // edx
  float v8; // eax
  float v9; // ecx
  ...
  _BYTE v39[12]; // [esp+8Ch] [ebp-B4h] BYREF
  ...
  sub_10265570(a7, 0);
  (*(void (__thiscall **)(int, float *, int, _BYTE *, float *, int, int))(*(_DWORD *)dword_106B31F4 + 16))(
    dword_106B31F4,
    v36,
    100679691,
    v39,
    ...
    for ( i = 0; i < 2; ++i )
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v36[2] = v77;
          sub_10265570(a7, 0);
          (*(void (__thiscall **)(int, float *, int, _BYTE *, float *))(*(_DWORD *)dword_106B31F4 + 16))(
            dword_106B31F4,
            v36,
            100679691,
            v39,
