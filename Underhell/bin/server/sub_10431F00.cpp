bool __thiscall sub_10431F00(int this, unsigned __int8 *Src, int a3)
{
  ...
  if ( a3 + *(_DWORD *)(this + 12) <= *(_DWORD *)(this + 8) )
  {
    if ( ((unsigned __int8)Src & 3) != 0 )
    {
      do
      {
        if ( v5 < 8 )
          break;
        sub_101532C0((_DWORD *)this, *v3++, 8, 0);
        v5 -= 8;
      }
    ...
    if ( v5 >= 32 )
    {
      ...
      if ( v5 >= 32 )
      {
        ...
        v16 = 32 - v9;
        v17 = dword_106FF998[33 * v9];
        v15 = dword_106FF918[v9];
    ...
    if ( v5 )
      sub_101532C0((_DWORD *)this, *v3, v5, 0);
