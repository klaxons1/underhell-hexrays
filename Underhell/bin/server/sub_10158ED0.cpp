float *__thiscall sub_10158ED0(_DWORD *this)
{
  int v2; // eax
  double v3; // st7
  double v4; // st6
  ...
  sub_104222B0(this[2] + 12, v54, v53, v42);
  v2 = this[2];
  ...
  {
    v16 = v15 - *(float *)(dword_106B31C8 + 16) * v15 * *(float *)(dword_106B7344 + 44) * *(float *)(this[1] + 4512);
    if ( v16 < 0.1 )
      v16 = 0.0;
    v17 = (float *)this[2];
    v18 = v16 / v15;
  ...
  if ( v62 >= 0.1 )
  {
    ...
    {
      off_10689714();
      v23 = *(float *)(dword_106B714C + 44) * v62 * *(float *)(dword_106B31C8 + 16) * *(float *)(this[1] + 4512);
      if ( v58 < v23 )
        v23 = v58;
      v24 = (float *)this[2];
      v25 = v63 * v23;
  ...
  v30 = v28 + 38;
  v31 = *this;
  v28[16] = v28[16] + v29[116];
  v32 = *(int (__thiscall **)(_DWORD *, _DWORD, int, _BYTE *))(v31 + 44);
  v28[17] = v28[17] + v29[117];
  v28[18] = v28[18] + v29[118];
...
LABEL_36:
  v41 = (float *)this[1];
  result[16] = result[16] - v41[116];
  result[17] = result[17] - v41[117];
  result[18] = result[18] - v41[118];
  return result;
}
