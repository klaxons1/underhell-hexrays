bool __cdecl sub_1044C440(int a1, int *a2)
{
  int v2; // edi
  int v3; // ebx
  int v4; // ebp
  ...
  if ( (*(_BYTE *)(a1 + 21) & 1) != 0 )
  {
    ...
    else
    {
      while ( 1 )
      {
        ...
        if ( v13 )
          sub_10431290(v13);
        if ( !(unsigned __int8)sub_1044EBD0(a1, v12 + *a2) )
          break;
        sub_1042D6E0((_DWORD *)a1);
        if ( *(_BYTE *)(a1 + 20) )
          return 1;
  ...
  else
  {
    ...
    if ( v14 && (sub_1044B060(a2, v14), v4 = 0, v3 > 0) )
    {
      for ( i = 0; ; i += 16 )
      {
        sub_1044B540(a2, a2[3]);
        if ( !(unsigned __int8)sub_1044EBD0(a1, i + *a2) )
          break;
        if ( ++v4 >= v3 )
        {
          v2 = a1;
