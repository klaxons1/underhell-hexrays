...
_DWORD *__userpurge sub_10158680@<eax>(
        _DWORD *a1@<ecx>,
        int a2@<ebp>,
        int a3@<edi>,
        int a4@<esi>,
        ...
        int a8)
{
  ...
  sub_1001F200(v17, a6, a6, v10, v19);
  v11 = *(_DWORD *)(a1[2] + 4);
  if ( v11 == -1 || off_1061BE18[4 * (*(_DWORD *)(a1[2] + 4) & 0xFFF) + 2] != v11 >> 12 )
    v12 = 0;
  else
    v12 = off_1061BE18[4 * (*(_DWORD *)(a1[2] + 4) & 0xFFF) + 1];
  (*(void (__thiscall **)(_DWORD *, _DWORD))(*a1 + 44))(a1, 0);
  sub_10265570(v12, a7);
  v13 = *(void (__thiscall **)(int, float *, int))(*(_DWORD *)dword_106B31F4 + 16);
  v19 = (float *)a8;
  v18[2] = v18;
  v13(dword_106B31F4, v17, a8);
