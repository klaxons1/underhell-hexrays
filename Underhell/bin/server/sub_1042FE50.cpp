HMODULE __usercall sub_1042FE50@<eax>(int a1@<ebx>, char *Source)
{
  ...
  sub_104299C0(LibFileName, Source, 1024);
  if ( !sub_104295F0(LibFileName, ".dll") )
    sub_10429750(LibFileName, ".dll", 0x400u, -1);
  sub_10429910(LibFileName, 92);
  ...
  v7 = LibFileName;
  v8 = 0;
  v4 = CreateSimpleThread(sub_1042FE30, &v7);
  v9 = v4;
