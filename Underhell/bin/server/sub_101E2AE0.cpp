int __usercall sub_101E2AE0@<eax>(int a1@<edi>)
{
  int v1; // eax
  int result; // eax
  char *v3; // esi
  ...
  sub_10422220(v1, v8);
  result = sub_101811E0("prop_vehicle_jeep", -1);
  v3 = (char *)result;
  if ( result )
  {
    v4 = *(_DWORD *)(a1 + 252) >> 11;
    ...
    (*(void (__thiscall **)(char *, const char *, const char *))(*(_DWORD *)v3 + 128))(v3, "targetname", "jeep");
    (*(void (__thiscall **)(char *, const char *, const char *))(*(_DWORD *)v3 + 128))(
      v3,
      "vehiclescript",
