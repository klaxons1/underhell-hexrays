int __thiscall sub_100ADFC0(_DWORD *this, int a2)
{
  int v2; // edx
  int v4; // eax
  int *v5; // ecx
  ...
  if ( a2 != this[4] )
  {
    while ( 1 )
    {
      ...
      v11 = v10[2];
      v12 = sub_100ACF50(this, v9);
      v13 = dword_10695154;
      if ( v12 )
      {
        if ( (dword_10695154 & 1) == 0 )
        {
          v13 = dword_10695154 | 1;
          dword_10695154 |= 1u;
          dword_10695144 = -1;
          dword_10695148 = -1;
          dword_1069514C = -1;
        ...
        {
          a2 = v9;
          sub_100AD010(this, v9);
          v17 = dword_10695154;
          if ( (dword_10695154 & 1) == 0 )
          {
            v17 = dword_10695154 | 1;
            dword_10695154 |= 1u;
            dword_10695144 = -1;
            dword_10695148 = -1;
            dword_1069514C = -1;
...
LABEL_61:
        ...
        if ( sub_100ACF50(this, a2) )
        {
          a2 = v9;
          sub_100AD1C0(this, v9);
          v22 = dword_10695154;
          if ( (dword_10695154 & 1) == 0 )
          {
            v22 = dword_10695154 | 1;
            dword_10695154 |= 1u;
            dword_10695144 = -1;
            dword_10695148 = -1;
            dword_1069514C = -1;
