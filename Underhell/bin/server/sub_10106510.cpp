int __userpurge sub_10106510@<eax>(int a1@<eax>, int a2@<ecx>, int a3, int a4, int a5, int a6)
{
  double v6; // st7
  double v7; // st6
  int v9; // ecx
  ...
  *(float *)&result = COERCE_FLOAT(sub_10106010((_DWORD *)a1, a2));
  v110 = 0.0;
  if ( *(int *)(a2 + 4104) <= 0 )
  {
    v30 = 0.0;
          ...
          switch ( *(_DWORD *)(v19 + 4) )
          {
            ...
            case 5:
              ...
              *(_DWORD *)(v20 + 4) = *(_DWORD *)(v19 + 4);
              ...
              {
                sub_104251E0(v20 + 24, v19 + 44, *(float *)(v19 + 96), v20 + 24);
                v21 = *(float *)(v19 + 96);
  ...
  if ( *(int *)(a2 + 4080) > 0 )
  {
    ...
    do
    {
      if ( v30 < *(float *)(v31 + 44) )
      {
        ...
        sub_10102F30(v32, v108 + 4132, a3, a4, v34, a5, a6);
        sub_10425290(v31 - 24, v31 - 36, v86);
        sub_10424F80(v86, v86);
        sub_10421E30(a5 + 48 * v34, v86, v85);
        ...
        *(float *)(v31 + 56) = *(float *)v31;
        ...
        if ( !v42 )
        {
          if ( 1.0 == *(float *)(v31 + 20) )
          {
            ...
            *(float *)(v31 + 224) = v44;
            *(float *)(v31 + 228) = v45;
            sub_10422E20(v31 + 60, -1.0, (int)v88);
            sub_10422EC0(v88, v31 + 204, v93);
            sub_10422DC0(v93);
            *(float *)(v31 + 232) = v93[0];
            *(float *)(v31 + 236) = v93[1];
            *(float *)(v31 + 240) = v93[2];
          ...
          else
          {
            ...
            else
            {
              ...
              *(float *)(v31 + 228) = v50 * *(float *)(v31 + 228);
              v80 = v50;
              sub_10422E20(v31 + 232, v80, v31 + 232);
              v51 = 1.0;
            }
            ...
            *(float *)(v31 + 56) = v53;
            v81 = v51;
            sub_10422E20(v31 + 232, v81, (int)v87);
            sub_10422EC0(v31 + 60, v87, v94);
            sub_10422DC0(v94);
            *(float *)v41 = v94[0];
            *(float *)(v31 + 64) = v94[1];
            *(float *)(v31 + 68) = v94[2];
        ...
        sub_10421CE0(a5 + 48 * *(_DWORD *)(v33 + *(_DWORD *)(v33 + 12)), 3, &v105);
        sub_10421CE0(a5 + 48 * *(_DWORD *)(*(_DWORD *)(v33 + 12) + v33 + 28), 3, &v101);
        sub_10421CE0(a5 + 48 * *(_DWORD *)(*(_DWORD *)(v33 + 12) + v33 + 56), 3, &v95);
        v82 = (v101 - v105) * (v101 - v105) + (v102 - v106) * (v102 - v106) + (v103 - v107) * (v103 - v107);
        v111 = off_10689708(v82);
        v83 = (v95 - v101) * (v95 - v101) + (v96 - v102) * (v96 - v102) + (v97 - v103) * (v97 - v103);
        v110 = off_10689708(v83);
        if ( *(_BYTE *)(v31 + 153) )
        {
