int __cdecl sub_10110230(int *a1)
{
  int result; // eax
  int v2; // esi
  bool v3; // cc
      ...
      if ( (_BYTE)result )
      {
        if ( *a1 >= 3 )
        {
          ...
          if ( *a1 == 4 )
            ...
            v8 = v10;
          v9[2] = v8;
          (*(void (__thiscall **)(int, float *, _DWORD, _DWORD))(*(_DWORD *)v2 + 416))(v2, v9, 0, 0);
          result = sub_1010FC80(v2);
          if ( !(_BYTE)result && *(_BYTE *)(v2 + 306) != 8 )
            return sub_1010EB30((_DWORD *)v2);
        }
        else
        {
          return sub_102601C0(v2, 2, "Usage:  setpos_exact x y <z optional>\n", 0, 0, 0, 0);
        }
      }
    }
  }
