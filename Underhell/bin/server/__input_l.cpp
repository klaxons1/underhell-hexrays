int __cdecl _input_l(FILE *a1, unsigned __int8 *a2, struct localeinfo_struct *a3, _WORD **a4)
{
  ...
  _BYTE *v93; // [esp+58h] [ebp-1B0h] BYREF
...
$f_incwidth$29477:
      ...
      for ( i = (unsigned __int8)Character; isdigit(i); i = (unsigned __int8)Character )
      {
        ...
        ++v94;
        v93[v22] = Character;
        if ( !__check_float_string((void **)&v93, &v83, ++v22, Src, &v86) )
          goto $error_return$29306;
        ++v105;
...
$f_incwidth2$29507:
      ...
      if ( v94 )
      {
        if ( !v100 )
        {
          ...
          v93[v22] = 0;
          v62 = (char)v106 - 1;
          v37 = DecodePointer(off_1068EA3C);
