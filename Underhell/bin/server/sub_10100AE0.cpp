char __cdecl sub_10100AE0(int a1, int a2, float a3, float a4, int a5, float *a6, float *a7)
{
  double v7; // st7
  int v10; // ecx
  int v11; // ebx
  ...
  v29 = sub_10245550(a2);
  sub_10100370(a1, v29, a2, a5, v21, v22);
  v7 = 0.0;
  *a6 = 0.0;
  a6[1] = 0.0;
  a6[2] = 0.0;
  *a7 = 0.0;
  ...
  do
  {
    ...
    *(float *)&v23 = v7;
    v24 = v7;
    v25 = v7;
    if ( sub_10100980((_DWORD *)v11, a3, a4, (int)&v26, (int)&v23) )
    {
