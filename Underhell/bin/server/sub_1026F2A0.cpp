int __thiscall sub_1026F2A0(int this)
{
  ...
  if ( (**(int (__thiscall ***)(int))(this + 1576))(this + 1576) )
  {
    v2 = *(void (__thiscall **)(int))(this + 8);
    if ( v2 )
      v2(this);
    if ( *(_BYTE *)(this + 896) && (*(_BYTE *)(this + 2094) || *(_BYTE *)(this + 2093)) )
    {
      v3 = (*(int (__thiscall **)(int))(*(_DWORD *)this + 340))(this);
      (*(void (__thiscall **)(int, _DWORD, int))(*(_DWORD *)v3 + 88))(v3, *(unsigned __int8 *)(this + 2094), 1);
    }
  }
