int __thiscall sub_101058D0(int *this, int a2, int a3, int a4, int a5, int a6, int a7)
{
  int *v7; // eax
  int v8; // edx
  int result; // eax
  ...
  {
    sub_10102F30(this[1022], (int)(this + 1033), a4, a5, v12, a6, a7);
    v32 = a6 + 48 * v12;
    sub_10421CE0(v32, 3, v29);
    ...
    if ( v13[28] * v13[28] + v13[27] * v13[27] + v13[29] * v13[29] <= 0.0 )
      ...
      sub_10102BD0(
        ...
        *(_DWORD *)(*(_DWORD *)(v11 + 12) + v11 + 56),
        ...
        a6);
    sub_10421CE0(v32, 3, v30);
    sub_10425290(132 * a3 + v31[1028] + 44, v30, v32);
    v19 = 16 * v12;
    v20 = *(_DWORD *)(a5 + v19);
    ...
    sub_10424F80(a6 + 48 * *(_DWORD *)(*(_DWORD *)(v31[1022] + 64) + 4 * v23), v27);
    sub_10421E30(v27, a6 + 48 * v23, v26);
    sub_10424D60(v26, a5 + 16 * v23, a4 + 12 * v23);
    sub_104251E0(v33, (int)v28, *(float *)(a2 + 8), v33);
    v24 = *(_DWORD *)(*(_DWORD *)(v11 + 12) + v11 + 28);
    sub_10424F80(a6 + 48 * *(_DWORD *)(*(_DWORD *)(v31[1022] + 64) + 4 * v24), v26);
    sub_10421E30(v26, a6 + 48 * v24, v27);
    sub_10424D60(v27, a5 + 16 * v24, a4 + 12 * v24);
    v25 = *(_DWORD *)(v11 + *(_DWORD *)(v11 + 12));
    sub_10424F80(a6 + 48 * *(_DWORD *)(*(_DWORD *)(v31[1022] + 64) + 4 * v25), v26);
    sub_10421E30(v26, a6 + 48 * v25, v27);
    return sub_10424D60(v27, a5 + 16 * v25, a4 + 12 * v25);
  }
  return result;
}
