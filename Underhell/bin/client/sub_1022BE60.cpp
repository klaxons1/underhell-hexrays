char __thiscall sub_1022BE60(_DWORD *this, char *a2, int a3, int a4, int a5)
{
  _BYTE *v5; // esi
  char *v6; // eax
  const char *v7; // edi
  ...
  {
    v41 = 1;
    v6 = sub_10229A30(v5, a3, &v42, &v43);
    v7 = v6;
    if ( *(_BYTE *)(a3 + 20) || !v6 || !*v6 )
      break;
    if ( !_stricmp(v6, "#include") )
    {
      v8 = sub_10229A30(v5, a3, &v42, &v43);
      if ( v8 && *v8 )
        sub_1022BCD0(v5, a2, v8, a4, a5, v30);
      else
        sub_10229950((int)dword_103FC1A0, "#include is NULL ");
    }
    else if ( !_stricmp(v7, "#base") )
    {
      v9 = sub_10229A30(v5, a3, &v42, &v43);
      if ( v9 && *v9 )
        sub_1022BCD0(v5, a2, v9, a4, a5, v34);
      else
        sub_10229950((int)dword_103FC1A0, "#base is NULL ");
    }
    else
    {
      ...
      v19 = sub_10229A30(v5, a3, &v42, &v43);
      if ( v43 )
      {
      ...
      if ( v19 && *v19 == 123 && !v42 )
        sub_1022B880(v16, (int)a2, a3);
      else
        sub_10229950((int)dword_103FC1A0, "LoadFromBuffer: missing {");
      if ( v41 )
      {
        v39 = v16;
        v40 = 0;
