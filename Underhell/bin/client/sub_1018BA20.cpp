double __thiscall sub_1018BA20(_DWORD *this)
{
  float *v1; // esi
  double result; // st7
  double v3; // st7
  ...
  if ( 0.0 != *((float *)off_103DC81C + 4) && v1 )
  {
    ...
    v4 = 0.003125 * v3 * (*((float *)off_103DC81C + 3) - flt_10445C14) + flt_10445C10;
    flt_10445C10 = v4;
    flt_10445C14 = *((float *)off_103DC81C + 3);
    v5 = v4 * 2.2222223;
