int __thiscall sub_10079A50(_DWORD *this, char a2)
{
  int v3; // ecx
  int v4; // eax
  __int16 v5; // cx
  ...
  {
    result = v3;
    *((_WORD *)this + 8) = *(_WORD *)(*this + 20 * v3 + 18);
  }
  v12 = *this;
  v13 = 20 * (unsigned __int16)result;
  if ( a2 )
  {
    *(_WORD *)(v13 + v12 + 18) = -1;
    *(_WORD *)(v13 + *this + 16) = -1;
  ...
  {
    *(_WORD *)(v13 + v12 + 18) = result;
    *(_WORD *)(v13 + *this + 16) = result;
  }
  this[6] = *this;
  return result;
}
