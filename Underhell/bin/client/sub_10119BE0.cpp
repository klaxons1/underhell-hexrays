int __thiscall sub_10119BE0(int *this, const char *a2, int a3, int a4, int a5, int a6)
{
  int v7; // edi
  int v8; // edx
  int v9; // eax
  ...
  v7 = (unsigned __int16)sub_10118170((_DWORD *)this[6], a2);
  ...
  if ( v8 == v7 )
  {
    ...
    while ( 1 )
    {
      ...
      v21 = sub_10117260(v20, a5, a6, &v28);
      if ( v21 )
      {
        v22 = *(_WORD *)(v21 + 18);
        if ( (v22 & 2) != 0 && (!this[8] || (v22 & 1) == 0) )
        {
          v23 = (_DWORD *)(a3 + *(_DWORD *)(v21 + 8));
          if ( *(int *)v21 > 11 )
            sub_101190C0(this, &v29, v23, a4, v21);
          else
            sub_10117030(this, &v29, v23, a4, v21);
          goto LABEL_33;
        }
      }
      v24 = (_DWORD *)this[6];
...
LABEL_33:
  ...
  v9 = this[6];
  if ( dword_103E4738 < 0 || dword_103E4738 >= *(_DWORD *)(v9 + 16) )
    v10 = "<<illegal>>";
  else
    v10 = *(const char **)(*(_DWORD *)(v9 + 20) + 4 * dword_103E4738);
