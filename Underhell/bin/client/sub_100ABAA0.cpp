...
float *__usercall sub_100ABAA0@<eax>(
        int a1@<ebp>,
        int a2@<edi>,
        int a3@<esi>,
        float *a4,
        ...
        int a11)
{
  ...
  v40 = v15;
  v41 = a7[2];
  sub_1000E4B0(v34, a4, a5, &v36, &v39);
  sub_1012D400(a8, a10);
  (*(void (__thiscall **)(int, float *, int, _BYTE *, int, int, int))(*(_DWORD *)dword_104131A0 + 16))(
    dword_104131A0,
    v34,
    a9,
    v35,
  ...
  if ( *(_DWORD *)(dword_10439134 + 48) )
    sub_10130AC0(a11, (int)v46, 255, 0, 0, 1, -1.0);
  if ( !*(_DWORD *)(a11 + 76) || *(float *)(a11 + 32) < 0.7 )
  {
    ...
    sub_1000E4B0(v34, a4, a5, &v36, &v39);
    sub_1012D400(a8, a10);
    (*(void (__thiscall **)(int, float *, int, _BYTE *, int))(*(_DWORD *)dword_104131A0 + 16))(
      dword_104131A0,
      v34,
      a9,
      v35,
    ...
    if ( !*(_DWORD *)(a11 + 76) || *(float *)(a11 + 32) < 0.7 )
    {
      ...
      if ( !*(_DWORD *)(a11 + 76) || *(float *)(a11 + 32) < 0.7 )
      {
        ...
        v40 = v31;
        sub_1000E4B0(v34, a4, a5, &v36, &v39);
        sub_100433C0((int)v34, a9, a8, a10, a11);
      }
    }
  }
  result = v46;
