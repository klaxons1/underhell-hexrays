int __thiscall sub_1027B5F0(int this)
{
  int v2; // ebx
  int v3; // edi
  int v4; // ebp
  ...
  if ( !*(_BYTE *)(this + 352)
    || (*(unsigned __int8 (__thiscall **)(_DWORD))(**(_DWORD **)(this + 288) + 912))(*(_DWORD *)(this + 288)) )
  {
  ...
  else
  {
    ...
    {
      (*(void (__stdcall **)(_DWORD))(*(_DWORD *)dword_1047CA6C + 40))(*(_DWORD *)(this + 324));
    }
    else
    {
      (*(void (__thiscall **)(int, _DWORD))(*(_DWORD *)dword_1047CA6C + 40))(dword_1047CA6C, *(_DWORD *)(this + 328));
    }
  }
