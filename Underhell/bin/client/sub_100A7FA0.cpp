int __thiscall sub_100A7FA0(int this, int a2, int a3)
{
  int result; // eax
  float v5; // [esp+20h] [ebp-4h]

  v5 = *((float *)off_103DC81C + 4);
  *((float *)off_103DC81C + 4) = *(float *)(a2 + 4616) * v5;
  sub_100A7D60((char *)this);
  *(_DWORD *)(this + 8) = a3;
  *(_BYTE *)(this + 904) = 0;
  *(_DWORD *)(this + 4) = a2;
  *(float *)(a3 + 56) = *(float *)(dword_1043483C + 44);
