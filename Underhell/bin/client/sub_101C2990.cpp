int __usercall sub_101C2990@<eax>(int a1@<eax>, int a2, int *a3, signed int a4)
{
  int v4; // edx
  int v5; // edi
  signed int v6; // esi
  ...
  int v23; // [esp+18h] [ebp-2Ch] BYREF
  int v24; // [esp+1Ch] [ebp-28h] BYREF
  int v25; // [esp+20h] [ebp-24h] BYREF
  ...
  if ( v9 > 0 )
  {
    ...
    do
    {
      if ( result > 0 )
      {
        ...
        do
        {
          sub_101BF6F0(v10, &a2, (unsigned __int8 *)&v23, (unsigned __int8 *)&v22, &v24, &v25);
          v12 = v31;
          sub_101C1070(v31, (int)v10, a4, &v22, &v23, &v24, &v25);
          v10 += 4;
          v13 = v30-- == 1;
          v31 = v12 + 4;
        }
