bool __thiscall sub_10031140(int this, int a2, float a3, float a4, _DWORD *a5)
{
  double v5; // st7
  int v6; // esi
  int v7; // edi
...
LABEL_55:
  ...
  if ( v10 != -1 )
  {
    ...
    if ( v14 >= v13 )
      v14 -= v13;
    v15 = *(float *)(*(_DWORD *)(this + 8) + 36 * v14) - v9;
      ...
      *(float *)(a2 + 16) = v16;
      ...
      if ( (*(_BYTE *)(this + 28) & 0x10) == 0 && v17 >= 0 && v17 < *(unsigned __int16 *)(this + 16) )
      {
        *(_DWORD *)(a2 + 4) = v17;
        ...
        if ( v18 >= v19 )
          v18 -= v19;
        if ( v11 - *(float *)(*(_DWORD *)(this + 8) + 36 * v18) > 0.000099999997 )
          *(_BYTE *)a2 = 1;
      }
      if ( a5 && v10 == (*(_WORD *)(this + 16) != 0) - 1 )
      {
        ...
        v23 = 32 * *(unsigned __int8 *)(this + 29);
        v36 = v23;
        if ( v21 >= v22 )
          v21 -= v22;
        v35 = *(_DWORD *)(this + 8);
