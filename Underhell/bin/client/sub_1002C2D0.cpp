bool __thiscall sub_1002C2D0(int this, int a2, float a3, float a4, _DWORD *a5)
{
  double v5; // st7
  int v6; // esi
  int v7; // edi
...
LABEL_55:
  ...
  if ( v10 != -1 )
  {
    ...
    if ( v14 >= v13 )
      v14 -= v13;
    v15 = *(float *)(*(_DWORD *)(this + 8) + 12 * v14) - v9;
      ...
      *(float *)(a2 + 16) = v16;
      ...
      if ( (*(_BYTE *)(this + 28) & 0x10) == 0 && v17 >= 0 && v17 < *(unsigned __int16 *)(this + 16) )
      {
        *(_DWORD *)(a2 + 4) = v17;
        ...
        if ( v18 >= v19 )
          v18 -= v19;
        if ( v11 - *(float *)(*(_DWORD *)(this + 8) + 12 * v18) > 0.000099999997 )
          *(_BYTE *)a2 = 1;
      }
      if ( a5 && v10 == (*(_WORD *)(this + 16) != 0) - 1 )
      {
        ...
        v23 = 4 * *(unsigned __int8 *)(this + 29);
        v36 = v23;
        if ( v21 >= v22 )
          v21 -= v22;
        v35 = *(_DWORD *)(this + 8);
        v24 = *(_DWORD *)(v35 + 12 * v21 + 8);
        v25 = v20 + *(_DWORD *)(a2 + 12);
        v34 = v25;
        if ( v25 >= v22 )
          v25 -= v22;
        v26 = *(_DWORD *)(v35 + 12 * v25 + 8);
        if ( v23 >= 4 )
        {
...
LABEL_33:
        if ( !v23
          || *(_BYTE *)v24 == *(_BYTE *)v26
          && (v23 <= 1
           || *(_BYTE *)(v24 + 1) == *(_BYTE *)(v26 + 1) && (v23 <= 2 || *(_BYTE *)(v24 + 2) == *(_BYTE *)(v26 + 2))) )
        {
          if ( !*(_BYTE *)a2 )
            goto LABEL_53;
          v27 = v20 + *(_DWORD *)(a2 + 4);
          ...
          if ( v27 >= v22 )
            v27 -= v22;
          v29 = *(_DWORD *)(v35 + 12 * v27 + 8);
          v30 = v34;
          if ( v34 >= v22 )
            v30 = v34 - v22;
          v31 = *(_DWORD *)(v35 + 12 * v30 + 8);
          if ( v36 >= 4 )
          {
