float *__thiscall sub_100A8660(_DWORD *this)
{
  int v2; // eax
  double v3; // st7
  int v4; // ecx
  ...
  sub_101EE040(this[2] + 12, v13, v14, v11);
  v2 = this[2];
  v15 = *(float *)(v2 + 44);
  v16 = *(float *)(v2 + 48);
  v13[2] = 0.0;
  ...
  result = (float *)this[2];
  v9 = (float *)this[1];
  result[16] = result[16] - v9[71];
  result[17] = result[17] - v9[72];
  result[18] = result[18] - v9[73];
  return result;
}
