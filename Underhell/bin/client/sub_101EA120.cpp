int __thiscall sub_101EA120(int this, float a2)
{
  double v3; // st7
  int v4; // ebx
  int v5; // esi
  ...
  for ( *(_DWORD *)(this + 144) = 0; v5 < v4; ++v5 )
    sub_101E3910(*(_DWORD **)(*(_DWORD *)(this + 104) + 4 * v5));
  v6 = 0;
  v7 = *(_DWORD *)(this + 16) <= 0;
  v28 = sub_101E6250;
  v29 = 0;
  ...
  if ( !v7 )
  {
    ...
    do
    {
      ...
      if ( v9 )
      {
        *(_DWORD *)(this + 144) += sub_101E67C0(this, v9, *(float *)(this + 124), a2, v8, v25);
        if ( *(_DWORD *)v25 )
        {
          v27[0] = *(_DWORD *)v25;
          v27[1] = v9;
          sub_101E9950((int)&v28, (int)v27);
        }
      }
      ++v6;
    }
    ...
    while ( 1 )
    {
      ...
      switch ( *(_DWORD *)v11 )
      {
        ...
        case 2:
          ...
          if ( sub_101E1B20(*(unsigned __int8 **)(v11 + 4)) == 1 )
          {
            v20 = *(_DWORD *)(this + 116);
            v21 = 0;
            if ( v20 <= 0 )
...
LABEL_25:
          ...
          break;
        case 3:
          sub_101E2080(*(void **)(v29 + 24 * v10 + 20), *(_DWORD *)(this + 160), this, *(float *)(this + 124));
          break;
        case 4:
          sub_101E20B0(*(_BYTE **)(v29 + 24 * v10 + 20), *(_DWORD *)(this + 160), this, *(float *)(this + 124));
          break;
        default:
          break;
      }
      *(_DWORD *)v25 = sub_101E7270(&v28, v10);
      if ( *(_DWORD *)v25 == -1 )
        break;
      v10 = *(_DWORD *)v25;
    }
