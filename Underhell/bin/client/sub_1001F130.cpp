void __cdecl sub_1001F130(int a1, int a2, int a3, int a4, int a5, float a6, int a7, int a8, int a9, float a10)
{
  int v10; // ebx
        ...
        if ( *(int *)(a2 + 156) > 0 )
        {
          ...
          do
          {
            ...
            if ( (*v87 & 0x200000) != 0 )
            {
              ...
              {
                v15 = sub_1001AB20(*v11);
                v16 = v11[1];
                v79 = v15;
                v17 = sub_1001AB20(v16);
                v18 = v11[2];
                *(float *)&v80 = v17;
                v19 = sub_1001AB20(v18);
                v20 = (float *)(a7 + 12 * v14);
                v21 = v19 * a10;
                v22 = 1.0 - a10;
            ...
            if ( (*v87 & 0x400000) != 0 )
            {
              if ( v14 >= 0 && (a9 & *(_DWORD *)(*(_DWORD *)(a1 + 44) + 4 * v14)) != 0 )
              {
                sub_1001A9E0(v11, (float *)&v75);
                v72 = v76;
                v73 = v77;
                v71 = v75;
                v74 = v78;
                sub_101F17B0(16 * v14 + a8, (int)&v71, a10, 16 * v14 + a8);
              }
              v11 += 4;
            }
            v87 += 54;
          ...
          do
          {
            ...
            if ( (*v82 & 0x200000) != 0 )
            {
              if ( v32 >= 0 && (a9 & *(_DWORD *)(*(_DWORD *)(a1 + 44) + 4 * v32)) != 0 )
              {
                v33 = v11[3 * v30];
                v34 = &v11[3 * v30];
                v35 = sub_1001AB20(v33);
                v36 = v34[1];
                v67 = v35;
                v37 = sub_1001AB20(v36);
                v38 = v34[2];
                *(float *)&v68 = v37;
                *(float *)&v69 = sub_1001AB20(v38);
                v61[2] = v69;
                *(float *)v61 = v67;
                v39 = &v11[3 * v83];
                v61[1] = v68;
                v40 = sub_1001AB20(*v39);
                v41 = v39[1];
                v64 = v40;
                v42 = sub_1001AB20(v41);
                v43 = v39[2];
                *(float *)&v65 = v42;
                *(float *)&v66 = sub_1001AB20(v43);
                v60[1] = v65;
                *(float *)v60 = v64;
                v44 = &v11[3 * v85];
                v54 = *v44;
                v60[2] = v66;
                v45 = sub_1001AB20(v54);
                v46 = v44[1];
                v79 = v45;
                v47 = sub_1001AB20(v46);
                v48 = v44[2];
                *(float *)&v80 = v47;
                *(float *)&v81 = sub_1001AB20(v48);
                *(float *)v62 = v79;
                v62[1] = v80;
                v62[2] = v81;
                sub_101EF7F0((int)v61, (int)v60, (int)v62, v84, (int)v59);
                v49 = *(float *)&v59[2] * a10;
                v50 = (float *)(a7 + 12 * v32);
                v51 = 1.0 - a10;
                v30 = v70;
            ...
            if ( (*v82 & 0x400000) != 0 )
            {
              if ( v32 >= 0 && (a9 & *(_DWORD *)(*(_DWORD *)(a1 + 44) + 4 * v32)) != 0 )
              {
                sub_1001A9E0(&v11[4 * v30], v58);
                v75 = LODWORD(v58[0]);
                v76 = v58[1];
                v77 = v58[2];
                v78 = v58[3];
                sub_1001A9E0(&v11[4 * v83], v56);
                v71 = LODWORD(v56[0]);
                v72 = v56[1];
                v73 = v56[2];
                v74 = v56[3];
                sub_1001A9E0(&v11[4 * v85], v57);
                *(float *)&v63[2] = v57[2];
                *(float *)v63 = v57[0];
                *(float *)&v63[1] = v57[1];
                *(float *)&v63[3] = v57[3];
                if ( 1.0 == a10 )
                {
                  sub_101EF890((int)&v75, (int)&v71, (int)v63, v84, a8 + 16 * v32);
                }
                else
                {
                  sub_101EF890((int)&v75, (int)&v71, (int)v63, v84, (int)v55);
                  sub_101F17B0(a8 + 16 * v32, (int)v55, a10, a8 + 16 * v32);
                }
              }
              v31 = v86;
              v11 += 4 * *(__int16 *)(a5 + 90);
