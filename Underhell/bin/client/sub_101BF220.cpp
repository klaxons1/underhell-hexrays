void __cdecl sub_101BF220(_DWORD *a1, int a2, int a3, int a4, int a5, int a6, int a7)
{
  int v7; // eax
  int v8; // ebx
  int v9; // ebp
  ...
  if ( *(int *)(a2 + 28) > 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v14 > 0 )
      {
        ...
        do
        {
          ...
          if ( *(int *)(a2 + 20) > 0 )
          {
            ...
            do
            {
              sub_101BE590(a1, a2, v25, v36, v24, a6, v35);
              v27 = 255;
              if ( v26 > (double)v35[3] )
                v27 = 0;
              v17 = 0;
              ...
              *(_BYTE *)(*(_DWORD *)(a2 + 4) + v16 + 3) = v22;
              sub_101BE780((int)a1, a1, a2, v25, v36, v24, v28, a7);
              v16 += 4;
      ...
      sub_101BDD70((int)a1, a2, a3, v8, v9, a7);
      v24 += v9;
      v31 = ++v13;
      if ( v13 >= *(_DWORD *)(a2 + 28) )
        break;
