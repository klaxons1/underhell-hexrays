int __thiscall sub_10263FA0(_DWORD *this, int a2)
{
  int v2; // esi
  int v4; // eax
  int *v5; // ecx
  ...
  if ( a2 != this[4] )
  {
    while ( 1 )
    {
      ...
      v14 = v13 == -1 ? &dword_10480468 : (int *)(this[1] + 24 * v13);
      if ( *v14 == v9 )
      {
        if ( (v4 & 1) == 0 )
        {
        ...
        v17 = v16 == -1 ? &dword_10480468 : (int *)(this[1] + 24 * v16);
        if ( v17[3] )
        {
          if ( (v4 & 1) == 0 )
          {
          ...
          {
            a2 = v9;
            sub_10263D70(this, v9);
            v22 = dword_10480478;
            if ( (dword_10480478 & 1) == 0 )
            {
              v22 = dword_10480478 | 1;
              dword_10480478 |= 1u;
              dword_10480468 = -1;
              dword_1048046C = -1;
              dword_10480470 = -1;
      ...
      else
      {
        ...
        v27 = v26 == -1 ? &dword_10480468 : (int *)(this[1] + 24 * v26);
        if ( v27[3] )
        {
          if ( sub_10263B20(this, a2) )
          {
            a2 = v9;
            sub_10263EA0(this, v9);
            v28 = dword_10480478;
            if ( (dword_10480478 & 1) == 0 )
            {
              v28 = dword_10480478 | 1;
              dword_10480478 |= 1u;
              dword_10480468 = -1;
              dword_1048046C = -1;
              dword_10480470 = -1;
