double __thiscall sub_101E2920(int this, float a2, int a3)
{
  double result; // st7
  int v5; // eax
  float *v6; // ebp
    ...
    if ( -1.0 != *(float *)(v5 + 76) )
    {
      ...
      if ( v7 >= 1 )
      {
        ...
        if ( v8 > -2 )
        {
          while ( v9 < v7 + 1 )
          {
            v6 = sub_101E2750(this, v9, &v25, a3);
            v10 = sub_101E2750(this, v9 + 1, &v25, a3);
            v29 = v10;
            if ( v26 / 2 <= 1 )
            {
              v26 = 1;
            ...
            if ( a2 >= (double)v6[1] )
            {
              if ( v12 <= v10[1] )
              {
                ...
                {
                  v6 = sub_101E2750(this, ++v9, &v25, a3);
                  v29 = sub_101E2750(this, v9 + 1, &v25, a3);
                }
                v7 = v27;
                break;
              }
          ...
          if ( v6 )
          {
            ...
            if ( v14 >= v7 )
              v28 = v7;
            v15 = sub_101E2750(this, v13, &v25, a3);
            v16 = sub_101E2750(this, v28, (_BYTE *)&v25 + 1, a3);
            v17 = v29;
            v18 = v29[1] - v6[1];
            v19 = *v15;
            v40[0] = *((int *)v15 + 1);
            ...
            *(float *)&v39[2] = 0.0;
            ...
            sub_100D9FD0(*((_WORD *)v6 + 4) >> 1, &v31, &v32);
            sub_100D9FD0(*((_WORD *)v17 + 4) >> 1, &v30, &v31);
            if ( v32 == 15 )
            {
              result = v37;
            }
            ...
            else
            {
              if ( v32 == v30 )
              {
                sub_100DA070(v30, (int)v40, (float *)&v36, (float *)&v33, (int)v39, v25, (float *)v41);
              }
              else
              {
                sub_100DA070(v32, (int)v40, (float *)&v36, (float *)&v33, (int)v39, v25, (float *)v43);
                sub_100DA070(v30, (int)v40, (float *)&v36, (float *)&v33, (int)v39, v25, (float *)v42);
                sub_1000E380((float *)v43, (float *)v42, v25, (float *)v41);
              }
              result = *(float *)&v41[1];
            }
            v24 = 1.0;
