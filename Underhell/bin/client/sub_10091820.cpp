char __cdecl sub_10091820(int a1, float *a2, float *a3, float *a4, float a5, int a6)
{
  char result; // al
  double v7; // st7
  double v8; // st6
  ...
  if ( *(_BYTE *)(a1 + 64) )
    return sub_10091550((float *)a1, (float *)(a1 + 16), a2, a3, a4, a5, a6);
  ...
  *(float *)&v82 = (*a3 + *a4) * 0.5 + a2[3];
  ...
  v15 = 0.5 * (a4[2] - a3[2]);
  v69 = v15 * v15 + v14;
  *(float *)&v94 = off_103EDFE0(v69);
  v16 = *(float *)(a1 + 52);
  v17 = *(float *)(a1 + 48);
  v92 = (float *)(a1 + 48);
  v70 = v16 * v16 + v17 * v17 + *(float *)(a1 + 56) * *(float *)(a1 + 56);
  v68 = off_103EDFE0(v70) + *(float *)&v94;
  if ( sub_10091490((float *)a1, (float *)(a1 + 16), (float *)&v82, v68, a5) )
  {
    sub_101ED8C0(a1, a2, &v75);
    sub_101ED980(a1 + 16, a2, v74);
    v18 = a4;
    *(float *)&v94 = COERCE_FLOAT(v72);
    ...
    while ( 1 )
    {
      ...
      *(v71 - 5) = v24 + *v18;
      ...
      v21[8] = *v20;
      v21[9] = v20[1];
      sub_10090A20(v21 + 7, a3, a4, (int)&v73[v22 + 196]);
      v25 = v92;
      v26 = dword_103DD7E8[v22 / 4];
      v27 = dword_103DD7EC[v22 / 4];
      *(float *)&v73[v22 + 196] = *(float *)&v73[v22 + 196] - *v92;
      *(float *)&v73[v22 + 200] = *v25 + *(float *)&v73[v22 + 200];
      v87 = *(float *)(a1 + 4 * v26 + 48);
      v28 = dword_103DD800[v22 / 4];
      v85 = *(float *)(a1 + 4 * v27 + 48);
      v21[16] = 0.0;
      v29 = v20[1];
      v89 = &a2[4 * v28];
      v30 = 4 * dword_103DD804[v22 / 4];
      v21[17] = -v29;
      v21[18] = *v20;
      v88 = &a2[v30];
      sub_10090AD0((int)(v21 + 16), 1, 2, (int)a3, (int)a4, (int)&v73[v22 + 220]);
      ...
      *(float *)&v73[v22 + 224] = v31 + *(float *)&v73[v22 + 224];
      ...
      v21[26] = 0.0;
      v21[27] = -*(v20 - 1);
      sub_10090AD0((int)(v21 + 25), 0, 2, (int)a3, (int)a4, (int)&v73[v22 + 244]);
      ...
      *(float *)&v73[v22 + 248] = v32 + *(float *)&v73[v22 + 248];
      ...
      v21[35] = *(v20 - 1);
      v21[36] = 0.0;
      sub_10090AD0((int)(v21 + 34), 0, 1, (int)a3, (int)a4, (int)&v73[v22 + 268]);
      ...
      if ( ++v47 >= 2 )
      {
        ...
        else
        {
          ...
          *(_DWORD *)(a6 + 48) = 1;
          ...
          LOBYTE(v84) = 3;
          sub_10090030((int)a2, (int)&v80, (float *)(a6 + 24));
          return 1;
        }
        return result;
      }
