void __thiscall sub_10014990(float *this, float *a2, float *a3, float *a4)
{
  float v4; // edx
  float v6; // ecx
  float v7; // ecx
  ...
  if ( 0.0 != *((float *)off_103DC81C + 4) )
  {
    ...
    v12 = off_103EDFE0(v26);
    v13 = flt_103D71D8;
    if ( flt_103D71D8 >= v12 || v13 <= 0.0 )
      v14 = (float)5.0;
    else
      v14 = v12 / v13 * 5.0;
    v15 = v14 * *((float *)off_103DC81C + 4);
    this[492] = v38 * v15 + this[492];
    this[493] = v39 * v15 + this[493];
    this[494] = v15 * v40 + this[494];
    off_103EDFEC();
    v16 = v39 * -1.0;
    v17 = -1.0 * v40;
    *a2 = v38 * -1.0 * 5.0 + *a2;
