int __thiscall sub_100944E0(void *this, char *a2)
{
  void *v2; // ebx
  int result; // eax
  int v4; // esi
  ...
  if ( result )
  {
    ...
    if ( result )
    {
      ...
      if ( dword_10413188 )
        ...
        v6 = 0;
      if ( !(unsigned __int8)sub_10229D70(v6, a2, 0) )
      {
        ...
        if ( sub_10229C90(v5) )
        {
          ...
          else
          {
            ...
            if ( v7 )
            {
              ...
              {
                v29 = -1;
                v8 = (void *)sub_10229A00(v7);
                v28 = *(_WORD *)sub_10230F20((int)&var2, v8);
                sub_1022A940(0, 0.0);
                v30 = 0.0;
                v32 = sub_10093720((int *)v2 + 4, *((_DWORD *)v2 + 7), (int)&v28);
                v9 = v4;
                if ( v4 + 1 > v24 )
                {
                  sub_1010AFF0(v4 - v24 + 1);
                  v4 = v26;
                }
                v10 = v23;
                v26 = ++v4;
            ...
            v31 = v14;
            sub_100943F0((int)v2 + 36, (int *)&v31, &v23);
            if ( v25 >= 0 && v23 )
...
LABEL_31:
      ...
      for ( j = sub_10229C90(v33); j; j = sub_1021F0F0(j) )
      {
        v16 = (const char *)sub_1022B4C0(0, (int)Locale);
        if ( _stricmp(v16, Locale) )
        {
          v17 = sub_1022B4C0(0, (int)Locale);
          if ( v17 )
          {
            v22 = v17;
            v23 = 0;
            ...
            v26 = 0;
            v27 = 0;
            a2 = (char *)sub_100937A0((unsigned __int8 (__cdecl **)(int, int))v2 + 9, (int)&v22);
            sub_1011A810(&v23);
            v18 = (int)a2;
          }
          else
          ...
          if ( v18 == -1 )
          {
            v21 = (const char *)sub_1022B4C0(0, (int)Locale);
            v20 = (const char *)sub_10229A00(j);
            Msg(
          ...
          {
            v19 = (const char *)sub_10229A00(j);
            sub_10009FD0((int)v2 + 128, v19, &a2);
          }
        }
      }
      return sub_1022AF00(v35);
    }
  }
  return result;
}
