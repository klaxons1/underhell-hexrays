int __thiscall sub_1011A470(_DWORD *this, int a2, int a3, int a4, int *a5, int a6)
{
  ...
  {
    v9 = (int *)(a3 + a5[2]);
    if ( sub_10116A30(this, v9, a5) )
    {
      if ( *a5 > 11 )
        v10 = sub_10119960((_DWORD **)this, a2, v9, a4, (int)a5);
      else
        v10 = sub_10116BD0(this, a2, v9, a4, (int)a5);
      if ( !v10 )
        break;
      ++v21;
    }
