  ...
  if ( (v6 & 0x7FFFFu) - 260864 >= 0x3BB )
  {
    ...
    if ( v17 >= 0x43 )
    {
        ...
        else
        {
          ...
          *(double *)v48.m128i_i64 = 0.01155180089613689 * v49.m128d_f64[0];
          ...
          v51 = (__m128i)_mm_mul_pd(
                           _mm_add_pd(
                             _mm_mul_pd(_mm_mul_pd(v49, v49), (__m128d)xmmword_103B51A0),
                             _mm_add_pd((__m128d)xmmword_103B5190, _mm_mul_pd((__m128d)xmmword_103B5180, v49))),
                           v50);
          *(double *)v48.m128i_i64 = (*(double *)v48.m128i_i64 + *(double *)_mm_shuffle_epi32(v48, 238).m128i_i64)
                                   * (v46.m128d_f64[0]
                                    * v50.m128d_f64[0]);
          v46.m128d_f64[0] = *(double *)_mm_shuffle_epi32((__m128i)xmmword_103B5130, 238).m128i_i64;
      ...
      else
      {
        ...
        v34 = (__m128i)_mm_mul_pd(
                         v33,
                         _mm_add_pd(
                           _mm_add_pd(_mm_mul_pd((__m128d)xmmword_103B5180, v32), (__m128d)xmmword_103B5190),
                           _mm_mul_pd((__m128d)xmmword_103B51A0, _mm_mul_pd(v32, v32))));
    ...
    else
    {
      ...
      *(_QWORD *)&v24 = COERCE_UNSIGNED_INT64(NAN) & a4.m128i_i64[0] | *(_QWORD *)&inserted.m128d_f64[0];
      ...
      v26 = *(double *)a4.m128i_i64 * *(double *)&qword_103B4930[v25];
      v27 = *(double *)&v20 * v24 - v26 + v21 * v24;
      v28 = (__m128i)_mm_sub_pd((__m128d)xmmword_103B5130, (__m128d)xmmword_103B3A30[v25]);
      *(_QWORD *)&result = COERCE_UNSIGNED_INT64(
