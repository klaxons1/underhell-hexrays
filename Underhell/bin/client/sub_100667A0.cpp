int __thiscall sub_100667A0(int this, unsigned __int16 a2)
{
  ...
  if ( a2 != *(_WORD *)(this + 16) )
  {
    while ( 1 )
    {
      ...
      if ( *(_WORD *)v14 == (_WORD)v9 )
      {
        ...
        {
          a2 = v9;
          sub_10066220(this, v9);
          v21 = dword_10410AAC;
          if ( (dword_10410AAC & 1) == 0 )
          {
            v21 = dword_10410AAC | 1;
            dword_10410AAC |= 1u;
            dword_10410AA4 = -1;
            dword_10410AA8 = 0x1FFFF;
          }
...
LABEL_81:
        ...
        {
          a2 = v9;
          sub_10066310(this, v9);
          v29 = dword_10410AAC;
          if ( (dword_10410AAC & 1) == 0 )
          {
            v29 = dword_10410AAC | 1;
            dword_10410AAC |= 1u;
            dword_10410AA4 = -1;
            dword_10410AA8 = 0x1FFFF;
          }
