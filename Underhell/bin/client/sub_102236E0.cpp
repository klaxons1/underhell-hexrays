int __userpurge sub_102236E0@<eax>(int a1@<ecx>, _BYTE *a2@<ebp>, int a3, int a4, int a5, int a6)
{
  void (__thiscall *v7)(int, char *); // edx
  int v9; // esi
  int v10; // ecx
  int v11; // eax
  int v12; // esi
  ...
  char v22[4]; // [esp+3Ch] [ebp-240h] BYREF
  ...
  v7 = *(void (__thiscall **)(int, char *))(*(_DWORD *)a5 + 588);
  v21 = a1;
  v7(a5, v22);
  ...
  if ( v18 )
  {
    while ( 1 )
    {
      ...
      if ( v12 > 0 )
      {
        ...
        {
          v21 -= 16;
          sub_102210D0((int)v24, (int)v50, *(_DWORD *)(v21 + 4), v23, v21);
          --v12;
        }
        while ( v12 );
      }
