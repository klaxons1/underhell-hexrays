int *__stdcall sub_101D2C70(int a1, int a2, int a3, int a4)
{
  unsigned int v4; // ecx
  int *result; // eax
  int v6; // ebp
  ...
  do
  {
    ...
    *(result - 2) = (unsigned __int8)*(&v11 + 4 * v4)
                  | (((unsigned __int8)v13[4 * v4 - 1] | ((unsigned __int8)v13[4 * v4] << 16)) << 8);
    v7 = (unsigned __int8)*(&v14 + 4 * v4) | ((v6 | (v16[4 * v4] << 16)) << 8);
    v8 = (unsigned __int8)v13[(_DWORD)result - 1 - a4];
    *(result - 1) = v7;
    v9 = *((unsigned __int8 *)result + (_DWORD)(&v11 - a4))
       | ((v8 | ((unsigned __int8)v13[(_DWORD)result - a4] << 16)) << 8);
    v10 = v16[(_DWORD)result - 1 - a4];
    *result = v9;
    result[1] = *((unsigned __int8 *)&v14 + (_DWORD)result - a4) | ((v10 | (v16[(_DWORD)result - a4] << 16)) << 8);
    v4 += 4;
    result += 4;
  }
  while ( v4 < 0x10 );
