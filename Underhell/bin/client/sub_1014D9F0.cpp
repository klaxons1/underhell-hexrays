int __cdecl sub_1014D9F0(int a1, char ArgList, int a3)
{
  const char *v3; // ebx
  int v4; // eax
  int v5; // esi
  ...
  if ( !a3 )
    v3 = "GAME";
  if ( sub_10229D00(32) )
    v11 = sub_10229D20("WeaponDatafile");
  else
    v11 = 0;
  sub_10228370(Buffer, 0x200u, "%s.txt", ArgList);
  if ( a1 )
    v4 = a1 + 4;
  else
    v4 = 0;
  if ( (unsigned __int8)sub_10229D70(v4, Buffer, v3) )
    return v11;
  if ( a3 )
  {
    sub_10228370(Buffer, 0x200u, "%s.ctx", ArgList);
    v5 = a1 + 4;
    ...
    if ( v6 )
    {
      ...
      sub_1012D250(v8, v7, a3);
      LOBYTE(v8) = sub_1022C1A0(Buffer, (int)v8, v5, 0);
      MemFreeScratch();
      if ( (_BYTE)v8 )
        return v11;
    }
