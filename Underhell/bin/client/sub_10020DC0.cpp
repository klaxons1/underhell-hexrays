void __usercall sub_10020DC0(int *a1@<eax>, int a2@<edx>, int a3, int a4, int a5, int a6, float a7, int a8)
{
  _DWORD *v9; // eax
  int v10; // edi
  int v11; // eax
  ...
  if ( v9 )
  {
    sub_10020970(a6, a2, a1, v9, a3, a4, a5, a7, a8);
  }
  else
  {
    v10 = sub_101278E0(a2);
    ...
    if ( v17 )
    {
      ...
      if ( *(int *)(v19 + 156) > 0 )
      {
        ...
        while ( 1 )
        {
          if ( v48 && *(unsigned __int8 *)v48 == v26 )
          {
            ...
            {
              sub_1001B1B0(v43, v39, v46, (_DWORD *)v42, (unsigned __int8 *)v48, (int)v27);
              sub_1001E5D0(v43, v39, v46, v42, (unsigned __int8 *)v48, v28 - 2);
              v25 = 0.0;
              v26 = v44;
              ++a1[33];
              ++a1[34];
      ...
      if ( v40 > v25 )
        sub_1001F130((int)a1, *a1, 0, *a1 + *(_DWORD *)(*a1 + 160), v10, v38, a3, a4, a8, v40);
      if ( *(_DWORD *)(v10 + 72) )
      {
        v41 = (int)sub_1001ACB0(&dword_10403328);
        if ( !v41 )
        {
          v41 = sub_100DDA40(6144);
          if ( (v41 & 7) != 0 )
            __debugbreak();
        }
        v32 = 0.0;
        ...
        if ( *(int *)(v10 + 72) > 0 )
        {
          do
          {
            v33 = (int *)sub_10126C90(LODWORD(v32));
            if ( !v33 )
              break;
            v34 = a1[11];
            if ( (a8 & *(_DWORD *)(v34 + 4 * *v33)) != 0 )
            {
              ...
              if ( (a8 & *(_DWORD *)(v34 + 4 * v35)) != 0 )
                sub_10020360((int)a1, v41, (int)v36, a3, a4, v46, *v33, v35, a7, v37, v39);
              v10 = v45;
            }
        ...
        sub_1001AC40(&dword_10403328, (int *)v41);
      }
    }
    else
    {
      ...
      sub_1001F130((int)a1, *a1, 0, *a1 + *(_DWORD *)(*a1 + 160), v10, v38, a3, a4, a8, 1.0);
    }
  }
}
