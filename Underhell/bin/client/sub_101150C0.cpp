...
int __usercall sub_101150C0@<eax>(int a1@<ebp>, int a2, int a3)
{
  int v3; // eax
  int *v4; // esi
  bool v5; // zf
...
LABEL_15:
        ...
        if ( sub_101024F0(*(v4 - 2), v25) )
        {
          sub_1000E430(v21, v26, v23);
          sub_100433C0((int)v21, 33570827, a3, 0, (int)v18);
  ...
  if ( *(int *)a2 > 0 )
  {
    ...
    do
    {
      if ( *((_BYTE *)&v29[-118] + v13) )
      {
        ...
        sub_101EDA20(v25, 3, v22);
        (*(void (__thiscall **)(_DWORD, _BYTE *, int))(*(_DWORD *)*v14 + 184))(*v14, v22, 1);
        (*(void (__thiscall **)(_DWORD, float *, float *))(*(_DWORD *)*v14 + 196))(*v14, v26, &flt_10459240);
        v13 = v27;
      }
      ++v13;
      v14 += 6;
