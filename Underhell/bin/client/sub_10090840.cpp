char __cdecl sub_10090840(float *a1, float *a2, int a3, int a4, float a5, int a6, float *a7)
{
  double v7; // st7
  char v8; // cl
  double v9; // st6
  ...
  *(_DWORD *)(a6 + 48) = 0;
  *(float *)(a6 + 44) = 1.0;
  if ( !sub_100906D0(a1, (int)a2, a3, a4, a5, (int)v18) )
    return 0;
  v7 = *(float *)&v18[1];
  v8 = v19;
  v9 = *(float *)v18;
  *(_BYTE *)(a6 + 55) = v19;
  if ( v9 < v7 && v9 >= 0.0 )
  {
    ...
    *(_DWORD *)(a6 + 48) = 1;
    *(float *)(a6 + 24) = flt_10459240;
    *(_QWORD *)(a6 + 28) = qword_10459244;
    if ( v10 < 3 )
    {
