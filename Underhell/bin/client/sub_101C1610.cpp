unsigned int __usercall sub_101C1610@<eax>(
        int a1@<eax>,
        _WORD *a2@<ecx>,
        int a3,
        _BYTE *a4,
    ...
    for ( i = 0; i < 4; ++i )
    {
      ...
      switch ( result )
      {
        case 0u:
          ...
          goto LABEL_8;
        case 1u:
          result = (unsigned int)sub_101BF510(a2, a5);
          break;
        case 2u:
          result = (unsigned int)sub_101BF510(a2, a6);
          break;
        case 3u:
          v12 = a7;
LABEL_8:
          result = (unsigned int)sub_101BF510(a2, v12);
          break;
        default:
          break;
      }
