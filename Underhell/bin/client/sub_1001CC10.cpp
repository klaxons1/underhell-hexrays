int __thiscall sub_1001CC10(char *this, float *a2)
{
  char *v2; // edi
  double v3; // st5
  double v4; // st7
  ...
  v2 = this + 108;
  sub_101EED90(this + 108, v10);
  sub_101EDA00(v10, 1, &v13);
  ...
  v14 = v8;
  v15 = v7;
  sub_101EDA20(v12, 0, v10);
  sub_101EDA20(&v13, 1, v10);
  sub_101EDA20(a2, 2, v10);
  return sub_101F0930(v10, v2, v11);
}
