void __cdecl sub_1001F670(int *a1, float *a2, int a3, int a4, int a5, int a6, float *a7, float a8, int a9)
{
  int *v9; // edx
  int v10; // ecx
  int v11; // ebx
          ...
          if ( (v38 & a9) != 0 )
          {
            ...
            if ( v24 >= 0 )
            {
              ...
              if ( v26 < *(float *)(*(_DWORD *)(a4 + 156) + 4 * v24 + a4) )
              {
                ...
                v34 = (int)v22 + v39;
                if ( (v38 & 0x100000) != 0 )
                  sub_101F0E00(v34, (int)v22, v35, (int)v36);
                else
                  sub_101F17B0(v34, (int)v22, v35, (int)v36);
                v28 = (float *)v40;
                *v22 = *(float *)v36;
                v29 = v41;
                v22[1] = *(float *)&v36[1];
