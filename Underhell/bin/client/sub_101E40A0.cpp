char __userpurge sub_101E40A0@<al>(_DWORD *a1@<ecx>, int a2@<edi>, int a3, int a4)
{
  ...
  if ( v4 )
  {
    ...
    while ( 1 )
    {
      ...
      else if ( (unsigned __int8)sub_1022E380(2) )
      {
        ...
        if ( (*(_BYTE *)(a3 + 44) & 1) != 0 )
        {
          sub_1011C410((_BYTE *)(a3 + 44), (char *)&v52, (char *)(*(_DWORD *)a3 + v5), 1);
          *(_DWORD *)(a3 + 12) += 2;
        }
        else
        {
      ...
      else if ( (unsigned __int8)sub_1022E380(4) )
      {
        ...
        if ( !v8 )
          sub_1011C390((_BYTE *)(a3 + 44), (int *)&Src, (char *)&Src, 1);
        *(_DWORD *)(a3 + 12) += 4;
      }
      else
      {
      ...
      *((float *)v9 + 2) = Src;
      ...
      else if ( (unsigned __int8)sub_1022E380(4) )
      {
        ...
        if ( !v8 )
          sub_1011C390((_BYTE *)(a3 + 44), (int *)&v48, (char *)&v48, 1);
        *(_DWORD *)(a3 + 12) += 4;
      }
      else
      {
      ...
      if ( (__int16)v51 > 0 )
      {
        ...
        while ( 1 )
        {
          ...
          else if ( (unsigned __int8)sub_1022E380(4) )
          {
            ...
            if ( !v8 )
              sub_1011C390((_BYTE *)(a3 + 44), (int *)&v50, (char *)&v50, 1);
            *(_DWORD *)(a3 + 12) += 4;
          }
          else
          {
          ...
          v15 = *v12 + 10 * sub_101E3920(v12, v14, (int)v58);
          if ( (*(_BYTE *)(a3 + 21) & 1) != 0 )
          {
            v46 = 0.0;
            sub_1022F5B0(a3, "%u", &v46);
            goto LABEL_65;
          }
...
LABEL_106:
    ...
    while ( 1 )
    {
      ...
      v32 = *v24 + 10 * sub_101E3920(v24, v31, (int)v60);
      if ( (*(_BYTE *)(a3 + 21) & 1) != 0 )
      {
        v43 = 0;
        sub_1022F5B0(a3, "%u", &v43);
        goto LABEL_105;
      }
      if ( !(unsigned __int8)sub_1022E380(2) )
      {
