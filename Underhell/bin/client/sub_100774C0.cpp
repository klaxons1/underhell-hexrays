int __thiscall sub_100774C0(int this)
{
  int v2; // ecx
  int v3; // eax
  __int16 v4; // cx
  ...
  v11 = *(_DWORD *)(this + 4) + 60 * (unsigned __int16)result + 8;
  if ( *(_DWORD *)(this + 4) + 60 * (unsigned __int16)result != -8 )
  {
    *(_BYTE *)(*(_DWORD *)(this + 4) + 60 * (unsigned __int16)result + 20) = 0;
    *(_DWORD *)(v11 + 4) = 0;
    *(_DWORD *)(v11 + 8) = -1;
  }
