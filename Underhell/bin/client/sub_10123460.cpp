int __stdcall sub_10123460(int a1, _DWORD *a2)
{
  _DWORD *v2; // esi
  int v3; // eax
  bool v4; // zf
  ...
  if ( v15 >= 0 )
  {
    do
    {
      ...
      v4 = (*(int (__thiscall **)(_DWORD *, int, int *))(*v2 + 8))(v2, v18, &dword_103E5728) == 0;
      ...
      if ( HIBYTE(a2) && *(_DWORD *)(v18 + 68) )
      {
        ...
        HIBYTE(a2) = 1;
        v7 = dword_103E5774;
        if ( dword_103E5774 + 1 > dword_103E576C )
        {
          sub_1010AFF0(&dword_103E5768, dword_103E5774 - dword_103E576C + 1);
          v6 = dword_103E5774;
        }
        v8 = dword_103E5768;
        dword_103E5774 = v6 + 1;
        v9 = v6 - v7;
        dword_103E5778 = dword_103E5768;
        if ( v9 > 0 )
        {
          memcpy((void *)(dword_103E5768 + 4 * v7 + 4), (const void *)(dword_103E5768 + 4 * v7), 4 * v9);
          v8 = dword_103E5768;
        }
        v10 = (_DWORD *)(v8 + 4 * v7);
        if ( v10 )
      ...
      if ( HIBYTE(a2) )
      {
        ...
        if ( --v17 >= 0 )
        {
          do
          {
            ...
            (*(void (__thiscall **)(_DWORD *))(*v2 + 20))(v2);
            if ( (*(int (__thiscall **)(_DWORD *, _DWORD *, int *))(*v2 + 8))(v2, v12, &dword_103E5740) )
            {
              *v12 = v18;
              a2 = v12;
              sub_10122F90(&dword_103E577C, (int *)&a2);
            }
