char __thiscall sub_1002D8D0(unsigned __int16 *this, float a2, float a3, char a4)
{
  char v5; // bl
  int v6; // ecx
  int v7; // edx
  ...
  if ( this[8] )
  {
    v6 = this[7];
    v7 = this[6];
    v8 = 4 * *((unsigned __int8 *)this + 29);
    if ( v6 >= v7 )
      v6 -= v7;
    v9 = (_BYTE *)*((_DWORD *)this + 1);
    v10 = (_BYTE *)(*((_DWORD *)this + 2) + 8 * v6 + 4);
    if ( v8 < 4 )
    {
LABEL_7:
