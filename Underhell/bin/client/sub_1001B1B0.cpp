int __cdecl sub_1001B1B0(int a1, float a2, int a3, _DWORD *a4, unsigned __int8 *a5, int a6)
{
  int v6; // edx
  int v7; // ecx
  int v8; // edi
  ...
  v21[2] = v18;
  return sub_1001AED0((int)&savedregs, a1, a2, v21, v23, v24, v20, (int)v22, (int)a5, a6);
}
