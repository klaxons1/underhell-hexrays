int __thiscall sub_10022FA0(int *this, int a2, int a3, int a4)
{
  int *v4; // esi
  int result; // eax
  bool v6; // zf
  ...
  if ( !v6 )
  {
    ...
    if ( *(_DWORD *)(a2 + 164) )
    {
      v24 = sub_1001ACB0(&dword_10403328);
      if ( !v24 )
      {
        v24 = (int *)sub_100DDA40(6144);
        if ( ((unsigned __int8)v24 & 7) != 0 )
          __debugbreak();
      }
      v8 = v4[1031];
      memset(v19, 0, sizeof(v19));
      v9 = 132 * sub_10020810(v4 + 1028, v8, *(_DWORD *)(a2 + 164), 0);
      ...
      if ( *(int *)(a2 + 164) > 0 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            sub_10020130(v4[1022], (int)(v4 + 1033), a3, a4, v12, (int)v24, (int)v19);
            v13 = v22 + v4[1028];
            v14 = v23;
            *(_DWORD *)(v13 + 8) = v23;
            *(_DWORD *)(v13 + 16) = v14;
            ...
            v18 = &v24[4 * v15];
            *(_DWORD *)(v13 + 4) = 2;
            sub_101F0930(v18, v13 + 44, v13 + 32);
            v17 = *(_DWORD *)(v11 + 12);
            ...
            {
              sub_101ED920(v17 + v11 + 4, &v16[12 * *(_DWORD *)(v11 + v17)], v13 + 108);
            }
            v4 = v20;
          }
          v22 += 132;
      ...
      return sub_1001AC40(&dword_10403328, v24);
    }
  }
  return result;
}
