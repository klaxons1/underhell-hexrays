char __thiscall sub_101C9560(_BYTE *this, int a2, int a3, int a4, int a5, int a6)
{
  char result; // al
  ...
  if ( this[24] )
    return 0;
  v8 = *(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 20);
  this[24] = 1;
  ...
  else if ( (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 16))(
              this,
              a2,
              a3,
              a4,
