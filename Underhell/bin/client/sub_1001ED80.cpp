char __cdecl sub_1001ED80(int a1, float *a2, int *a3, int a4, int a5, int a6, int a7)
{
  char result; // al
  int v9; // ecx
  int v10; // eax
  ...
  if ( !*((_BYTE *)a2 + 64) )
    return sub_1001EB70((int)&savedregs, a1, a2, a3, a4, a5, a6, a7);
  v9 = a4;
  v26 = -1;
  *(float *)(a7 + 44) = 1.0;
  v25 = -1;
  *(_BYTE *)(a7 + 55) = 0;
  ...
  while ( 1 )
  {
    ...
    {
      v13 = sub_1001E8F0(v12, a2, *(float **)(a5 + 4 * *(_DWORD *)v12), a7);
      if ( v13 >= 0 )
      {
        v26 = v29;
        v25 = v13;
