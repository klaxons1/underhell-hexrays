float *__userpurge sub_101ABE10@<eax>(int *a1@<ecx>, int a2@<ebp>, float a3, int *a4, float *a5, int a6)
{
  int v7; // edi
  int v8; // ecx
  double v9; // st7
  ...
  float v23[3]; // [esp+74h] [ebp-CCh] BYREF
  float v24; // [esp+80h] [ebp-C0h] BYREF
  ...
  {
    v7 = sub_1009E370(i);
    if ( !*(_BYTE *)(v7 + 1248) && (!a6 || v7 != a6) )
    {
      sub_1009E3A0(v7, v28);
      sub_1009E3F0(v7, v27);
      sub_101F0290(a1[2] + 152, v27, v28, &v39, 0);
      v8 = a1[2];
      v9 = v39 - *(float *)(v8 + 152);
      v10 = (float *)(v8 + 152);
      v11 = v40 - v10[1];
      ...
      {
        v42 = a1[1];
        sub_1000E430(v22, v10, &v39);
        sub_1012D400(v29, v42, 0);
        ...
        if ( *(_DWORD *)(dword_10439134 + 48) )
          sub_10130AC0(v23, &v24, 255, 0, 0, 1, 5.0);
        if ( 1.0 == v25 )
          goto LABEL_15;
        if ( !v26 )
          goto LABEL_15;
        ...
        *(float *)&v42 = v14;
        ...
        sub_1000FCE0((int)v44, (int)a1, v30, &v39, 33636363, v19, 0, (int)v23);
        if ( 1.0 == v25 || !v26 || v26 == v7 || (*(_BYTE *)(v26 + 388) & 8) != 0 )
        {
LABEL_15:
          if ( v32 < (double)v34 )
          {
