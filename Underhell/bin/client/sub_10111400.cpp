int __thiscall sub_10111400(int this, float a2, float a3)
{
  int v4; // eax
  int v5; // ecx
  int v6; // edx
  ...
  v25 = 0;
  if ( sub_10110970(this, (int)v20, a2, a3, &v25) )
  {
    if ( LOBYTE(v20[0]) )
    {
    ...
    else
    {
        ...
        && *(float *)(this + 24) >= (double)flt_10433C50 )
      {
        ...
        v10 = sub_10027610((unsigned __int16 *)(this + 8), v24);
        sub_10110490((unsigned __int8 *)this, *(_DWORD *)(this + 4), v10, v16, v17, v18);
      }
      else
      {
