char __cdecl sub_1001C540(int a1, int a2, int a3, float a4, int a5, int a6, int a7, float *a8, char *a9)
{
  double v10; // st7
  float *v11; // ebx
  int v12; // edi
...
LABEL_12:
  ...
  v27 = sub_1001C270((float *)a9, a4);
  *((float *)a9 + 23) = v27;
  if ( v27 <= 0.001 )
  {
    if ( sub_10126C30(a5)
      && (*(_BYTE *)(*(_DWORD *)v12 + 12) & 1) != 0
      && *(_DWORD *)(sub_10126C30(a5) + 4) == 3
  ...
  while ( 2 )
  {
    if ( v28 != *v29 )
    {
      ...
      *((float *)a9 + 19) = *(float *)(v31 + 104) * *v29 + *((float *)a9 + 19);
      v33 = sub_1001C370((float *)a9, a4);
      v34 = *((_DWORD *)a9 + 1);
      *((float *)a9 + 22) = v33 * *v29 + *((float *)a9 + 22);
      if ( v34 > 0 && (v34 <= 3 || v34 == 5) )
      {
        if ( sub_1001C3D0(a1, v32, *(_DWORD *)((char *)v29 + v52), a4, (float *)v49, v47, (float *)&v50) )
        {
          v35 = *v29;
          v45 = v53;
...
LABEL_34:
      ...
      LODWORD(v51) = sub_1001C320((float *)a9, a4);
      v41 = *((_DWORD *)a9 + 1) == 5;
  ...
  if ( v42 < 0.99900001 )
  {
    ...
    *((float *)a9 + 10) = v43 * *((float *)a9 + 10);
    v46 = v43;
    sub_101EEBE0((int)v30, v46, (int)v30);
  }
  if ( *((_DWORD *)a9 + 1) == 1 && *((_DWORD *)a9 + 3) != -1 )
  {
    v44 = sub_10127F20(a3, *((_DWORD *)a9 + 3));
    *((_DWORD *)a9 + 3) = v44;
    if ( v44 == -1 )
      return 0;
  }
