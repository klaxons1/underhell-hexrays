int __usercall sub_100C87B0@<eax>(int a1@<ecx>, int a2@<ebx>, int a3@<edi>)
{
  int result; // eax
  double v5; // st7
  int v6; // ebx
  ...
  if ( *(_DWORD *)(dword_10430E6C + 48) )
  {
    ...
    v35 = (int)(*(float *)(a1 + 248) / (*(float *)(a1 + 256) + *(float *)(a1 + 264)));
    v6 = dword_1047CA6C;
      ...
      do
      {
        ...
        *(float *)&v38 = v12;
        (*(void (__thiscall **)(int, int, int, int, int))(v13 + 48))(
          ...
          v39,
          v11,
          (int)(v40 + *(float *)(a1 + 240)),
          (int)(v12 + *(float *)(a1 + 256)));
        v14 = *(float *)&v38 - (*(float *)(a1 + 256) + *(float *)(a1 + 264));
        v15 = v37-- == 1;
        v11 = (int)v14;
        v38 = (int)v14;
      }
    ...
    if ( v36 < v35 )
    {
      ...
      do
      {
        ...
        *(float *)&v38 = v23;
        ...
        v25 = *(float *)&v38 - (*(float *)(a1 + 256) + *(float *)(a1 + 264));
        v15 = v35-- == 1;
        v11 = (int)v25;
        v38 = (int)v25;
      }
