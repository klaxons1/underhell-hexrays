int __thiscall sub_100DC700(int this, int a2)
{
  int v3; // edi
  int v4; // edi
  ...
  if ( v15 )
  {
    if ( v15 == 2 )
    {
      (*(void (__thiscall **)(_DWORD, float *, int))(**(_DWORD **)(this + 12) + 112))(*(_DWORD *)(this + 12), v13, v16);
      (*(void (__thiscall **)(_DWORD, float *, int))(**(_DWORD **)(this + 16) + 112))(*(_DWORD *)(this + 16), v12, v16);
      v6 = *(_DWORD *)(this + 4);
      v11[0] = v13[0] - v12[0];
      v11[1] = v13[1] - v12[1];
      v11[2] = v13[2] - v12[2];
    ...
    else if ( v15 == 4 )
    {
      ...
      v4 = v3 - (*(int (__thiscall **)(_DWORD))(**(_DWORD **)(this + 16) + 104))(*(_DWORD *)(this + 16));
      v5 = *(void (__stdcall **)(_DWORD))(**(_DWORD **)(this + 4) + 12);
      v14 = *(float *)&v4;
      v9 = (float)v4;
      v5(LODWORD(v9));
    }
  ...
  else
  {
    ...
    *(float *)&v10 = v14
                   - ((double (__thiscall *)(_DWORD))*(_DWORD *)(**(_DWORD **)(this + 16) + 108))(*(_DWORD *)(this + 16));
