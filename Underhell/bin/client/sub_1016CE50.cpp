void __thiscall sub_1016CE50(int *this, int a2, int a3)
{
  float *v4; // eax
  float *v5; // esi
  double v6; // st7
  ...
  char v19; // al
  int v20; // eax
  _BYTE v21[12]; // [esp+80h] [ebp-5Ch] BYREF
  float v22[3]; // [esp+8Ch] [ebp-50h] BYREF
  float v23[3]; // [esp+98h] [ebp-44h] BYREF
  float v24; // [esp+A4h] [ebp-38h] BYREF
  float v25; // [esp+A8h] [ebp-34h]
  float v26; // [esp+ACh] [ebp-30h]
  float v27; // [esp+B0h] [ebp-2Ch] BYREF
  float v28; // [esp+B4h] [ebp-28h]
  float v29; // [esp+B8h] [ebp-24h]
  float v30; // [esp+BCh] [ebp-20h] BYREF
  float v31; // [esp+C0h] [ebp-1Ch]
  float v32; // [esp+C4h] [ebp-18h]
  int v33; // [esp+C8h] [ebp-14h]
  int *v34; // [esp+CCh] [ebp-10h]
  float v35; // [esp+D0h] [ebp-Ch]
  int v36; // [esp+D4h] [ebp-8h]
  float *v37; // [esp+D8h] [ebp-4h] BYREF
  int v38; // [esp+E8h] [ebp+Ch]

  v34 = this;
  CVProfile::EnterScope(g_VProfCurrentProfile, "MuzzleFlash_357_Player", 0, "Particle/Effect_Rendering", 0, 4);
  sub_100F32D0(&v37, (int)"MuzzleFlash_357_Player");
  sub_100F2A30(v37, 1u);
  sub_1016B9E0(this);
  ...
  if ( v4 )
  {
    ...
    *((_BYTE *)v5 + 53) = v11;
    LODWORD(v35) = (int)((double)v11 * 8.0);
