char __thiscall sub_101AC220(int this, int a2, float *a3, float a4, float a5)
{
  float *v7; // eax
  float v8; // edx
  float v9; // eax
  ...
  v30 = v7[39];
  v31 = v7[40];
  sub_101F0290(&v29, v21, v22, v20, 0);
  v26 = v20[0] - v29;
  v27 = v20[1] - v30;
  v28 = v20[2] - v31;
  v39 = off_103EDFEC();
...
LABEL_10:
  ...
  v40 = 1;
LABEL_11:
  v17 = fabs(*(float *)(this + 28) * v24 + v23 * *(float *)(this + 24) + *(float *)(this + 32) * v25) > *(float *)(dword_1044E634 + 44);
