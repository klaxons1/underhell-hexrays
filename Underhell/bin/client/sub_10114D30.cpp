int __usercall sub_10114D30@<eax>(_DWORD *a1@<eax>, int *a2, char *String1)
{
  int result; // eax
  __int16 v6; // dx
  int v7; // edx
  ...
  if ( result )
  {
    ...
    if ( (v6 & 0x7FFFu) <= 0x18 )
    {
      ...
      *(float *)&v14[2] = 3.0;
      ...
      v14[1] = 15;
      a1[2] = v8(a2, v14);
      v9 = (*(int (__thiscall **)(int, _DWORD))(*(_DWORD *)dword_10436250 + 152))(
             dword_10436250,
      ...
      while ( !(*(unsigned __int8 (__thiscall **)(int))(*(_DWORD *)v9 + 8))(v9) )
      {
        ...
        if ( !_stricmp(String1a, "solid") )
        {
          (*(void (__thiscall **)(int, _BYTE *, int (__stdcall ***)(int, char *, char *)))(*(_DWORD *)v9 + 12))(
            ...
            v12,
            &off_103E2154);
          sub_10114560((int)v12, a1, (int)a2, String1);
        }
        else if ( !_stricmp(String1a, "ragdollconstraint") )
        {
          (*(void (__thiscall **)(int, _BYTE *, _DWORD))(*(_DWORD *)v9 + 20))(v9, v13, 0);
          sub_101146A0((int)v13, (int)a2, (int)a1, (int)String1);
        }
        else if ( !_stricmp(String1a, "collisionrules") )
        {
          v15[1] = (*(int (__thiscall **)(int, _DWORD, _DWORD))(*(_DWORD *)dword_10436248 + 40))(
                     dword_10436248,
                     *((_DWORD *)String1 + 3),
                     *a1);
      ...
      return (*(int (__thiscall **)(int, int))(*(_DWORD *)dword_10436250 + 156))(dword_10436250, v9);
    }
  }
  return result;
}
