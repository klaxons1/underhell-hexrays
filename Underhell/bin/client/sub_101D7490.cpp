int __userpurge sub_101D7490@<eax>(int a1@<ecx>, double a2@<st0>, int a3, _DWORD *a4)
{
  double v5; // st7
  ...
  sub_101DAEF0(a3, 16, (int)v7, v11, 8, 0, *(unsigned __int8 *)(a1 + 10), 8, 0, 1);
  v9 = a2;
  v5 = 0.0;
  if ( 0.0 == v9 )
    v5 = 3.4028235e38;
  else
    sub_101DAEF0(a3, 16, (int)v8, v12, 6, 1, *(unsigned __int8 *)(a1 + 10), 8, 0, 1);
  v10 = v5;
  if ( v10 < (double)v9 )
