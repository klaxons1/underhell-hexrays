int __cdecl sub_100211E0(_DWORD *a1, _DWORD *a2, int a3, int a4, int a5, int a6, float *a7, float a8, int a9)
{
  int v9; // ebx
  int *v10; // eax
  int v11; // edx
  ...
  sub_101EE350(v37);
  v9 = 0;
  v49 = (char *)sub_1001ACB0(&dword_10403328);
  if ( !v49 )
  {
    v49 = (char *)sub_100DDA40(6144);
    if ( ((unsigned __int8)v49 & 7) != 0 )
      __debugbreak();
  }
  memset(v42, 0, sizeof(v42));
  v48 = (char *)sub_1001ACB0(&dword_10403328);
  if ( !v48 )
  {
    v48 = (char *)sub_100DDA40(6144);
    if ( ((unsigned __int8)v48 & 7) != 0 )
      __debugbreak();
  }
  memset(v41, 0, sizeof(v41));
  v10 = sub_1001ACB0(&dword_10403328);
  v52 = v10;
  if ( !v10 )
  {
    v52 = (int *)sub_100DDA40(6144);
...
LABEL_26:
          if ( v20 > 0.0 )
          {
            sub_10020130((int)a1, (int)v37, a3, (int)a2, v9, (int)v48, (int)v41);
            sub_10020130((int)a1, (int)v37, (int)a7, a6, v9, (int)v49, (int)v42);
            v45 = (char *)v53 + (_DWORD)v40;
            sub_101F0930((char *)v53 + (_DWORD)v40 + v39, v32, v36);
            sub_101F0930(v45, v33, v30);
            sub_101F0F00((int)v32, (int)v33, v44, (int)v31);
            sub_101F1020(v31, v34);
            sub_101F1750(v34, v36, v53);
            if ( v16 == -1 )
            {
              sub_101F0930(v53, v51, v35);
              v13 = a8;
              v14 = (_DWORD *)v51;
            }
            else
            {
              sub_101F0AB0(&v52[12 * v16], v29);
              sub_101EDC00(v29, v53, v28);
              sub_101F0930(v28, v51, v35);
              v14 = (_DWORD *)v51;
...
LABEL_30:
  ...
  sub_1001AC40(&dword_10403328, (int *)v49);
  sub_1001AC40(&dword_10403328, (int *)v48);
  return sub_1001AC40(&dword_10403328, v52);
}
