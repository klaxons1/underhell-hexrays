__int16 *__thiscall sub_10230F20(int *this, __int16 *a2, const char *Src)
{
  const char *v3; // esi
  __int16 *result; // eax
  __int16 v6; // ax
  ...
  if ( Src )
  {
    this[8] = (int)Src;
    v20 = -1;
    v6 = sub_102304A0((int)this, (unsigned __int16 *)&v20);
    if ( v6 == -1 )
    {
      v7 = strlen(v3) + 1;
      v8 = 0;
...
LABEL_10:
      ...
      *(_DWORD *)(v16 + 4) += v7;
      HIWORD(Src) = v19;
      LOWORD(Src) = v17;
      v6 = sub_10230E50((int)this, (unsigned __int16 *)&Src);
    }
    *a2 = v6;
    return a2;
  }
