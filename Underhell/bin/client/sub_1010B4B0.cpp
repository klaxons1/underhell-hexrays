int __usercall sub_1010B4B0@<eax>(float *a1@<eax>, float *a2@<ecx>, int a3)
{
  float v3; // edx
  float v4; // ecx
  double v5; // st7
...
LABEL_23:
  ...
  for ( ; v9 > 0; result = sub_101EDA20(&v24, v16, a3) )
  {
    v15 = v17[2 * v9];
    v16 = v17[2 * v9-- + 1];
    sub_101EDA00(a3, v15, &v21);
    sub_101EDA00(a3, v16, v20);
    sub_101EDA20(v20, v15, a3);
    v24 = -v21;
    v25 = -v22;
    v26 = -v23;
  }
