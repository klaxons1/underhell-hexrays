char __cdecl sub_102ACBF0(int Src, int a2)
{
  int v2; // ebp
  int *v3; // esi
  int v4; // ebx
  ...
  *(_DWORD *)(a2 + 12) = 0;
  if ( (*(_BYTE *)(Src + 21) & 1) != 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !(unsigned __int8)sub_102AFD90(Src, *v3 + 16 * v13) )
        break;
      sub_1022E840((_DWORD *)Src);
      if ( *(_BYTE *)(Src + 20) )
        return 1;
  ...
  else
  {
    ...
    for ( i = 0; ; i += 16 )
    {
      ...
      if ( !(unsigned __int8)sub_102AFD90(Src, i + *v3) )
        break;
      if ( ++v4 >= a2 )
      {
        v2 = Src;
