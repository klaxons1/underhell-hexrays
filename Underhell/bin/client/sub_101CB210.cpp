char __thiscall sub_101CB210(_BYTE *this, int a2, int a3, int a4, int a5, int a6)
{
  char result; // al
  int v8; // edi
  unsigned int i; // edi
  ...
  if ( (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _WORD *))(*(_DWORD *)this + 160))(
         this,
         a2,
         a3,
         v8,
  ...
  result = (*(int (__thiscall **)(_BYTE *, int, int, int, int, _WORD *))(*(_DWORD *)this + 168))(
             this,
             a2,
             a3,
             v8,
