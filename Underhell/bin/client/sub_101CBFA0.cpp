char __thiscall sub_101CBFA0(_BYTE *this, int a2, int a3, int a4, int a5, int a6)
{
  char result; // al
  int v8; // ebp
  ...
  _WORD v12[256]; // [esp+D40h] [ebp-204h] BYREF

  if ( this[24] )
    return 0;
  v8 = 4 * (unsigned __int8)a5 * (unsigned __int8)a4;
  this[24] = 1;
  sub_101C6E60((int)v11, a6, v8);
  if ( (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 192))(
    ...
    || (sub_101C7120((int)v10, a6, v8),
        (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 196))(
          ...
          a5,
          v10))
    || (sub_101C7350(v12, *(float *)&a6, v8),
        (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _WORD *))(*(_DWORD *)this + 200))(
          this,
          a2,
          a3,
          a4,
          a5,
          v12))
    || (sub_101C7920(a6, (unsigned __int8)a5 * (unsigned __int8)a4),
        sub_101C7700((int)v9, a6, v8),
