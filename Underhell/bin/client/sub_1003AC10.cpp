int __thiscall sub_1003AC10(int this, float a2, float a3)
{
  int v4; // eax
  int v5; // ebx
  int v6; // edx
  ...
  if ( sub_10038CB0(this, (int)v24, a2, a3, &v29) )
  {
    ...
    if ( v26 == v25 )
    {
        ...
        && *(float *)(this + 24) >= (double)flt_10433C50 )
      {
        ...
        sub_10036AB0((unsigned __int8 *)this, *(_DWORD *)(this + 4), v12, v20, v21, v22);
LABEL_28:
    ...
    sub_10036BD0(
      ...
      *(_DWORD *)(this + 4),
      v27,
      (float *)(*(_DWORD *)(this + 8) + 16 * v16),
      (float *)(*(_DWORD *)(this + 8) + 16 * v15));
    goto LABEL_28;
  }
  return v29;
}
