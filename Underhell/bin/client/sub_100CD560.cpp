int __thiscall sub_100CD560(_DWORD *this, int a2)
{
  int v2; // edx
  int v4; // eax
  int *v5; // ecx
  ...
  if ( a2 != this[4] )
  {
    while ( 1 )
    {
      ...
      v11 = v10[2];
      v12 = sub_100CC730(this, v9);
      v13 = dword_10430EA8;
      if ( v12 )
      {
        if ( (dword_10430EA8 & 1) == 0 )
        {
          v13 = dword_10430EA8 | 1;
          dword_10430EA8 |= 1u;
          dword_10430E98 = -1;
          dword_10430E9C = -1;
          dword_10430EA0 = -1;
        ...
        {
          a2 = v9;
          sub_100CC7E0(this, v9);
          v17 = dword_10430EA8;
          if ( (dword_10430EA8 & 1) == 0 )
          {
            v17 = dword_10430EA8 | 1;
            dword_10430EA8 |= 1u;
            dword_10430E98 = -1;
            dword_10430E9C = -1;
            dword_10430EA0 = -1;
...
LABEL_61:
        ...
        if ( sub_100CC730(this, a2) )
        {
          a2 = v9;
          sub_100CC990(this, v9);
          v22 = dword_10430EA8;
          if ( (dword_10430EA8 & 1) == 0 )
          {
            v22 = dword_10430EA8 | 1;
            dword_10430EA8 |= 1u;
            dword_10430E98 = -1;
            dword_10430E9C = -1;
            dword_10430EA0 = -1;
