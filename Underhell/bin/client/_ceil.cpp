double __cdecl ceil(double X)
{
  ...
  if ( v2 )
  {
    ...
    v6 = _mm_sub_epi32((__m128i)xmmword_103AD5F0, (__m128i)_mm_and_pd(v4, (__m128d)xmmword_103AD610));
    ...
    else
    {
      ...
      if ( v5 < 1023 )
      {
        *(_QWORD *)&X = *(_OWORD *)&_mm_cmpnle_pd(v11, (__m128d)xmmword_103AD600) & 0x3FF0000000000000LL;
        return X;
      }
      else
      {
