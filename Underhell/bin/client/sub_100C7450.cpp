const unsigned __int16 *__thiscall sub_100C7450(_DWORD *this)
{
  int v2; // eax
  int v3; // eax
  int v4; // ebx
  ...
  (*(void (__thiscall **)(int, _DWORD, _DWORD, _DWORD, int))(*(_DWORD *)dword_1047CA6C + 48))(
    ...
    this[183],
    v26);
  (*(void (__stdcall **)(int, _DWORD, int, int))(*(_DWORD *)dword_1047CA6C + 48))(v27 - this[185], 0, v27, v26);
  ...
  v4 = (*(int (__thiscall **)(int, const char *, _DWORD))(*(_DWORD *)v3 + 12))(v3, "MenuTitle", 0);
  ...
  (*(void (__thiscall **)(int, _DWORD))(*(_DWORD *)dword_1047CA6C + 72))(
    dword_1047CA6C,
    *(_DWORD *)((char *)this + 726));
  v6 = (const unsigned __int16 *)(*(int (__thiscall **)(int, _DWORD *))(*(_DWORD *)dword_1047CA78 + 8))(
                                   dword_1047CA78,
                                   this + 52);
  v7 = v6;
  if ( v6 )
  ...
  result = (const unsigned __int16 *)(*(int (__thiscall **)(int, _DWORD *))(*(_DWORD *)dword_1047CA78 + 8))(
                                       dword_1047CA78,
                                       this + 116);
  v24 = (int)result;
  if ( result )
