char __usercall sub_10090D00@<al>(float *a1@<edi>, float *a2@<esi>, float *a3, int a4, float a5, float *a6)
{
  double v6; // st6
  double v7; // st5
  char result; // al
  ...
  sub_101EDC00(a3, a4, &v19);
  sub_101EDA00(&v19, 3, &v37);
  sub_10090C50(&v28, &v19);
  ...
  if ( v28 < 0.99900001 )
  {
    ...
    {
      sub_101EDA00(a4, 0, v40);
      sub_101EDA40(a3, v40, a6);
      return 1;
    }
  }
  if ( v29 < 0.99900001 )
