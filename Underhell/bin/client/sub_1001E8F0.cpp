int __usercall sub_1001E8F0@<eax>(float *a1@<eax>, float *a2@<edi>, float *a3, int a4)
{
  double v5; // st7
  double v6; // st5
  float *v7; // ecx
  ...
  *(float *)&v35 = 0.0;
  ...
  if ( v41 * v39 + v42 * v38 < fabs(v22 * a3[10] + v19 * a3[2] + v21 * a3[6]) )
    return -1;
  sub_101ED8C0(a2, a3, v30);
  *(float *)&v35 = *(float *)&v35 * 2.0;
  v36 = v36 * 2.0;
  v37 = 2.0 * v37;
  if ( !(unsigned __int8)sub_10090840((int)v30, (int)&v35, v33, v34, 0.0, (int)v26, 0) )
    return -1;
  v24 = v28 * *(float *)(a4 + 44);
  *(_BYTE *)(a4 + 55) = v29;
  v25 = v27;
