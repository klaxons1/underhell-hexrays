int __thiscall sub_10147860(int this, unsigned __int16 a2)
{
    ...
    if ( *(_WORD *)v14 == v9 )
    {
      ...
      if ( *((_WORD *)v17 + 3) )
      {
        ...
        if ( *((_WORD *)v21 + 1) == v2 )
        {
          v2 = v9;
          a2 = v9;
          sub_10143F70(this, v9);
          v9 = sub_10143C50((_DWORD *)this, v9);
          LOWORD(v11) = sub_10143C50((_DWORD *)this, v9);
        }
        *(_WORD *)(*(_DWORD *)(this + 4) + 12 * v9 + 6) = 1;
        *(_WORD *)(*(_DWORD *)(this + 4) + 12 * (unsigned __int16)v11 + 6) = 0;
        sub_10144070(this, v11);
        continue;
      }
      *(_WORD *)(*(_DWORD *)(this + 4) + 12 * v9 + 6) = 1;
      v18 = v16;
    ...
    else
    {
      ...
      if ( *((_WORD *)v24 + 3) )
      {
        ...
        if ( *(_WORD *)v27 == v2 )
        {
          v2 = v9;
          a2 = v9;
          sub_10144070(this, v9);
          v9 = sub_10143C50((_DWORD *)this, v9);
          LOWORD(v11) = sub_10143C50((_DWORD *)this, v9);
        }
        *(_WORD *)(*(_DWORD *)(this + 4) + 12 * v9 + 6) = 1;
        *(_WORD *)(*(_DWORD *)(this + 4) + 12 * (unsigned __int16)v11 + 6) = 0;
        sub_10143F70(this, v11);
        continue;
      }
      *(_WORD *)(*(_DWORD *)(this + 4) + 12 * v9 + 6) = 1;
      v18 = v23;
