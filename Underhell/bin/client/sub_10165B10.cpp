        ...
        int a18)
{
  ...
  v20 = (float)a17;
  v19 = (float)a12;
  return (*((int (__thiscall **)(void ***, int, int, int, int, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, int, _DWORD, _DWORD, _DWORD, _DWORD))*off_103E773C[0]
          + 11))(
           off_103E773C[0],
           a3,
           a4,
