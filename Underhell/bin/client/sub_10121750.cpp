double __thiscall sub_10121750(void *this, int a2, int a3, int a4, int a5)
{
  int v6; // edi
  double v7; // st7
  float *v8; // esi
  ...
  if ( a5 > 0 )
  {
    while ( 1 )
    {
      ...
      {
        v10 = ((double (__stdcall *)(_DWORD, _DWORD))*(_DWORD *)(*(_DWORD *)dword_10413198 + 4))(*v8, v8[1]);
      }
      v7 = -1.0;
LABEL_8:
      if ( v7 == v8[2] && v8[3] == v7 )
      ...
      {
        v11 = ((double (__stdcall *)(_DWORD, _DWORD))*(_DWORD *)(*(_DWORD *)dword_10413198 + 4))(v8[2], v8[3]);
      }
