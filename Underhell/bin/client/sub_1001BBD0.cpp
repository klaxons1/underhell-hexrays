        ...
        float a11)
{
  ...
  if ( *(int *)(a5 + 148) > 0 )
  {
    ...
    for ( i = 0; ; i += 24 )
    {
      ...
      if ( (v15 & 0x4000) != 0 )
      {
        v19 = sub_10127A40(a6, *v14);
        v20 = sub_10127B00(v19, v14[1]);
        v21 = v20;
        if ( v20 == -1 )
        {
          v17 = 0.0;
...
LABEL_29:
      v28 = sub_10127A40(a6, *v14);
      sub_10024510(a1, a2, a3, a4, v28, LODWORD(v31), a8, a9, LODWORD(v32), LODWORD(a11));
      v13 = a10;
LABEL_32:
      v12 = i + 24;
