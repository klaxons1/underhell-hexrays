int __thiscall sub_10072320(_DWORD *this, int a2)
{
  int v2; // edx
  int v4; // eax
  int *v5; // ecx
  ...
  if ( a2 != this[4] )
  {
    while ( 1 )
    {
      ...
      v11 = v10[2];
      v12 = sub_100716C0(this, v9);
      v13 = dword_10412B58;
      if ( v12 )
      {
        if ( (dword_10412B58 & 1) == 0 )
        {
          v13 = dword_10412B58 | 1;
          dword_10412B58 |= 1u;
          dword_10412B48 = -1;
          dword_10412B4C = -1;
          dword_10412B50 = -1;
        ...
        {
          a2 = v9;
          sub_10071770(this, v9);
          v17 = dword_10412B58;
          if ( (dword_10412B58 & 1) == 0 )
          {
            v17 = dword_10412B58 | 1;
            dword_10412B58 |= 1u;
            dword_10412B48 = -1;
            dword_10412B4C = -1;
            dword_10412B50 = -1;
...
LABEL_61:
        ...
        if ( sub_100716C0(this, a2) )
        {
          a2 = v9;
          sub_10071920(this, v9);
          v22 = dword_10412B58;
          if ( (dword_10412B58 & 1) == 0 )
          {
            v22 = dword_10412B58 | 1;
            dword_10412B58 |= 1u;
            dword_10412B48 = -1;
            dword_10412B4C = -1;
            dword_10412B50 = -1;
