int __thiscall sub_1011B4A0(_DWORD *this, int (__thiscall ***a2)(int))
{
  int v4; // eax
  ...
  v13[0] = this + 16;
  v7 = *(void (__thiscall **)(int *, _DWORD *, int (__thiscall ***)(int)))(dword_10437584 + 4);
  v13[1] = 0;
  v13[2] = 0;
  v7(&dword_10437584, v13, a2);
  if ( (int)this[12] > 0 )
  {
    do
    {
