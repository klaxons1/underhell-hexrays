int __userpurge sub_101D3510@<eax>(int *a1@<ecx>, int a2@<edi>, char *a3@<esi>, _DWORD *a4, _DWORD *a5)
{
  int v6; // eax
  int v7; // ecx
  unsigned int v8; // edi
  ...
  for ( i = 0; v10 < v9; i = v10 )
  {
    if ( v8 )
    {
      ...
      do
      {
        ...
        if ( HIBYTE(v22) )
        {
          (*(void (__thiscall **)(int *, char *))(v13 + 116))(a1, v27);
          v14 = *(void (__thiscall **)(_DWORD *, int, int, int))(*a5 + 208);
          v15 = &v26;
        }
        else
        {
          (*(void (__thiscall **)(int *, char *))(v13 + 112))(a1, v29);
