int __thiscall sub_100B4FC0(int this, unsigned __int16 a2)
{
  ...
  v4 = sub_100B41D0((_DWORD *)this, a2);
  v5 = v4;
  *(_WORD *)(16 * a2 + *(_DWORD *)(this + 4)) = sub_100B4230((_DWORD *)this, v4);
  v8 = 16 * a2;
  if ( sub_100B4230((_DWORD *)this, v5) != -1 )
    *(_WORD *)(*(_DWORD *)(this + 4) + 16 * (unsigned __int16)sub_100B4230((_DWORD *)this, v5) + 4) = a2;
  if ( (_WORD)v5 != 0xFFFF )
  ...
  else
  {
    ...
    if ( sub_100B4230((_DWORD *)this, v6) == a2 )
