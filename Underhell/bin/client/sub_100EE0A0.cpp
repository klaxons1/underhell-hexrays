int __thiscall sub_100EE0A0(int this, unsigned __int16 a2)
{
  ...
  if ( a2 != *(_WORD *)(this + 16) )
  {
    while ( 1 )
    {
      ...
      if ( *(_WORD *)v14 == (_WORD)v9 )
      {
        ...
        {
          a2 = v9;
          sub_100EC970(this, v9);
          v21 = dword_10435BAC;
          if ( (dword_10435BAC & 1) == 0 )
          {
            v21 = dword_10435BAC | 1;
            dword_10435BAC |= 1u;
            dword_10435BA4 = -1;
            dword_10435BA8 = 0x1FFFF;
          }
...
LABEL_81:
        ...
        {
          a2 = v9;
          sub_100ECA60(this, v9);
          v29 = dword_10435BAC;
          if ( (dword_10435BAC & 1) == 0 )
          {
            v29 = dword_10435BAC | 1;
            dword_10435BAC |= 1u;
            dword_10435BA4 = -1;
            dword_10435BA8 = 0x1FFFF;
          }
