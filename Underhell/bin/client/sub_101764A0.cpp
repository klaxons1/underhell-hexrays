void __cdecl sub_101764A0(float *a1, float *a2, int a3, char a4)
{
  double v5; // st7
  double v6; // st7
  double v7; // st6
  ...
  CVProfile::EnterScope(g_VProfCurrentProfile, "FX_GunshipTracer", 0, "Particle/Effect_Rendering", 0, 4);
  *(float *)v11 = *a2 - *a1;
  ...
  *(float *)&v11[2] = a2[2] - a1[2];
  ...
  if ( v5 > 256.0 )
  {
    ...
    v9 = v6;
    v8 = v7;
    sub_1008DBD0((int)a1, (int)v11, v8, v9, v13, 5.0, v10, (int)"effects/gunshiptracer");
    if ( a4 )
