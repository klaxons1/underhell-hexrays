char __cdecl sub_1001DF00(_DWORD *a1, float a2, float a3, int a4, int a5)
{
  double v6; // st7
  ...
  if ( !a1[5] )
    return 0;
  sub_1001DD80(a1, a2, (float *)v12, (float *)&v8);
  sub_1001DD80(a1, a3, (float *)v13, (float *)v10);
