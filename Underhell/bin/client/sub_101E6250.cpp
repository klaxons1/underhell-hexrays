char __cdecl sub_101E6250(int a1, int a2)
{
  float *v2; // esi
  float *v3; // edi
  ...
  v3 = *(float **)(a1 + 4);
  v15 = sub_10103A90(v3);
  if ( sub_10103A90(v2) > v15 )
    return 1;
  v16 = sub_10103A90(v3);
  if ( sub_10103A90(v2) < v16 )
    return 0;
  if ( !sub_101E1CC0(v3) || !sub_101E1CC0(v2) )
    goto LABEL_9;
  v17 = sub_10103A80(v3);
  if ( sub_10103A80(v2) < v17 )
    return 1;
  v18 = sub_10103A80(v3);
  if ( sub_10103A80(v2) > v18 )
    return 0;
LABEL_9:
  ...
  if ( NumExternalThreads && v6 && NumExternalThreads == v6 )
  {
    ...
    {
      v10 = sub_101EA940(v7);
      return v10 < sub_101EA940(v9);
    }
    else
    {
      v11 = (const char *)sub_101E1B70((char *)v2);
      v12 = strcmp((const char *)sub_101E1B70((char *)v3), v11);
      return v12 && -(v12 < 0) - ((v12 < 0) - 1) == -1;
    }
  }
  else
  {
    v13 = (const char *)sub_101E1B70((char *)v2);
    v14 = strcmp((const char *)sub_101E1B70((char *)v3), v13);
