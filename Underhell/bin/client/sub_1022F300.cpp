int __thiscall sub_1022F300(int this, char *a2, int a3)
{
  char v4; // bl
  int v5; // edi
  char v6; // al
      ...
      else if ( v4 == 37 )
      {
        ...
        switch ( v7 )
        {
          case 'c':
            v8 = *(_BYTE **)(v5 + 4);
            v5 += 4;
            if ( (*(_BYTE *)(this + 20) & 2) != 0 || (v9 = sub_1022E380(this, 1), *(_BYTE *)(this + 20) &= ~2u, !v9) )
            {
              result = v18;
              *v8 = 0;
              return result;
