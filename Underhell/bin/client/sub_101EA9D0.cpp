char __thiscall sub_101EA9D0(char *Destination, int a2, _DWORD *a3, int a4)
{
  int v5; // edi
  ...
  if ( v6 )
  {
    ...
    {
      v17 = sub_101E7B60(a3);
      if ( !(unsigned __int8)sub_101ECA00(a2, a3, Destination, v5) )
        return 0;
