int __thiscall sub_101BAAB0(int this, unsigned __int16 a2)
{
  ...
  if ( a2 != *(_WORD *)(this + 16) )
  {
    while ( 1 )
    {
      ...
      if ( *(_WORD *)v14 == (_WORD)v9 )
      {
        ...
        {
          a2 = v9;
          sub_101BA710(this, v9);
          v21 = dword_1044F1F8;
          if ( (dword_1044F1F8 & 1) == 0 )
          {
            v21 = dword_1044F1F8 | 1;
            dword_1044F1F8 |= 1u;
            dword_1044F1F0 = -1;
            dword_1044F1F4 = 0x1FFFF;
          }
...
LABEL_81:
        ...
        {
          a2 = v9;
          sub_101BA9C0(this, v9);
          v29 = dword_1044F1F8;
          if ( (dword_1044F1F8 & 1) == 0 )
          {
            v29 = dword_1044F1F8 | 1;
            dword_1044F1F8 |= 1u;
            dword_1044F1F0 = -1;
            dword_1044F1F4 = 0x1FFFF;
          }
