int __thiscall sub_10270830(int (__thiscall ***this)(void *, int, int))
{
  int v2; // edi
  int v3; // ebx
  _DWORD *v4; // eax
  ...
  sub_102361D0(this, (int)&v7, (int)&v6);
  v2 = dword_1047CA6C;
  v3 = *(_DWORD *)dword_1047CA6C;
  v4 = (_DWORD *)((int (__thiscall *)(int (__thiscall ***)(void *, int, int), _BYTE *))(*this)[56])(this, v8);
