int __usercall sub_101C39B0@<eax>(signed int a1@<eax>, int a2, int *a3, signed int a4)
{
  int result; // eax
  int v6; // edi
  void *v7; // esp
  ...
  char v27[4]; // [esp+20h] [ebp-28h] BYREF
  char v28[4]; // [esp+24h] [ebp-24h] BYREF
  int v29; // [esp+28h] [ebp-20h]
  int *v30; // [esp+2Ch] [ebp-1Ch]
  int v31; // [esp+30h] [ebp-18h]
  int v32; // [esp+34h] [ebp-14h]
  __int16 *v33; // [esp+38h] [ebp-10h]
  __int16 *v34; // [esp+3Ch] [ebp-Ch]
    ...
    do
    {
      ...
      if ( v8 > 0 )
      {
        ...
        do
        {
          ...
          v13 = a4;
          v14 = v33;
          sub_101C1540(a4, v33, (int)v12, v25, v26, v27, v28);
          sub_101C1D00(v14, v24, v13, 3);
