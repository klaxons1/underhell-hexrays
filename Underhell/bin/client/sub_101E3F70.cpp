char __userpurge sub_101E3F70@<al>(int *a1@<ecx>, int a2@<ebp>, _DWORD *a3, int a4)
{
  _DWORD *v4; // esi
  ...
  do
  {
    ...
    else if ( (unsigned __int8)sub_1022E380(4) )
    {
      ...
      if ( !v8 )
        sub_1011C390((_BYTE *)v4 + 44, Src, (char *)Src, 1);
      v4[3] += 4;
    }
    else
    {
