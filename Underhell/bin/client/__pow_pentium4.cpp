        ...
        double a9)
{
  ...
  v13.m128d_f64[0] = v13.m128d_f64[0] * *(double *)((char *)&qword_103AFF00 + 4 * v12);
  a6.m128d_f64[0] = *(double *)((char *)&qword_103AFF00 + 4 * v12);
  v14 = *(__m128d *)((char *)&xmmword_103B0310 + 8 * v12);
  v15 = 32751 - epi16;
        ...
        if ( v63 == 255 )
        {
          ...
          *(double *)v62.m128i_i64 = a9;
          v72 = (__m128d)_mm_sub_epi32(
                           _mm_srli_epi64((__m128i)_mm_and_pd(v72, (__m128d)xmmword_103B37B0), 0x34u),
...
X_NAN:
  ...
  *(double *)v62.m128i_i64 = a9;
  ...
  v65 = _mm_sub_epi32(_mm_srli_epi64((__m128i)_mm_and_pd(v61, (__m128d)xmmword_103B37B0), 0x34u), (__m128i)a4);
  a4.m128d_f64[0] = -0.0;
...
BACK_DEN:
  ...
  inserted = (__m128d)_mm_srli_epi64((__m128i)_mm_and_pd(inserted, (__m128d)xmmword_103B37B0), 0x2Cu);
  v13 = _mm_or_pd(v68, a3);
  v69 = ((unsigned __int8)_mm_extract_epi16((__m128i)inserted, 0) + 1) & 0x1FE;
  v13.m128d_f64[0] = v13.m128d_f64[0] * *(double *)((char *)&qword_103AFF00 + 4 * v69);
  a6.m128d_f64[0] = *(double *)((char *)&qword_103AFF00 + 4 * v69);
  v14 = *(__m128d *)((char *)&xmmword_103B0310 + 8 * v69);
  v17 = 278143;
BACK_MAIN:
  ...
  a4.m128d_f64[0] = a4.m128d_f64[0] * *(double *)((char *)&qword_103B0B20 + 4 * v21);
  a6.m128d_f64[0] = a6.m128d_f64[0] * *(double *)((char *)&qword_103B0B20 + 4 * v21);
  v22 = _mm_add_pd(v14, *(__m128d *)((char *)&xmmword_103B0F30 + 8 * v21));
  a5 = _mm_or_pd(_mm_and_pd(a5, (__m128d)xmmword_103B3790), (__m128d)xmmword_103B37A0);
  ...
  a6.m128d_f64[0] = a6.m128d_f64[0] * *(double *)((char *)&qword_103B1740 + 4 * v24);
  v25 = v23 * *(double *)((char *)&qword_103B1740 + 4 * v24);
  v34 = _mm_add_pd(v22, *(__m128d *)((char *)&xmmword_103B1F50 + 8 * v24));
...
RET_Y_NAN:
        ...
        (v101 | v100) < 0x80000000) )
  {
    ...
    *(_QWORD *)&v44 = _mm_shuffle_epi32((__m128i)v34, 238).m128i_u64[0];
    ...
    {
      v47 = _mm_mul_pd((__m128d)xmmword_103B2F60, v35);
      v48 = _mm_mul_pd(v35, v35);
      v49 = (__m128i)_mm_add_pd(v47, _mm_mul_pd((__m128d)xmmword_103B2F70, v48));
      *(double *)v49.m128i_i64 = *(double *)v49.m128i_i64 * v48.m128d_f64[0]
      ...
      v50 = (__m128i)_mm_mul_pd(
                       (__m128d)xmmword_103B2F80[(int)v41 & 0x7F],
      ...
      v52 = _mm_mul_pd((__m128d)xmmword_103B37C0, v51);
      v53 = 0.6931471805599453 * v51.m128d_f64[0];
      v54 = _mm_mul_pd(v51, v51);
      v55 = (__m128i)_mm_mul_pd(_mm_add_pd((__m128d)xmmword_103B37D0, v52), v54);
...
RET_ZERO_UF:
    ...
    v84 = _mm_mul_pd((__m128d)xmmword_103B2F60, v35);
    v85 = _mm_mul_pd(v35, v35);
    v33.m128d_f64[0] = v41 - (v41 + 6.755399441055744e15 - 6.755399441055744e15);
    v86 = (__m128i)_mm_add_pd(v84, _mm_mul_pd((__m128d)xmmword_103B2F70, v85));
    v87 = (__m128i)_mm_mul_pd(
                     (__m128d)xmmword_103B2F80[v79],
    ...
    v89 = _mm_mul_pd((__m128d)xmmword_103B37C0, v88);
    v90 = 0.6931471805599453 * v88.m128d_f64[0];
    v70 = _mm_mul_pd(v88, v88);
    v91 = (__m128i)_mm_mul_pd(_mm_add_pd((__m128d)xmmword_103B37D0, v89), v70);
