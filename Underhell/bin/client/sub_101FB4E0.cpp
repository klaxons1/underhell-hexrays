int *__userpurge sub_101FB4E0@<eax>(
        int a1@<ecx>,
        int a2@<edi>,
        int a3@<esi>,
        void *Src,
        ...
        int a8)
{
  ...
  v8 = a6;
  result = (int *)sub_102AA770(Src);
  if ( result )
  {
    if ( *result == 15 )
    {
      Srca = (_DWORD *)((char *)off_103EE614 + 20 * a5);
      result = sub_101F6B90(result);
      v33 = result;
      v34 = result[3];
      v32 = 0;
      if ( v34 > 0 )
      {
        while ( 2 )
        {
          v11 = (_DWORD *)sub_102AA770("functionName");
          if ( v11 )
          {
            if ( *v11 == 5 )
              v12 = (const char *)sub_1022CF00(v11[2]);
            else
              v12 = Locale;
          }
          else
          ...
          v13 = 0;
          while ( _stricmp(v12, (&off_103EE618)[v13]) )
          {
            v13 += 2;
            if ( v13 >= 0x6A )
            {
          ...
          v14 = (char *)*(&off_103EE61C + v13);
          if ( v14 != v12 )
          {
            sub_102AA700(1);
            sub_102AAB50("functionName");
            sub_102AD500(v14);
            if ( v8 )
              sub_102AA700(0);
          }
