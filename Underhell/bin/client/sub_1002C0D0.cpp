void *__thiscall sub_1002C0D0(int this, float a2, void *Src, char a4)
{
  int v5; // eax
  int v6; // ecx
  __int16 v7; // dx
...
LABEL_27:
  ...
  *(float *)v30 = a2;
  if ( v28 )
  {
    ...
    {
      *(_DWORD *)(v30 + 4) = v28;
      result = (void *)sub_100DDA40((unsigned __int64)v28 >> 30 != 0 ? -1 : 4 * v28);
      *(_DWORD *)(v30 + 8) = result;
    }
  }
  else
