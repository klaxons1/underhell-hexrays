char __thiscall sub_101C9DA0(_BYTE *this, int a2, int a3, int a4, int a5, int a6)
{
  char result; // al
  unsigned int i; // eax
  __int16 v9; // cx
  ...
  if ( (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _WORD *))(*(_DWORD *)this + 132))(
         this,
         a2,
         a3,
         a4,
  ...
  if ( (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _WORD *))(*(_DWORD *)this + 136))(
         this,
         a2,
         a3,
         a4,
  ...
  result = (*(int (__thiscall **)(_BYTE *, int, int, int, int, _WORD *))(*(_DWORD *)this + 140))(
             this,
             a2,
             a3,
             v11,
