_DWORD *__fastcall sub_101E6520(_DWORD *a1)
{
  _DWORD *result; // eax
  int v3; // edi
  int v4; // ebp
  ...
  for ( i = 0; v3 < a1[9]; i = v3 )
  {
    ...
    if ( v4 )
    {
      v5 = 0;
      v11 = 0;
      result = (_DWORD *)sub_101EA900(result[v3]);
      if ( (int)result > 0 )
      {
        do
        {
          v6 = (Concurrency::details::VirtualProcessor *)sub_101EA910(v5);
          v7 = v6;
          if ( v6 )
          {
            v8 = 0;
            if ( (int)Concurrency::details::VirtualProcessor::GetMaskId(v6) > 0 )
            {
              do
              {
                v9 = (unsigned __int8 *)sub_101EAE80(v8);
                if ( v9 )
                {
                  v10 = sub_101E1B20(v9);
