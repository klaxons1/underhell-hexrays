float *__cdecl sub_1001E430(int a1, float a2, float *a3, int a4, int a5, float *a6)
{
  ...
  if ( (v6 & 1) != 0 )
  {
    ...
    v23 = sub_1001AB20(*v7);
    v24 = sub_1001AB20(v7[1]);
    v8 = sub_1001AB20(v7[2]);
    result = a6;
    *a6 = v23;
    a6[1] = v24;
    a6[2] = v8;
  ...
  else if ( (v6 & 4) != 0 )
  {
    ...
    if ( a2 <= 0.001 )
    {
      ...
      for ( i = a4 - (_DWORD)a6; ; v17 = i )
      {
        ...
        v20 = v19 <= 0 ? 0 : v12 + v19;
        v22 = v18;
        result = (float *)sub_1001AE60(a1, v20, v22, v11);
        ++v10;
        ++v11;
        if ( v10 >= 3 )
          break;
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        v16 = v15 <= 0 ? 0 : v12 + v15;
        v21 = v14;
        result = (float *)sub_1001AD50(a1, v16, v21, (float *)&v26, (float *)&v25);
        ++v10;
