void __thiscall sub_1008EC80(char *this, float *a2, float *a3)
{
  int v4; // edi
  int v5; // eax
  int v6; // eax
  ...
  v4 = *(_DWORD *)(*((_DWORD *)this + 1) + 184);
  if ( !v4 )
    goto LABEL_6;
  if ( (*(int (__thiscall **)(_DWORD))(*(_DWORD *)v4 + 292))(*(_DWORD *)(*((_DWORD *)this + 1) + 184)) )
  {
    v5 = *(_DWORD *)this;
    v19 = *(float *)dword_10436250;
    ...
    v9 = a3;
    v10 = a2;
    (*(void (__thiscall **)(int, float *, float *, int))(LODWORD(v19) + 92))(dword_10436250, a2, a3, v8);
    goto LABEL_8;
  }
...
LABEL_8:
  if ( this[36] < 0 )
  {
    ...
    sub_100158B0(v18, v10, v10);
    sub_10015910(v17, v9, v9);
  }
}
