void __cdecl sub_1008E240(float *a1, float *a2, int a3, char a4)
{
  double v6; // st7
  ...
  CVProfile::EnterScope(g_VProfCurrentProfile, "FX_Tracer", 0, "Particle/Effect_Rendering", 0, 4);
  *(float *)v9 = *a2 - *a1;
  ...
  *(float *)&v9[2] = a2[2] - a1[2];
  ...
  if ( v6 >= 256.0 )
  {
    ...
    sub_1008DBD0((int)a1, (int)v9, v10, v12, v13, v8, 0.75, COERCE_INT(0.89999998));
  }
  if ( a4 )
    sub_1008DF90((int)&savedregs, a1, a2, 1);
