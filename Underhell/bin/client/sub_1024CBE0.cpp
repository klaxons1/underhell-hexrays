int __thiscall sub_1024CBE0(_DWORD *this)
{
  int v2; // edi
  int v3; // ebx
  _DWORD *v4; // eax
  ...
  v4 = (_DWORD *)(*(int (__thiscall **)(_DWORD *, _BYTE *))(*this + 228))(this, v6);
  (*(void (__thiscall **)(int, _DWORD))(v3 + 72))(v2, *v4);
  return (*(int (__thiscall **)(int, int, _DWORD))(*(_DWORD *)dword_1047CA6C + 92))(dword_1047CA6C, 112, 0);
}
