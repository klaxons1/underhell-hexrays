int __cdecl _input_s_l(FILE *a1, unsigned __int8 *a2, struct localeinfo_struct *a3, _BYTE **a4)
{
  ...
  *(_DWORD *)DstCh = 0;
  ...
  while ( 2 )
  {
    ...
    {
      --v108;
      v9 = _whiteout(v65, &v108, (int)Stream);
      if ( v9 != -1 )
...
LABEL_37:
    ...
    if ( v18 != 110 )
    {
      ...
      {
        v19 = _whiteout(v14, &v108, (int)Stream);
      }
      Character = v19;
      if ( v19 == -1 )
        goto $error_return$29311;
...
$f_incwidth2$29542:
        ...
        if ( v96 )
        {
          if ( !v104 )
          {
            ...
            v97[v24] = 0;
            v62 = (char)v109 - 1;
            v39 = (void (__cdecl *)(int, _WORD *, void *, __crt_locale_pointers *))DecodePointer(off_103FDB60);
