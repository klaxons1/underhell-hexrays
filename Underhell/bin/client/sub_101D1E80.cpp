int __stdcall sub_101D1E80(int a1, int a2, int a3, int a4)
{
  unsigned int v4; // ecx
  ...
  {
    v6 = v5[4];
    *(_DWORD *)&v13[4 * v4 - 1] = v5[2] | ((*v5 | ((v5[1] | 0xFFFFFF00) << 8)) << 8);
    v7 = v5[6] | ((v6 | ((v5[5] | 0xFFFFFF00) << 8)) << 8);
    v8 = v5[8];
    *(_DWORD *)&v13[(_DWORD)v5 + 2 - a4] = v7;
    v9 = v5[10] | ((v8 | ((v5[9] | 0xFFFFFF00) << 8)) << 8);
    v10 = v5[12];
    *(_DWORD *)&v13[(_DWORD)v5 - a4] = v9;
    *(_DWORD *)&v14[(_DWORD)v5 - a4] = v5[14] | ((v10 | ((v5[13] | 0xFFFFFF00) << 8)) << 8);
    v4 += 4;
    v5 += 16;
  }
  while ( v4 < 0x10 );
