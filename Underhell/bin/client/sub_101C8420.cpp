char __thiscall sub_101C8420(_BYTE *this, int a2, int a3, int a4, int a5, int a6)
{
  char result; // al
  ...
  if ( this[24] )
    return 0;
  v8 = *(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 52);
  this[24] = 1;
  ...
  {
    if ( !(*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 60))(
            this,
            a2,
            a3,
            a4,
            ...
            v16) )
    {
      if ( (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 56))(
             this,
             a2,
             a3,
             a4,
