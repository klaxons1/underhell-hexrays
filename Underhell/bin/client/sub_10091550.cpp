char __cdecl sub_10091550(float *a1, float *a2, float *a3, float *a4, float *a5, float a6, int a7)
{
  double v7; // st6
  double v8; // st5
  double v9; // st7
  ...
  *(float *)&v40 = 0.0;
  ...
  if ( v35 * v38 + v15 * v37 < fabs(v27 * a3[2] + v24 * a3[6] + v28 * a3[10]) )
    return 0;
  sub_101ED8C0(a1, a3, v34);
  *(float *)&v40 = *(float *)&v40 * 2.0;
  v41 = v41 * 2.0;
  v42 = 2.0 * v42;
  if ( !sub_10090840((float *)v34, (float *)&v40, (int)a4, (int)a5, a6, a7, 0) )
    return 0;
