void __thiscall sub_100A8850(_DWORD *this, float a2, float a3)
{
  int v4; // ecx
  double v5; // st7
  int v6; // edx
  ...
  v4 = this[2];
  v44 = *(float *)(dword_1043483C + 44) * a2;
  sub_101EE040(v4 + 12, v37, v38, v35);
  v5 = a2;
  v6 = this[2];
  ...
  else
  {
    ...
    if ( v19 <= v17 )
      v19 = v17;
    v20 = v17 - v19 * (*(float *)(this[1] + 4676) * *(float *)(dword_10434A7C + 44)) * *((float *)off_103DC81C + 4);
    if ( v20 < 0.0 )
      v20 = 0.0;
    v21 = (float *)this[2];
    v22 = v20 / v17;
