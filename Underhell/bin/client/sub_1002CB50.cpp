bool __thiscall sub_1002CB50(int this, int a2, float a3, float a4, _DWORD *a5)
{
  double v5; // st7
  int v6; // esi
  int v7; // edi
...
LABEL_55:
  ...
  if ( v10 != -1 )
  {
    ...
    if ( v14 >= v13 )
      v14 -= v13;
    v15 = *(float *)(*(_DWORD *)(this + 8) + 8 * v14) - v9;
      ...
      *(float *)(a2 + 16) = v16;
      ...
      if ( (*(_BYTE *)(this + 28) & 0x10) == 0 && v17 >= 0 && v17 < *(unsigned __int16 *)(this + 16) )
      {
        *(_DWORD *)(a2 + 4) = v17;
        ...
        if ( v18 >= v19 )
          v18 -= v19;
        if ( v11 - *(float *)(*(_DWORD *)(this + 8) + 8 * v18) > 0.000099999997 )
          *(_BYTE *)a2 = 1;
      }
      if ( a5 && v10 == (*(_WORD *)(this + 16) != 0) - 1 )
      {
        v20 = *(unsigned __int16 *)(this + 14);
        v21 = *(unsigned __int16 *)(this + 12);
        v22 = 4 * *(unsigned __int8 *)(this + 29);
        v23 = v20 + v6;
        v36 = v22;
        if ( v23 >= v21 )
          v23 -= v21;
...
LABEL_33:
        if ( !v22
          || *(_BYTE *)v24 == *(_BYTE *)v26
          && (v22 <= 1
           || *(_BYTE *)(v24 + 1) == *(_BYTE *)(v26 + 1) && (v22 <= 2 || *(_BYTE *)(v24 + 2) == *(_BYTE *)(v26 + 2))) )
        {
          if ( !*(_BYTE *)a2 )
            goto LABEL_53;
          v27 = v20 + *(_DWORD *)(a2 + 4);
