char __thiscall sub_101C89E0(_BYTE *this, int a2, int a3, int a4, int a5, _WORD *a6)
{
  char result; // al
  ...
  else if ( (*(unsigned __int8 (__thiscall **)(_BYTE *, int, int, int, int, _BYTE *))(*(_DWORD *)this + 40))(
              this,
              a2,
              a3,
              a4,
