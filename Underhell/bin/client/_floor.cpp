double __cdecl floor(double X)
{
  ...
  if ( v2 )
  {
    ...
    v6 = _mm_sub_epi32((__m128i)xmmword_103AD5A0, (__m128i)_mm_and_pd(v4, (__m128d)xmmword_103AD5D0));
    ...
    if ( (v5 & 0x800) != 0 )
    {
      ...
      if ( v5 < 3071 )
      {
        *(_QWORD *)&X = *(_OWORD *)&_mm_cmplt_pd(v11, (__m128d)xmmword_103AD5C0) & 0x3FF0000000000000LL
