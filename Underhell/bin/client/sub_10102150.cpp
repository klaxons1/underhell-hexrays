int __cdecl sub_10102150(int a1, int a2, const void *a3)
{
  int v3; // eax
  _DWORD *v4; // eax
  int v5; // ebx
  ...
  v3 = (*(int (__thiscall **)(int, const char *))(*(_DWORD *)dword_10436258 + 12))(dword_10436258, "default");
  qmemcpy(v34, a3, sizeof(v34));
  v34[7] = a1;
  v26 = v3;
  v4 = *(_DWORD **)(a2 + 4);
  v34[6] = "world";
  v5 = (*(int (__thiscall **)(int, _DWORD, int, float *, float *, _DWORD *))(*(_DWORD *)dword_10436254 + 32))(
         dword_10436254,
         *v4,
         v26,
         &flt_10459240,
  ...
  v9 = (*(int (__thiscall **)(int, _DWORD))(*(_DWORD *)dword_10436250 + 152))(dword_10436250, *(_DWORD *)(a2 + 8));
  ...
  if ( !v10(v9) )
  {
    do
    {
      ...
      if ( !_stricmp(v11, "solid") || !_stricmp(v11, "staticsolid") )
      {
        ...
        LOBYTE(v29[10]) = 1;
        v29[6] = "world";
        v18 = (*(int (__thiscall **)(int, const char *))(*(_DWORD *)dword_10436258 + 12))(dword_10436258, "default");
        if ( v28[0] )
        {
          v19 = *(_DWORD *)(a2 + 4);
          ...
          {
            v21 = (*(int (__thiscall **)(int, _DWORD, int, float *, float *, _DWORD *))(*(_DWORD *)dword_10436254 + 32))(
                    dword_10436254,
                    *v20,
                    v18,
                    &flt_10459240,
            ...
            if ( v21 )
            {
              ...
              (*(void (__thiscall **)(int, int))(*(_DWORD *)v22 + 164))(v22, dword_103E2158);
              if ( !v35 )
                v35 = v22;
            }
          }
      ...
      else if ( !_stricmp(v11, "fluid") )
      {
        ...
        if ( v30 > 0 )
        {
          ...
          LOBYTE(v29[10]) = 1;
          v29[6] = "fluid";
          v12 = (*(int (__thiscall **)(int, char *))(*(_DWORD *)dword_10436258 + 12))(dword_10436258, v31);
          v13 = (*(int (__thiscall **)(int, _DWORD, int, float *, float *, _DWORD *))(*(_DWORD *)dword_10436254 + 32))(
                  dword_10436254,
          ...
          (*(void (__thiscall **)(int, int, char *))(*(_DWORD *)dword_10436254 + 44))(dword_10436254, v13, v32);
        }
      }
      else if ( !_stricmp(v11, "materialtable") )
      {
        ...
        (*(void (__thiscall **)(int, _BYTE *, int))(*(_DWORD *)dword_10436258 + 32))(dword_10436258, v27, 128);
      }
      else
      {
  ...
  (*(void (__thiscall **)(int, int))(*(_DWORD *)dword_10436250 + 156))(dword_10436250, v9);
  if ( v36 && (*(unsigned __int8 (__thiscall **)(int))(*(_DWORD *)dword_10436250 + 188))(dword_10436250) )
    sub_10102080(a1, a3);
  return v35;
}
