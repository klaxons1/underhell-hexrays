int __thiscall sub_10165DB0(int this, int a2)
{
  ...
  return (*((int (__thiscall **)(void ***, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD))*off_103E773C[0]
          + 13))(
           off_103E773C[0],
           *(_DWORD *)(this + 72),
           *(_DWORD *)(this + 76),
